...
############################# Head ############################
head_title: "Aggiungi Metadata ai File PPTX utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file PPTX. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File PPTX in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Pptx in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file PPTX nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file PPTX che desideri aggiornare.
