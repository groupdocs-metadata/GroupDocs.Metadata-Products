...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos XLTX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos XLTX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos XLTX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Xltx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos XLTX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo XLTX que deseja atualizar.
