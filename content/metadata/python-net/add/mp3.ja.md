...
############################# Head ############################
head_title: "Pythonを使用してMP3ファイルにメタデータを追加"
head_description: "Python APIを使用してMP3ファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでMP3ファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでMp3にメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでMP3ファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
