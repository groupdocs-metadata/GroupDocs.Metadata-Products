...
############################# Head ############################
head_title: "Aggiungi Metadata ai File HEIF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file HEIF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File HEIF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Heif in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file HEIF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file HEIF che desideri aggiornare.
