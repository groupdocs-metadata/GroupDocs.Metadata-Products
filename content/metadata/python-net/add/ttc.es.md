...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos TTC usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos TTC. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos TTC en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Ttc en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos TTC en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo TTC que deseas actualizar.
