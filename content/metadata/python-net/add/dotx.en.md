...
############################# Head ############################
head_title: "Add Metadata to DOTX Files using Python"
head_description: "Use the Python API to insert metadata into DOTX files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DOTX Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Dotx in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DOTX files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DOTX file you want to update.
