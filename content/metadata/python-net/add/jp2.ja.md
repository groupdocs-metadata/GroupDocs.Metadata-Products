...
############################# Head ############################
head_title: "Pythonを使用してJP2ファイルにメタデータを追加"
head_description: "Python APIを使用してJP2ファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでJP2ファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでJp2にメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでJP2ファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
