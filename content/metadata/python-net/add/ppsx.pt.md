...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PPSX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PPSX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PPSX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Ppsx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PPSX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PPSX que deseja atualizar.
