...
############################# Head ############################
head_title: "Pythonを使用してVSDXファイルにメタデータを追加"
head_description: "Python APIを使用してVSDXファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでVSDXファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでVsdxにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでVSDXファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいVSDXファイルを開きます。
