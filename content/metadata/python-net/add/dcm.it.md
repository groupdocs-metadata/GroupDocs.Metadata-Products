...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DCM utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DCM. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DCM in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Dcm in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DCM nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DCM che desideri aggiornare.
