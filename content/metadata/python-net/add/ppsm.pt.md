...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PPSM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PPSM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PPSM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Ppsm em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PPSM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PPSM que deseja atualizar.
