...
############################# Head ############################
head_title: "Aggiungi Metadata ai File XLSM utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file XLSM. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File XLSM in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Xlsm in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file XLSM nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file XLSM che desideri aggiornare.
