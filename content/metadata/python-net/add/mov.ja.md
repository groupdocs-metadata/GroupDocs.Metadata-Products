...
############################# Head ############################
head_title: "Pythonを使用してMOVファイルにメタデータを追加"
head_description: "Python APIを使用してMOVファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでMOVファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでMovにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでMOVファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
