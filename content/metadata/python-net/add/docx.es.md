...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DOCX usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DOCX. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DOCX en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Docx en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DOCX en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DOCX que deseas actualizar.
