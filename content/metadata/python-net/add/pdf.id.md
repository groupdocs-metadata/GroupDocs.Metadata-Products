...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas PDF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas PDF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas PDF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Pdf dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas PDF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas PDF yang ingin Anda perbarui.
