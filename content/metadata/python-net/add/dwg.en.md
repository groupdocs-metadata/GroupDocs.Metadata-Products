...
############################# Head ############################
head_title: "Add Metadata to DWG Files using Python"
head_description: "Use the Python API to insert metadata into DWG files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DWG Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Dwg in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DWG files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DWG file you want to update.
