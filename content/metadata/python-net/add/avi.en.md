...
############################# Head ############################
head_title: "Add Metadata to AVI Files using Python"
head_description: "Use the Python API to insert metadata into AVI files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to AVI Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Avi in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to AVI files in Python apps is straightforward. Just follow these steps.
      
      1. Open the AVI file you want to update.
