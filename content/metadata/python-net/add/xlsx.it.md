...
############################# Head ############################
head_title: "Aggiungi Metadata ai File XLSX utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file XLSX. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File XLSX in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Xlsx in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file XLSX nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file XLSX che desideri aggiornare.
