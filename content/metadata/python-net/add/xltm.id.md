...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas XLTM Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas XLTM. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas XLTM dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Xltm dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas XLTM dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas XLTM yang ingin Anda perbarui.
