...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas POTX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas POTX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas POTX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Potx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas POTX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas POTX yang ingin Anda perbarui.
