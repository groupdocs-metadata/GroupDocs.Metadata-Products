...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas POTM Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas POTM. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas POTM dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Potm dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas POTM dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas POTM yang ingin Anda perbarui.
