...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos PNG usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos PNG. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos PNG en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Png en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos PNG en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo PNG que deseas actualizar.
