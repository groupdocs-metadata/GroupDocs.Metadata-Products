...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos WEBP usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos WEBP. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos WEBP em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Webp em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos WEBP em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo WEBP que deseja atualizar.
