...
############################# Head ############################
head_title: "Pythonを使用してHEICファイルにメタデータを追加"
head_description: "Python APIを使用してHEICファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでHEICファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでHeicにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでHEICファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいHEICファイルを開きます。
