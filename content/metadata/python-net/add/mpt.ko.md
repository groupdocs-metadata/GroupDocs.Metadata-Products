...
############################# Head ############################
head_title: "Python를 사용하여 MPT 파일에 메타데이터 추가"
head_description: "Python API를 사용하여 MPT 파일에 메타데이터를 삽입하세요. XMP, EXIF, IPTC, ID3 등의 표준으로 작업할 수 있습니다."

############################# Header ############################
title: "Python에서 MPT 파일에 메타데이터 추가" 
...
steps:
    enable: true
    title: "Python에서 Mpt에 메타데이터 추가 방법"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)를 사용하면 Python 애플리케이션에서 MPT 파일에 메타데이터를 추가하는 것이 간단합니다. 다음 단계를 따르세요.
      
      1. 업데이트하려는 MPT 파일을 엽니다.
