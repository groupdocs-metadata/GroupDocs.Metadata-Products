...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos VCF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos VCF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos VCF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Vcf em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos VCF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo VCF que deseja atualizar.
