...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos MSG usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos MSG. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos MSG em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Msg em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos MSG em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo MSG que deseja atualizar.
