...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos GIF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos GIF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos GIF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Gif em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos GIF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo GIF que deseja atualizar.
