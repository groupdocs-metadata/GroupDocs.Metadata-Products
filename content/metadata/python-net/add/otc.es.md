...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos OTC usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos OTC. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos OTC en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Otc en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos OTC en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo OTC que deseas actualizar.
