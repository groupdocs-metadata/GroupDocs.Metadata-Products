...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas WMF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas WMF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas WMF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Wmf dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas WMF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas WMF yang ingin Anda perbarui.
