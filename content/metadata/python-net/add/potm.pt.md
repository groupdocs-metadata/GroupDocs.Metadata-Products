...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos POTM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos POTM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos POTM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Potm em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos POTM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo POTM que deseja atualizar.
