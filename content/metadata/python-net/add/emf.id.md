...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas EMF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas EMF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas EMF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Emf dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas EMF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas EMF yang ingin Anda perbarui.
