...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos XLSX usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos XLSX. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos XLSX en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Xlsx en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos XLSX en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo XLSX que deseas actualizar.
