...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas JP2 Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas JP2. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas JP2 dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Jp2 dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas JP2 dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas JP2 yang ingin Anda perbarui.
