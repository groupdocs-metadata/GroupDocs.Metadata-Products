...
############################# Head ############################
head_title: "Add Metadata to OTC Files using Python"
head_description: "Use the Python API to insert metadata into OTC files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to OTC Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Otc in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to OTC files in Python apps is straightforward. Just follow these steps.
      
      1. Open the OTC file you want to update.
