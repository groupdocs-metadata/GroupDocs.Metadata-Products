...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos PPT usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos PPT. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos PPT en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Ppt en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos PPT en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo PPT que deseas actualizar.
