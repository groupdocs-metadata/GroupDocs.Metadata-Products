...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos TTF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos TTF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos TTF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Ttf em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos TTF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo TTF que deseja atualizar.
