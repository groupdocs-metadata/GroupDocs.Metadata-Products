...
############################# Head ############################
head_title: "Pythonを使用してVDXファイルにメタデータを追加"
head_description: "Python APIを使用してVDXファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでVDXファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでVdxにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでVDXファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
