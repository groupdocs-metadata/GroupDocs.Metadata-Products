...
############################# Head ############################
head_title: "Add Metadata to OTF Files using Python"
head_description: "Use the Python API to insert metadata into OTF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to OTF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Otf in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to OTF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the OTF file you want to update.
