...
############################# Head ############################
head_title: "Add Metadata to VSDX Files using Python"
head_description: "Use the Python API to insert metadata into VSDX files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to VSDX Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Vsdx in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to VSDX files in Python apps is straightforward. Just follow these steps.
      
      1. Open the VSDX file you want to update.
