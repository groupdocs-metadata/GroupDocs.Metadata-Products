...
############################# Head ############################
head_title: "Aggiungi Metadata ai File EML utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file EML. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File EML in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Eml in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file EML nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file EML che desideri aggiornare.
