...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas GIF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas GIF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas GIF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Gif dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas GIF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas GIF yang ingin Anda perbarui.
