...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DOC utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DOC. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DOC in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Doc in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DOC nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DOC che desideri aggiornare.
