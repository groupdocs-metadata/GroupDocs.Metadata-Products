...
############################# Head ############################
head_title: "Aggiungi Metadata ai File AVI utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file AVI. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File AVI in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Avi in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file AVI nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file AVI che desideri aggiornare.
