...
############################# Head ############################
head_title: "Aggiungi Metadata ai File VCR utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file VCR. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File VCR in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Vcr in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file VCR nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file VCR che desideri aggiornare.
