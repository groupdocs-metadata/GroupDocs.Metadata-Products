...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos XLT usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos XLT. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos XLT em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Xlt em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos XLT em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo XLT que deseja atualizar.
