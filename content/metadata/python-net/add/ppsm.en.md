...
############################# Head ############################
head_title: "Add Metadata to PPSM Files using Python"
head_description: "Use the Python API to insert metadata into PPSM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to PPSM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Ppsm in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to PPSM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the PPSM file you want to update.
