...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos JPEG usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos JPEG. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos JPEG en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Jpeg en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos JPEG en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo JPEG que deseas actualizar.
