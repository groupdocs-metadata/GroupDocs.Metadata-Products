...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos ODT usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos ODT. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos ODT en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Odt en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos ODT en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo ODT que deseas actualizar.
