...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos EML usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos EML. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos EML en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Eml en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos EML en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo EML que deseas actualizar.
