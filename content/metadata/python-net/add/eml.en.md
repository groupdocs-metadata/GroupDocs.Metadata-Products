...
############################# Head ############################
head_title: "Add Metadata to EML Files using Python"
head_description: "Use the Python API to insert metadata into EML files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to EML Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Eml in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to EML files in Python apps is straightforward. Just follow these steps.
      
      1. Open the EML file you want to update.
