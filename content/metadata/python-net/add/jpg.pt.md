...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos JPG usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos JPG. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos JPG em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Jpg em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos JPG em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo JPG que deseja atualizar.
