...
############################# Head ############################
head_title: "Pythonを使用してDICOMファイルにメタデータを追加"
head_description: "Python APIを使用してDICOMファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでDICOMファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでDicomにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでDICOMファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいDICOMファイルを開きます。
