...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DOCM usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DOCM. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DOCM en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Docm en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DOCM en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DOCM que deseas actualizar.
