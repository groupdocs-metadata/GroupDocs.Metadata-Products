...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas BMP Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas BMP. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas BMP dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Bmp dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas BMP dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas BMP yang ingin Anda perbarui.
