...
############################# Head ############################
head_title: "Add Metadata to DOTM Files using Python"
head_description: "Use the Python API to insert metadata into DOTM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DOTM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Dotm in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DOTM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DOTM file you want to update.
