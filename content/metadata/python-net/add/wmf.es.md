...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos WMF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos WMF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos WMF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Wmf en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos WMF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo WMF que deseas actualizar.
