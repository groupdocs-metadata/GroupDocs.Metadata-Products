...
############################# Head ############################
head_title: "Add Metadata to XLSX Files using Python"
head_description: "Use the Python API to insert metadata into XLSX files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to XLSX Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Xlsx in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to XLSX files in Python apps is straightforward. Just follow these steps.
      
      1. Open the XLSX file you want to update.
