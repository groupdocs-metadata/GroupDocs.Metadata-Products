...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DOCM utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DOCM. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DOCM in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Docm in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DOCM nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DOCM che desideri aggiornare.
