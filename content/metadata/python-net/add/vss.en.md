...
############################# Head ############################
head_title: "Add Metadata to VSS Files using Python"
head_description: "Use the Python API to insert metadata into VSS files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to VSS Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Vss in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to VSS files in Python apps is straightforward. Just follow these steps.
      
      1. Open the VSS file you want to update.
