...
############################# Head ############################
head_title: "Add Metadata to TORRENT Files using Python"
head_description: "Use the Python API to insert metadata into TORRENT files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to TORRENT Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Torrent in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to TORRENT files in Python apps is straightforward. Just follow these steps.
      
      1. Open the TORRENT file you want to update.
