...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas HEIC Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas HEIC. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas HEIC dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Heic dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas HEIC dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas HEIC yang ingin Anda perbarui.
