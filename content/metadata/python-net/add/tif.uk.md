...
############################# Head ############################
head_title: "Додавання метаданих до файлів TIF за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли TIF. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів TIF у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Tif у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів TIF у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл TIF, який хочете оновити.
