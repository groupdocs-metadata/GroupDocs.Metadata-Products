...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos XLT usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos XLT. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos XLT en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Xlt en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos XLT en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo XLT que deseas actualizar.
