...
############################# Head ############################
head_title: "Aggiungi Metadata ai File ODS utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file ODS. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File ODS in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Ods in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file ODS nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file ODS che desideri aggiornare.
