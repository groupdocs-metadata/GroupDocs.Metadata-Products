...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos MOV usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos MOV. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos MOV en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Mov en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos MOV en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo MOV que deseas actualizar.
