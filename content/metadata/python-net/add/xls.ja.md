...
############################# Head ############################
head_title: "Pythonを使用してXLSファイルにメタデータを追加"
head_description: "Python APIを使用してXLSファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでXLSファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでXlsにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでXLSファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
