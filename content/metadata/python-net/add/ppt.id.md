...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas PPT Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas PPT. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas PPT dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Ppt dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas PPT dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas PPT yang ingin Anda perbarui.
