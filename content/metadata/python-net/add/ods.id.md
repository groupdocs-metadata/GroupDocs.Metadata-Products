...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas ODS Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas ODS. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas ODS dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Ods dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas ODS dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas ODS yang ingin Anda perbarui.
