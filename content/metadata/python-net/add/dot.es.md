...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DOT usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DOT. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DOT en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Dot en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DOT en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DOT que deseas actualizar.
