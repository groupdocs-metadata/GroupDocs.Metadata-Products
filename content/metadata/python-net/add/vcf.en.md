...
############################# Head ############################
head_title: "Add Metadata to VCF Files using Python"
head_description: "Use the Python API to insert metadata into VCF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to VCF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Vcf in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to VCF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the VCF file you want to update.
