...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos MSG usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos MSG. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos MSG en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Msg en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos MSG en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo MSG que deseas actualizar.
