...
############################# Head ############################
head_title: "Add Metadata to XLS Files using Python"
head_description: "Use the Python API to insert metadata into XLS files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to XLS Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Xls in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to XLS files in Python apps is straightforward. Just follow these steps.
      
      1. Open the XLS file you want to update.
