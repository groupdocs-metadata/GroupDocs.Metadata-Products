...
############################# Head ############################
head_title: "Add Metadata to GIF Files using Python"
head_description: "Use the Python API to insert metadata into GIF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to GIF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Gif in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to GIF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the GIF file you want to update.
