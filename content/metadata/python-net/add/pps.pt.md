...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PPS usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PPS. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PPS em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Pps em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PPS em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PPS que deseja atualizar.
