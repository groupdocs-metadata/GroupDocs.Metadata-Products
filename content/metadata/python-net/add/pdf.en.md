...
############################# Head ############################
head_title: "Add Metadata to PDF Files using Python"
head_description: "Use the Python API to insert metadata into PDF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to PDF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Pdf in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to PDF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the PDF file you want to update.
