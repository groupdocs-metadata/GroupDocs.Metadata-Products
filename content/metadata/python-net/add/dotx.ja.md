...
############################# Head ############################
head_title: "Pythonを使用してDOTXファイルにメタデータを追加"
head_description: "Python APIを使用してDOTXファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでDOTXファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでDotxにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでDOTXファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいDOTXファイルを開きます。
