...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas MOV Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas MOV. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas MOV dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Mov dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas MOV dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas MOV yang ingin Anda perbarui.
