...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos POTX usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos POTX. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos POTX en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Potx en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos POTX en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo POTX que deseas actualizar.
