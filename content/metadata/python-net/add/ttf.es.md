...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos TTF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos TTF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos TTF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Ttf en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos TTF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo TTF que deseas actualizar.
