...
############################# Head ############################
head_title: "Pythonを使用してGIFファイルにメタデータを追加"
head_description: "Python APIを使用してGIFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでGIFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでGifにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでGIFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
