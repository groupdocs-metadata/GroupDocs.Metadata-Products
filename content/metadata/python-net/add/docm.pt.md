...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DOCM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DOCM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DOCM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Docm em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DOCM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DOCM que deseja atualizar.
