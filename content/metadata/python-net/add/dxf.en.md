...
############################# Head ############################
head_title: "Add Metadata to DXF Files using Python"
head_description: "Use the Python API to insert metadata into DXF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DXF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Dxf in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DXF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DXF file you want to update.
