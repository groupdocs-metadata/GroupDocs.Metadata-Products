...
############################# Head ############################
head_title: "Pythonを使用してOTCファイルにメタデータを追加"
head_description: "Python APIを使用してOTCファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでOTCファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでOtcにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでOTCファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
