...
############################# Head ############################
head_title: "Add Metadata to XLSB Files using Python"
head_description: "Use the Python API to insert metadata into XLSB files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to XLSB Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Xlsb in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to XLSB files in Python apps is straightforward. Just follow these steps.
      
      1. Open the XLSB file you want to update.
