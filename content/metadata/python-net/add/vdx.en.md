...
############################# Head ############################
head_title: "Add Metadata to VDX Files using Python"
head_description: "Use the Python API to insert metadata into VDX files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to VDX Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Vdx in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to VDX files in Python apps is straightforward. Just follow these steps.
      
      1. Open the VDX file you want to update.
