...
############################# Head ############################
head_title: "Add Metadata to MPP Files using Python"
head_description: "Use the Python API to insert metadata into MPP files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to MPP Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Mpp in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to MPP files in Python apps is straightforward. Just follow these steps.
      
      1. Open the MPP file you want to update.
