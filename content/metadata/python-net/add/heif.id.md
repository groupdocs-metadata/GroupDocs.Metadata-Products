...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas HEIF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas HEIF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas HEIF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Heif dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas HEIF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas HEIF yang ingin Anda perbarui.
