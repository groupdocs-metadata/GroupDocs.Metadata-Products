...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PPT usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PPT. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PPT em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Ppt em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PPT em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PPT que deseja atualizar.
