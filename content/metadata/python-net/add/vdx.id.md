...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas VDX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas VDX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas VDX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Vdx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas VDX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas VDX yang ingin Anda perbarui.
