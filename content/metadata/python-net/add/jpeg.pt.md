...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos JPEG usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos JPEG. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos JPEG em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Jpeg em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos JPEG em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo JPEG que deseja atualizar.
