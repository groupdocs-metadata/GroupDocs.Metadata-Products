...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos VSDX usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos VSDX. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos VSDX en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Vsdx en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos VSDX en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo VSDX que deseas actualizar.
