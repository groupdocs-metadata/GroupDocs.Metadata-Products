...
############################# Head ############################
head_title: "Add Metadata to JPG Files using Python"
head_description: "Use the Python API to insert metadata into JPG files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to JPG Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Jpg in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to JPG files in Python apps is straightforward. Just follow these steps.
      
      1. Open the JPG file you want to update.
