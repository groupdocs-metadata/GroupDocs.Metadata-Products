...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos PDF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos PDF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos PDF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Pdf en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos PDF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo PDF que deseas actualizar.
