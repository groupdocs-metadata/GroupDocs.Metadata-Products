...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos JP2 usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos JP2. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos JP2 en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Jp2 en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos JP2 en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo JP2 que deseas actualizar.
