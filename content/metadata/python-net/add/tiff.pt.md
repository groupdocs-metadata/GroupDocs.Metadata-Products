...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos TIFF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos TIFF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos TIFF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Tiff em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos TIFF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo TIFF que deseja atualizar.
