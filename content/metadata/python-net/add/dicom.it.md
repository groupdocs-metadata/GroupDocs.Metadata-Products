...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DICOM utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DICOM. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DICOM in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Dicom in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DICOM nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DICOM che desideri aggiornare.
