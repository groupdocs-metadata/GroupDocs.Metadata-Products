...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos EPUB usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos EPUB. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos EPUB em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Epub em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos EPUB em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo EPUB que deseja atualizar.
