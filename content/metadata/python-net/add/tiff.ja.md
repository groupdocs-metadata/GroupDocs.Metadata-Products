...
############################# Head ############################
head_title: "Pythonを使用してTIFFファイルにメタデータを追加"
head_description: "Python APIを使用してTIFFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでTIFFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでTiffにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでTIFFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいTIFFファイルを開きます。
