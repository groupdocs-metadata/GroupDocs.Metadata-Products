...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos HEIF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos HEIF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos HEIF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Heif en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos HEIF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo HEIF que deseas actualizar.
