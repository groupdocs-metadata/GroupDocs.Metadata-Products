...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos HEIC usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos HEIC. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos HEIC en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Heic en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos HEIC en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo HEIC que deseas actualizar.
