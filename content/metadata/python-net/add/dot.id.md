...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DOT Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DOT. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DOT dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Dot dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DOT dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DOT yang ingin Anda perbarui.
