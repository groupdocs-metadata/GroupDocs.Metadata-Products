...
############################# Head ############################
head_title: "Додавання метаданих до файлів TORRENT за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли TORRENT. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів TORRENT у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Torrent у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів TORRENT у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл TORRENT, який хочете оновити.
