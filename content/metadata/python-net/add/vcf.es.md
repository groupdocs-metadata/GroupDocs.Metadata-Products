...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos VCF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos VCF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos VCF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Vcf en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos VCF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo VCF que deseas actualizar.
