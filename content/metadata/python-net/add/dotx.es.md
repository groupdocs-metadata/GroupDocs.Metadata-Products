...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DOTX usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DOTX. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DOTX en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Dotx en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DOTX en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DOTX que deseas actualizar.
