...
############################# Head ############################
head_title: "Add Metadata to MPT Files using Python"
head_description: "Use the Python API to insert metadata into MPT files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to MPT Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Mpt in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to MPT files in Python apps is straightforward. Just follow these steps.
      
      1. Open the MPT file you want to update.
