...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers JPEG avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers JPEG. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers JPEG en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Jpeg en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers JPEG dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier JPEG que vous souhaitez mettre à jour.
