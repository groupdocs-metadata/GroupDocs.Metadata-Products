...
############################# Head ############################
head_title: "Aggiungi Metadata ai File XLS utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file XLS. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File XLS in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Xls in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file XLS nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file XLS che desideri aggiornare.
