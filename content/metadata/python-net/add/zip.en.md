...
############################# Head ############################
head_title: "Add Metadata to ZIP Files using Python"
head_description: "Use the Python API to insert metadata into ZIP files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to ZIP Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Zip in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to ZIP files in Python apps is straightforward. Just follow these steps.
      
      1. Open the ZIP file you want to update.
