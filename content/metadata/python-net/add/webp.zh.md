...
############################# Head ############################
head_title: "使用Python为WEBP文件添加元数据"
head_description: "利用Python API将元数据插入到WEBP文件中。处理XMP、EXIF、IPTC、ID3等标准。"

############################# Header ############################
title: "在Python中为WEBP文件添加元数据" 
...
steps:
    enable: true
    title: "如何在Python中为Webp添加元数据"
    content: |
      使用[GroupDocs.Metadata](/metadata/python-net/)，在Python应用程序中向WEBP文件添加元数据非常简单。只需按照以下步骤进行。
