...
############################# Head ############################
head_title: "Pythonを使用してDOCXファイルにメタデータを追加"
head_description: "Python APIを使用してDOCXファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでDOCXファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでDocxにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでDOCXファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいDOCXファイルを開きます。
