...
############################# Head ############################
head_title: "Pythonを使用してBMPファイルにメタデータを追加"
head_description: "Python APIを使用してBMPファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでBMPファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでBmpにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでBMPファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
