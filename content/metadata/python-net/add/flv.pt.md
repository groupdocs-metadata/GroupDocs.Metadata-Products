...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos FLV usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos FLV. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos FLV em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Flv em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos FLV em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo FLV que deseja atualizar.
