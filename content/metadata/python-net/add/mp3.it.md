...
############################# Head ############################
head_title: "Aggiungi Metadata ai File MP3 utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file MP3. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File MP3 in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Mp3 in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file MP3 nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file MP3 che desideri aggiornare.
