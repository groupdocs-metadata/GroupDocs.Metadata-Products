...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos ASF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos ASF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos ASF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Asf en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos ASF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo ASF que deseas actualizar.
