...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers DOTM avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers DOTM. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers DOTM en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Dotm en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers DOTM dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier DOTM que vous souhaitez mettre à jour.
