...
############################# Head ############################
head_title: "Aggiungi Metadata ai File BMP utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file BMP. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File BMP in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Bmp in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file BMP nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file BMP che desideri aggiornare.
