...
############################# Head ############################
head_title: "Aggiungi Metadata ai File PPSX utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file PPSX. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File PPSX in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Ppsx in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file PPSX nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file PPSX che desideri aggiornare.
