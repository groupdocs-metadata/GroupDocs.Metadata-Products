...
############################# Head ############################
head_title: "Aggiungi Metadata ai File TIF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file TIF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File TIF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Tif in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file TIF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file TIF che desideri aggiornare.
