...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos EPUB usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos EPUB. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos EPUB en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Epub en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos EPUB en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo EPUB que deseas actualizar.
