...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos XLSM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos XLSM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos XLSM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Xlsm em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos XLSM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo XLSM que deseja atualizar.
