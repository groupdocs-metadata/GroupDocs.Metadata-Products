...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DXF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DXF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DXF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Dxf dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DXF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DXF yang ingin Anda perbarui.
