...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PPTM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PPTM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PPTM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Pptm em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PPTM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PPTM que deseja atualizar.
