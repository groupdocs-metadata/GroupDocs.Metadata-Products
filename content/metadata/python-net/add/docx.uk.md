...
############################# Head ############################
head_title: "Додавання метаданих до файлів DOCX за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли DOCX. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів DOCX у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Docx у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів DOCX у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл DOCX, який хочете оновити.
