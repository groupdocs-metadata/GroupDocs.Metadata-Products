...
############################# Head ############################
head_title: "Pythonを使用してDCMファイルにメタデータを追加"
head_description: "Python APIを使用してDCMファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでDCMファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでDcmにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでDCMファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
