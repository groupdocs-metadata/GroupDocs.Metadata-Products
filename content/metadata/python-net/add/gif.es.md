...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos GIF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos GIF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos GIF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Gif en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos GIF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo GIF que deseas actualizar.
