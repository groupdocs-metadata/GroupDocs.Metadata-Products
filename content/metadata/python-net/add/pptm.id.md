...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas PPTM Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas PPTM. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas PPTM dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Pptm dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas PPTM dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas PPTM yang ingin Anda perbarui.
