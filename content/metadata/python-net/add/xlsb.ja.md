...
############################# Head ############################
head_title: "Pythonを使用してXLSBファイルにメタデータを追加"
head_description: "Python APIを使用してXLSBファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでXLSBファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでXlsbにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでXLSBファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいXLSBファイルを開きます。
