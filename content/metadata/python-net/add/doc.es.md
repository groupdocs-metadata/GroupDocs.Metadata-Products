...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DOC usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DOC. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DOC en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Doc en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DOC en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DOC que deseas actualizar.
