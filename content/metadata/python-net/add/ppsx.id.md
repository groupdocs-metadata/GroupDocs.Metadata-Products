...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas PPSX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas PPSX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas PPSX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Ppsx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas PPSX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas PPSX yang ingin Anda perbarui.
