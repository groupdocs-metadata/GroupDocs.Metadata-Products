...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DWG Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DWG. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DWG dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Dwg dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DWG dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DWG yang ingin Anda perbarui.
