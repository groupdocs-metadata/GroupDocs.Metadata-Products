...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PNG usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PNG. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PNG em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Png em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PNG em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PNG que deseja atualizar.
