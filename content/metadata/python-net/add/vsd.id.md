...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas VSD Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas VSD. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas VSD dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Vsd dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas VSD dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas VSD yang ingin Anda perbarui.
