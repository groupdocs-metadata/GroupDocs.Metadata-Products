...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas VCF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas VCF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas VCF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Vcf dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas VCF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas VCF yang ingin Anda perbarui.
