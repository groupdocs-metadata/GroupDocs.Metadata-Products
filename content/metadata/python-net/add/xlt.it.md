...
############################# Head ############################
head_title: "Aggiungi Metadata ai File XLT utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file XLT. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File XLT in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Xlt in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file XLT nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file XLT che desideri aggiornare.
