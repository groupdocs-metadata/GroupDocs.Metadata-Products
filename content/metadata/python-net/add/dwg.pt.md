...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DWG usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DWG. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DWG em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Dwg em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DWG em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DWG que deseja atualizar.
