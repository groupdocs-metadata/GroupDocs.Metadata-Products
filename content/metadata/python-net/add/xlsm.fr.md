...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers XLSM avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers XLSM. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers XLSM en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Xlsm en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers XLSM dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier XLSM que vous souhaitez mettre à jour.
