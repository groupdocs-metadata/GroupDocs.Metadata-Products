...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos MP3 usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos MP3. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos MP3 em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Mp3 em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos MP3 em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo MP3 que deseja atualizar.
