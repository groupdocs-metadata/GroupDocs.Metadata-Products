...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos OTF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos OTF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos OTF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Otf en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos OTF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo OTF que deseas actualizar.
