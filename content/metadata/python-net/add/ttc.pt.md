...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos TTC usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos TTC. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos TTC em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Ttc em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos TTC em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo TTC que deseja atualizar.
