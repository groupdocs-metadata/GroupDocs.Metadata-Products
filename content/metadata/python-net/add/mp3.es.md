...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos MP3 usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos MP3. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos MP3 en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Mp3 en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos MP3 en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo MP3 que deseas actualizar.
