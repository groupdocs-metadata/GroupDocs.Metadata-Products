...
############################# Head ############################
head_title: "Add Metadata to MSG Files using Python"
head_description: "Use the Python API to insert metadata into MSG files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to MSG Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Msg in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to MSG files in Python apps is straightforward. Just follow these steps.
      
      1. Open the MSG file you want to update.
