...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PDF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PDF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PDF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Pdf em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PDF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PDF que deseja atualizar.
