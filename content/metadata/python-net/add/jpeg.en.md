...
############################# Head ############################
head_title: "Add Metadata to JPEG Files using Python"
head_description: "Use the Python API to insert metadata into JPEG files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to JPEG Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Jpeg in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to JPEG files in Python apps is straightforward. Just follow these steps.
      
      1. Open the JPEG file you want to update.
