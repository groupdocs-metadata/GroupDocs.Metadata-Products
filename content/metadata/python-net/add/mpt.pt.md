...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos MPT usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos MPT. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos MPT em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Mpt em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos MPT em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo MPT que deseja atualizar.
