...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos PSD usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos PSD. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos PSD en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Psd en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos PSD en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo PSD que deseas actualizar.
