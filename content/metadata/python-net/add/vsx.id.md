...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas VSX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas VSX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas VSX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Vsx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas VSX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas VSX yang ingin Anda perbarui.
