...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos JP2 usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos JP2. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos JP2 em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Jp2 em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos JP2 em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo JP2 que deseja atualizar.
