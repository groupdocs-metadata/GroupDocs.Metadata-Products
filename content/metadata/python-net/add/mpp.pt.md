...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos MPP usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos MPP. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos MPP em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Mpp em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos MPP em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo MPP que deseja atualizar.
