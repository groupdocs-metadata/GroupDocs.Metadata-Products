...
############################# Head ############################
head_title: "Add Metadata to WMF Files using Python"
head_description: "Use the Python API to insert metadata into WMF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to WMF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Wmf in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to WMF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the WMF file you want to update.
