...
############################# Head ############################
head_title: "Pythonを使用してJPGファイルにメタデータを追加"
head_description: "Python APIを使用してJPGファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでJPGファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでJpgにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでJPGファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
