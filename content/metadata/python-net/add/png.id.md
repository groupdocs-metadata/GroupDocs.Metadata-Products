...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas PNG Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas PNG. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas PNG dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Png dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas PNG dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas PNG yang ingin Anda perbarui.
