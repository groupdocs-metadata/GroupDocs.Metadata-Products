...
############################# Head ############################
head_title: "Aggiungi Metadata ai File GIF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file GIF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File GIF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Gif in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file GIF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file GIF che desideri aggiornare.
