...
############################# Head ############################
head_title: "Pythonを使用してODSファイルにメタデータを追加"
head_description: "Python APIを使用してODSファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでODSファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでOdsにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでODSファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
