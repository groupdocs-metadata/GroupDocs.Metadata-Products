...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos POT usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos POT. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos POT em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Pot em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos POT em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo POT que deseja atualizar.
