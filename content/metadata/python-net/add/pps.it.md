...
############################# Head ############################
head_title: "Aggiungi Metadata ai File PPS utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file PPS. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File PPS in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Pps in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file PPS nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file PPS che desideri aggiornare.
