...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos ZIP usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos ZIP. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos ZIP en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Zip en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos ZIP en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo ZIP que deseas actualizar.
