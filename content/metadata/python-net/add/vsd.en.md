...
############################# Head ############################
head_title: "Add Metadata to VSD Files using Python"
head_description: "Use the Python API to insert metadata into VSD files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to VSD Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Vsd in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to VSD files in Python apps is straightforward. Just follow these steps.
      
      1. Open the VSD file you want to update.
