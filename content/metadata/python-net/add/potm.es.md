...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos POTM usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos POTM. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos POTM en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Potm en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos POTM en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo POTM que deseas actualizar.
