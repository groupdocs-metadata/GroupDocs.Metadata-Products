...
############################# Head ############################
head_title: "Pythonを使用してVSSファイルにメタデータを追加"
head_description: "Python APIを使用してVSSファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでVSSファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでVssにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでVSSファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
