...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas TTF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas TTF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas TTF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Ttf dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas TTF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas TTF yang ingin Anda perbarui.
