...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos VSX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos VSX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos VSX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Vsx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos VSX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo VSX que deseja atualizar.
