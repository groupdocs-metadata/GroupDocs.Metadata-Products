...
############################# Head ############################
head_title: "Aggiungi Metadata ai File PSD utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file PSD. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File PSD in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Psd in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file PSD nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file PSD che desideri aggiornare.
