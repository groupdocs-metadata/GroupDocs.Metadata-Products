...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DCM usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DCM. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DCM en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Dcm en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DCM en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DCM que deseas actualizar.
