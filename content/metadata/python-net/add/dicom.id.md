...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DICOM Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DICOM. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DICOM dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Dicom dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DICOM dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DICOM yang ingin Anda perbarui.
