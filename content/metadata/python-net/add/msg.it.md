...
############################# Head ############################
head_title: "Aggiungi Metadata ai File MSG utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file MSG. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File MSG in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Msg in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file MSG nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file MSG che desideri aggiornare.
