...
############################# Head ############################
head_title: "Aggiungi Metadata ai File XLTX utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file XLTX. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File XLTX in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Xltx in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file XLTX nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file XLTX che desideri aggiornare.
