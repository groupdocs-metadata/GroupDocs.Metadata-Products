...
############################# Head ############################
head_title: "Add Metadata to HEIF Files using Python"
head_description: "Use the Python API to insert metadata into HEIF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to HEIF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Heif in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to HEIF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the HEIF file you want to update.
