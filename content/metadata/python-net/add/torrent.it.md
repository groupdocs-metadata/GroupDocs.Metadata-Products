...
############################# Head ############################
head_title: "Aggiungi Metadata ai File TORRENT utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file TORRENT. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File TORRENT in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Torrent in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file TORRENT nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file TORRENT che desideri aggiornare.
