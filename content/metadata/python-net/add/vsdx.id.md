...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas VSDX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas VSDX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas VSDX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Vsdx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas VSDX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas VSDX yang ingin Anda perbarui.
