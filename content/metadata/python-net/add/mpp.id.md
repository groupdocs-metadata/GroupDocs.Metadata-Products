...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas MPP Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas MPP. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas MPP dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Mpp dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas MPP dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas MPP yang ingin Anda perbarui.
