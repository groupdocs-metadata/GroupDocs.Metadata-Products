...
############################# Head ############################
head_title: "Add Metadata to TTC Files using Python"
head_description: "Use the Python API to insert metadata into TTC files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to TTC Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Ttc in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to TTC files in Python apps is straightforward. Just follow these steps.
      
      1. Open the TTC file you want to update.
