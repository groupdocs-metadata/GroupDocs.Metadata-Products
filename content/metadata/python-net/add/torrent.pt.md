...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos TORRENT usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos TORRENT. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos TORRENT em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Torrent em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos TORRENT em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo TORRENT que deseja atualizar.
