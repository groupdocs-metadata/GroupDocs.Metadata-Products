...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DJVU usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DJVU. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DJVU en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Djvu en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DJVU en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DJVU que deseas actualizar.
