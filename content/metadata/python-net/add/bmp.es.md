...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos BMP usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos BMP. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos BMP en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Bmp en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos BMP en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo BMP que deseas actualizar.
