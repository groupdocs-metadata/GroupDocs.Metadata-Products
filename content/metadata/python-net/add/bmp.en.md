...
############################# Head ############################
head_title: "Add Metadata to BMP Files using Python"
head_description: "Use the Python API to insert metadata into BMP files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to BMP Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Bmp in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to BMP files in Python apps is straightforward. Just follow these steps.
      
      1. Open the BMP file you want to update.
