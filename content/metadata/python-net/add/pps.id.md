...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas PPS Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas PPS. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas PPS dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Pps dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas PPS dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas PPS yang ingin Anda perbarui.
