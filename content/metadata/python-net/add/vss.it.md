...
############################# Head ############################
head_title: "Aggiungi Metadata ai File VSS utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file VSS. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File VSS in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Vss in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file VSS nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file VSS che desideri aggiornare.
