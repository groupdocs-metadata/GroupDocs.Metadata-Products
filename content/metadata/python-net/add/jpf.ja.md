...
############################# Head ############################
head_title: "Pythonを使用してJPFファイルにメタデータを追加"
head_description: "Python APIを使用してJPFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでJPFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでJpfにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでJPFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
