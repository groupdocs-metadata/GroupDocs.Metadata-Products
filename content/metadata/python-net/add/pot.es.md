...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos POT usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos POT. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos POT en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Pot en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos POT en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo POT que deseas actualizar.
