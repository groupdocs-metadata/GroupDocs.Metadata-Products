...
############################# Head ############################
head_title: "Aggiungi Metadata ai File VSX utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file VSX. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File VSX in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Vsx in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file VSX nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file VSX che desideri aggiornare.
