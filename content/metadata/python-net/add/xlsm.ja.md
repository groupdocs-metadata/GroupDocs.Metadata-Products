...
############################# Head ############################
head_title: "Pythonを使用してXLSMファイルにメタデータを追加"
head_description: "Python APIを使用してXLSMファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでXLSMファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでXlsmにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでXLSMファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいXLSMファイルを開きます。
