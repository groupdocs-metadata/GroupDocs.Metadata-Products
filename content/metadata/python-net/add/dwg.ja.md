...
############################# Head ############################
head_title: "Pythonを使用してDWGファイルにメタデータを追加"
head_description: "Python APIを使用してDWGファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでDWGファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでDwgにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでDWGファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
