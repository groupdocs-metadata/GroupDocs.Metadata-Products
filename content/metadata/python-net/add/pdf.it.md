...
############################# Head ############################
head_title: "Aggiungi Metadata ai File PDF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file PDF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File PDF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Pdf in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file PDF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file PDF che desideri aggiornare.
