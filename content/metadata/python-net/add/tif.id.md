...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas TIF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas TIF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas TIF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Tif dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas TIF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas TIF yang ingin Anda perbarui.
