...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DOT usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DOT. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DOT em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Dot em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DOT em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DOT que deseja atualizar.
