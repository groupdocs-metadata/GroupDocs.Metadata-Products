...
############################# Head ############################
head_title: "Add Metadata to ODT Files using Python"
head_description: "Use the Python API to insert metadata into ODT files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to ODT Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Odt in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to ODT files in Python apps is straightforward. Just follow these steps.
