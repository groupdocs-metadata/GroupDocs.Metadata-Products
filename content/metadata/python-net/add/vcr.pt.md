...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos VCR usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos VCR. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos VCR em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Vcr em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos VCR em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo VCR que deseja atualizar.
