...
############################# Head ############################
head_title: "Додавання метаданих до файлів JPEG за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли JPEG. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів JPEG у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Jpeg у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів JPEG у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл JPEG, який хочете оновити.
