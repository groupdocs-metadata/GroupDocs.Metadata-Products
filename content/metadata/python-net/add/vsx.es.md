...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos VSX usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos VSX. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos VSX en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Vsx en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos VSX en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo VSX que deseas actualizar.
