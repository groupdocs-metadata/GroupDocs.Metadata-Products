...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers MSG avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers MSG. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers MSG en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Msg en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers MSG dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier MSG que vous souhaitez mettre à jour.
