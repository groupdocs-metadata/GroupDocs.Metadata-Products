...
############################# Head ############################
head_title: "Add Metadata to XLTM Files using Python"
head_description: "Use the Python API to insert metadata into XLTM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to XLTM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Xltm in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to XLTM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the XLTM file you want to update.
