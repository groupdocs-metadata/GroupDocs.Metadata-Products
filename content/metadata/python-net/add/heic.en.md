...
############################# Head ############################
head_title: "Add Metadata to HEIC Files using Python"
head_description: "Use the Python API to insert metadata into HEIC files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to HEIC Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Heic in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to HEIC files in Python apps is straightforward. Just follow these steps.
      
      1. Open the HEIC file you want to update.
