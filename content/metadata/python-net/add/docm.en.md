...
############################# Head ############################
head_title: "Add Metadata to DOCM Files using Python"
head_description: "Use the Python API to insert metadata into DOCM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DOCM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Docm in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DOCM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DOCM file you want to update.
