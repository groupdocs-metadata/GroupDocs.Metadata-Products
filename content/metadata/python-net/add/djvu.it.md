...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DJVU utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DJVU. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DJVU in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Djvu in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DJVU nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DJVU che desideri aggiornare.
