...
############################# Head ############################
head_title: "Thêm Siêu Dữ Liệu vào Tệp POTM Sử Dụng Python"
head_description: "Sử dụng API Python để chèn siêu dữ liệu vào các tệp POTM. Làm việc với các tiêu chuẩn như XMP, EXIF, IPTC, ID3, và nhiều hơn nữa."

############################# Header ############################
title: "Thêm Siêu Dữ Liệu vào Tệp POTM trong Python" 
...
steps:
    enable: true
    title: "Cách Thêm Siêu Dữ Liệu Vào Potm Trong Python"
    content: |
      Với [GroupDocs.Metadata](/metadata/python-net/), việc thêm siêu dữ liệu vào các tệp POTM trong ứng dụng Python rất đơn giản. Chỉ cần làm theo các bước sau.
      
      1. Mở tệp POTM mà bạn muốn cập nhật.
