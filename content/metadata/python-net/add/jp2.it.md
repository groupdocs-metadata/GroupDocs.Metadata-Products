...
############################# Head ############################
head_title: "Aggiungi Metadata ai File JP2 utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file JP2. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File JP2 in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Jp2 in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file JP2 nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file JP2 che desideri aggiornare.
