...
############################# Head ############################
head_title: "Aggiungi Metadata ai File TIFF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file TIFF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File TIFF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Tiff in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file TIFF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file TIFF che desideri aggiornare.
