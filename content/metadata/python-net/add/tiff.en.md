...
############################# Head ############################
head_title: "Add Metadata to TIFF Files using Python"
head_description: "Use the Python API to insert metadata into TIFF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to TIFF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Tiff in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to TIFF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the TIFF file you want to update.
