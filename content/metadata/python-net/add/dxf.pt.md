...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DXF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DXF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DXF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Dxf em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DXF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DXF que deseja atualizar.
