...
############################# Head ############################
head_title: "Aggiungi Metadata ai File OTC utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file OTC. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File OTC in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Otc in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file OTC nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file OTC che desideri aggiornare.
