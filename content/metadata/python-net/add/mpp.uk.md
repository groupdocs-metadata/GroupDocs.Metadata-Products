...
############################# Head ############################
head_title: "Додавання метаданих до файлів MPP за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли MPP. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів MPP у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Mpp у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів MPP у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл MPP, який хочете оновити.
