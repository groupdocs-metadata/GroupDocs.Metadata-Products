...
############################# Head ############################
head_title: "Aggiungi Metadata ai File VSDX utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file VSDX. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File VSDX in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Vsdx in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file VSDX nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file VSDX che desideri aggiornare.
