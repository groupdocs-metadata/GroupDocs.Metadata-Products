...
############################# Head ############################
head_title: "Додавання метаданих до файлів VSX за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли VSX. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів VSX у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Vsx у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів VSX у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл VSX, який хочете оновити.
