...
############################# Head ############################
head_title: "Aggiungi Metadata ai File TTF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file TTF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File TTF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Ttf in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file TTF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file TTF che desideri aggiornare.
