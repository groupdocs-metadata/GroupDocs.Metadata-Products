...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DICOM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DICOM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DICOM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Dicom em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DICOM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DICOM que deseja atualizar.
