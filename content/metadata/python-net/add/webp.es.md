...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos WEBP usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos WEBP. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos WEBP en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Webp en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos WEBP en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo WEBP que deseas actualizar.
