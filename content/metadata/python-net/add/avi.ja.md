...
############################# Head ############################
head_title: "Pythonを使用してAVIファイルにメタデータを追加"
head_description: "Python APIを使用してAVIファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでAVIファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでAviにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでAVIファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
