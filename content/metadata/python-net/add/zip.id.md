...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas ZIP Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas ZIP. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas ZIP dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Zip dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas ZIP dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas ZIP yang ingin Anda perbarui.
