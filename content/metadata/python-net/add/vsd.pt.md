...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos VSD usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos VSD. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos VSD em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Vsd em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos VSD em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo VSD que deseja atualizar.
