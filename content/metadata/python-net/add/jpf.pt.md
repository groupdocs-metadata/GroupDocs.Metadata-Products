...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos JPF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos JPF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos JPF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Jpf em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos JPF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo JPF que deseja atualizar.
