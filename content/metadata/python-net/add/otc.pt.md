...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos OTC usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos OTC. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos OTC em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Otc em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos OTC em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo OTC que deseja atualizar.
