...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas EPUB Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas EPUB. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas EPUB dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Epub dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas EPUB dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas EPUB yang ingin Anda perbarui.
