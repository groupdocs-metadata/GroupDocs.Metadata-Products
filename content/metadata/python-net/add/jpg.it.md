...
############################# Head ############################
head_title: "Aggiungi Metadata ai File JPG utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file JPG. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File JPG in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Jpg in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file JPG nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file JPG che desideri aggiornare.
