...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos TIF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos TIF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos TIF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Tif em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos TIF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo TIF que deseja atualizar.
