...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos PPSM usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos PPSM. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos PPSM en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Ppsm en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos PPSM en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo PPSM que deseas actualizar.
