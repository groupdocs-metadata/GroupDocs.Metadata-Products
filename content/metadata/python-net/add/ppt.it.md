...
############################# Head ############################
head_title: "Aggiungi Metadata ai File PPT utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file PPT. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File PPT in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Ppt in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file PPT nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file PPT che desideri aggiornare.
