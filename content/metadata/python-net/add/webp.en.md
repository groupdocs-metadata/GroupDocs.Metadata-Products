...
############################# Head ############################
head_title: "Add Metadata to WEBP Files using Python"
head_description: "Use the Python API to insert metadata into WEBP files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to WEBP Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Webp in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to WEBP files in Python apps is straightforward. Just follow these steps.
      
      1. Open the WEBP file you want to update.
