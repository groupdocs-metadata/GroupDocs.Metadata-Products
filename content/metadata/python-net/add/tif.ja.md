...
############################# Head ############################
head_title: "Pythonを使用してTIFファイルにメタデータを追加"
head_description: "Python APIを使用してTIFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでTIFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでTifにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでTIFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
