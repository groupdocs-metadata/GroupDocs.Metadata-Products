...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers POT avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers POT. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers POT en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Pot en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers POT dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier POT que vous souhaitez mettre à jour.
