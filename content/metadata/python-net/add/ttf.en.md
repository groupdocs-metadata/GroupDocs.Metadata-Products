...
############################# Head ############################
head_title: "Add Metadata to TTF Files using Python"
head_description: "Use the Python API to insert metadata into TTF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to TTF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Ttf in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to TTF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the TTF file you want to update.
