...
############################# Head ############################
head_title: "Pythonを使用してVCFファイルにメタデータを追加"
head_description: "Python APIを使用してVCFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでVCFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでVcfにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでVCFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
