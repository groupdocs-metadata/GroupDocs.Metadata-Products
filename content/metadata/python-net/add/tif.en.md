...
############################# Head ############################
head_title: "Add Metadata to TIF Files using Python"
head_description: "Use the Python API to insert metadata into TIF files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to TIF Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Tif in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to TIF files in Python apps is straightforward. Just follow these steps.
      
      1. Open the TIF file you want to update.
