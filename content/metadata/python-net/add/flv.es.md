...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos FLV usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos FLV. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos FLV en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Flv en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos FLV en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo FLV que deseas actualizar.
