...
############################# Head ############################
head_title: "Aggiungi Metadata ai File WEBP utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file WEBP. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File WEBP in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Webp in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file WEBP nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file WEBP che desideri aggiornare.
