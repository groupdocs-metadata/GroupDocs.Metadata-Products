...
############################# Head ############################
head_title: "Pythonを使用してPPSXファイルにメタデータを追加"
head_description: "Python APIを使用してPPSXファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでPPSXファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでPpsxにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでPPSXファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいPPSXファイルを開きます。
