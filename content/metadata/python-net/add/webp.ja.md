...
############################# Head ############################
head_title: "Pythonを使用してWEBPファイルにメタデータを追加"
head_description: "Python APIを使用してWEBPファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでWEBPファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでWebpにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでWEBPファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいWEBPファイルを開きます。
