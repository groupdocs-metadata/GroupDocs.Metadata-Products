...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas WAV Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas WAV. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas WAV dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Wav dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas WAV dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas WAV yang ingin Anda perbarui.
