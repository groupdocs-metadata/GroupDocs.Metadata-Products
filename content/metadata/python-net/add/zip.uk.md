...
############################# Head ############################
head_title: "Додавання метаданих до файлів ZIP за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли ZIP. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів ZIP у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Zip у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів ZIP у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл ZIP, який хочете оновити.
