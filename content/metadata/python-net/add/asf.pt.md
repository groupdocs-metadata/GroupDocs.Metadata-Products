...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos ASF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos ASF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos ASF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Asf em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos ASF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo ASF que deseja atualizar.
