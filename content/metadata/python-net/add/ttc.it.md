...
############################# Head ############################
head_title: "Aggiungi Metadata ai File TTC utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file TTC. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File TTC in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Ttc in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file TTC nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file TTC che desideri aggiornare.
