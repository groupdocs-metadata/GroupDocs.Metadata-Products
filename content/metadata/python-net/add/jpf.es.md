...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos JPF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos JPF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos JPF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Jpf en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos JPF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo JPF que deseas actualizar.
