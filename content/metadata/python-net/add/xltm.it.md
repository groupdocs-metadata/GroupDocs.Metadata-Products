...
############################# Head ############################
head_title: "Aggiungi Metadata ai File XLTM utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file XLTM. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File XLTM in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Xltm in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file XLTM nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file XLTM che desideri aggiornare.
