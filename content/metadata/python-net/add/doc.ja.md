...
############################# Head ############################
head_title: "Pythonを使用してDOCファイルにメタデータを追加"
head_description: "Python APIを使用してDOCファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでDOCファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでDocにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでDOCファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
