...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos ODT usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos ODT. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos ODT em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Odt em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos ODT em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo ODT que deseja atualizar.
