...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas AVI Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas AVI. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas AVI dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Avi dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas AVI dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas AVI yang ingin Anda perbarui.
