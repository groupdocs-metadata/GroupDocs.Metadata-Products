...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos EMF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos EMF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos EMF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Emf em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos EMF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo EMF que deseja atualizar.
