...
############################# Head ############################
head_title: "Add Metadata to WAV Files using Python"
head_description: "Use the Python API to insert metadata into WAV files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to WAV Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Wav in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to WAV files in Python apps is straightforward. Just follow these steps.
      
      1. Open the WAV file you want to update.
