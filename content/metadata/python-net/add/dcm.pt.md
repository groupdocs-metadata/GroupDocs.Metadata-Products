...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DCM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DCM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DCM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Dcm em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DCM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DCM que deseja atualizar.
