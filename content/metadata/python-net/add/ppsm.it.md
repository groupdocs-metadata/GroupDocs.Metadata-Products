...
############################# Head ############################
head_title: "Aggiungi Metadata ai File PPSM utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file PPSM. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File PPSM in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Ppsm in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file PPSM nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file PPSM che desideri aggiornare.
