...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas JPF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas JPF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas JPF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Jpf dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas JPF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas JPF yang ingin Anda perbarui.
