...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DOTM utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DOTM. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DOTM in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Dotm in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DOTM nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DOTM che desideri aggiornare.
