...
############################# Head ############################
head_title: "Aggiungi Metadata ai File JPF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file JPF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File JPF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Jpf in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file JPF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file JPF che desideri aggiornare.
