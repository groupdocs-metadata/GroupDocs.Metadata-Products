...
############################# Head ############################
head_title: "Add Metadata to POTX Files using Python"
head_description: "Use the Python API to insert metadata into POTX files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to POTX Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Potx in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to POTX files in Python apps is straightforward. Just follow these steps.
      
      1. Open the POTX file you want to update.
