...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DOT utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DOT. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DOT in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Dot in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DOT nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DOT che desideri aggiornare.
