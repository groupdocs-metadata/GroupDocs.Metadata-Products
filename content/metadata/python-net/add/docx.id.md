...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DOCX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DOCX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DOCX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Docx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DOCX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DOCX yang ingin Anda perbarui.
