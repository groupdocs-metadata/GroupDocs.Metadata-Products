...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos XLS usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos XLS. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos XLS em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Xls em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos XLS em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo XLS que deseja atualizar.
