...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos WAV usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos WAV. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos WAV en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Wav en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos WAV en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo WAV que deseas actualizar.
