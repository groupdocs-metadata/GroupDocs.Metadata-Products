...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos HEIC usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos HEIC. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos HEIC em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Heic em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos HEIC em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo HEIC que deseja atualizar.
