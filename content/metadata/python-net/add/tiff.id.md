...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas TIFF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas TIFF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas TIFF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Tiff dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas TIFF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas TIFF yang ingin Anda perbarui.
