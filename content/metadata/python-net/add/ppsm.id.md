...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas PPSM Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas PPSM. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas PPSM dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Ppsm dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas PPSM dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas PPSM yang ingin Anda perbarui.
