...
############################# Head ############################
head_title: "Metadaten zu TIF-Dateien mit Python hinzufügen"
head_description: "Verwenden Sie die Python-API, um Metadaten in TIF-Dateien einzufügen. Arbeiten Sie mit Standards wie XMP, EXIF, IPTC, ID3 und mehr."

############################# Header ############################
title: "Metadaten zu TIF-Dateien in Python hinzufügen" 
...
steps:
    enable: true
    title: "So fügen Sie Metadaten zu Tif in Python hinzu"
    content: |
      Mit [GroupDocs.Metadata](/metadata/python-net/) ist das Hinzufügen von Metadaten zu TIF-Dateien in Python-Apps unkompliziert. Befolgen Sie einfach diese Schritte.
      
      1. Öffnen Sie die TIF-Datei, die Sie aktualisieren möchten.
