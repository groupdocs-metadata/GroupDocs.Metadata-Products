...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos AVI usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos AVI. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos AVI en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Avi en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos AVI en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo AVI que deseas actualizar.
