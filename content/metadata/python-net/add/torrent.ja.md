...
############################# Head ############################
head_title: "Pythonを使用してTORRENTファイルにメタデータを追加"
head_description: "Python APIを使用してTORRENTファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでTORRENTファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでTorrentにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでTORRENTファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいTORRENTファイルを開きます。
