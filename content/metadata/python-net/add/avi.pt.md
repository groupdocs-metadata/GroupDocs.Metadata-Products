...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos AVI usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos AVI. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos AVI em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Avi em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos AVI em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo AVI que deseja atualizar.
