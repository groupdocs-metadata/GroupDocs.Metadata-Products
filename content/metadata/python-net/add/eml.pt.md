...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos EML usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos EML. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos EML em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Eml em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos EML em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo EML que deseja atualizar.
