...
############################# Head ############################
head_title: "Aggiungi Metadata ai File MPT utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file MPT. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File MPT in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Mpt in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file MPT nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file MPT che desideri aggiornare.
