...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos XLS usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos XLS. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos XLS en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Xls en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos XLS en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo XLS que deseas actualizar.
