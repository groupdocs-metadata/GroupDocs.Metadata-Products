...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos MPT usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos MPT. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos MPT en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Mpt en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos MPT en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo MPT que deseas actualizar.
