...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos PPSX usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos PPSX. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos PPSX en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Ppsx en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos PPSX en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo PPSX que deseas actualizar.
