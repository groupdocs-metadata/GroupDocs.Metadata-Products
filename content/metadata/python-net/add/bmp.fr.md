...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers BMP avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers BMP. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers BMP en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Bmp en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers BMP dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier BMP que vous souhaitez mettre à jour.
