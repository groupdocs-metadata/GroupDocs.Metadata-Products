...
############################# Head ############################
head_title: "Pythonを使用してEPUBファイルにメタデータを追加"
head_description: "Python APIを使用してEPUBファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでEPUBファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでEpubにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでEPUBファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいEPUBファイルを開きます。
