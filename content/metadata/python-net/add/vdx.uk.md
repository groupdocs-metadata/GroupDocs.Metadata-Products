...
############################# Head ############################
head_title: "Додавання метаданих до файлів VDX за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли VDX. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів VDX у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Vdx у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів VDX у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл VDX, який хочете оновити.
