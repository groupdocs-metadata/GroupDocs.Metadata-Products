...
############################# Head ############################
head_title: "Pythonを使用してXLTファイルにメタデータを追加"
head_description: "Python APIを使用してXLTファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでXLTファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでXltにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでXLTファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
