...
############################# Head ############################
head_title: "Pythonを使用してXLTMファイルにメタデータを追加"
head_description: "Python APIを使用してXLTMファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでXLTMファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでXltmにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでXLTMファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいXLTMファイルを開きます。
