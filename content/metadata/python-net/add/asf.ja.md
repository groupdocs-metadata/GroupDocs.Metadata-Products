...
############################# Head ############################
head_title: "Pythonを使用してASFファイルにメタデータを追加"
head_description: "Python APIを使用してASFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでASFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでAsfにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでASFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
