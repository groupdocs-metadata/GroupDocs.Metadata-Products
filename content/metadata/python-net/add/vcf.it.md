...
############################# Head ############################
head_title: "Aggiungi Metadata ai File VCF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file VCF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File VCF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Vcf in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file VCF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file VCF che desideri aggiornare.
