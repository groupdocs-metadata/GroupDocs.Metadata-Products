...
############################# Head ############################
head_title: "Pythonを使用してWMFファイルにメタデータを追加"
head_description: "Python APIを使用してWMFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでWMFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでWmfにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでWMFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
