...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas XLS Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas XLS. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas XLS dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Xls dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas XLS dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas XLS yang ingin Anda perbarui.
