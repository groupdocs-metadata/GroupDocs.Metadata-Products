...
############################# Head ############################
head_title: "Metadaten zu DJVU-Dateien mit Python hinzufügen"
head_description: "Verwenden Sie die Python-API, um Metadaten in DJVU-Dateien einzufügen. Arbeiten Sie mit Standards wie XMP, EXIF, IPTC, ID3 und mehr."

############################# Header ############################
title: "Metadaten zu DJVU-Dateien in Python hinzufügen" 
...
steps:
    enable: true
    title: "So fügen Sie Metadaten zu Djvu in Python hinzu"
    content: |
      Mit [GroupDocs.Metadata](/metadata/python-net/) ist das Hinzufügen von Metadaten zu DJVU-Dateien in Python-Apps unkompliziert. Befolgen Sie einfach diese Schritte.
      
      1. Öffnen Sie die DJVU-Datei, die Sie aktualisieren möchten.
