...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DWG usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DWG. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DWG en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Dwg en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DWG en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DWG que deseas actualizar.
