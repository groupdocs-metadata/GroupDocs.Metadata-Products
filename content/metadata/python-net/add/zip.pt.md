...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos ZIP usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos ZIP. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos ZIP em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Zip em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos ZIP em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo ZIP que deseja atualizar.
