...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas VCR Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas VCR. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas VCR dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Vcr dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas VCR dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas VCR yang ingin Anda perbarui.
