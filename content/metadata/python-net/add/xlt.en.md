...
############################# Head ############################
head_title: "Add Metadata to XLT Files using Python"
head_description: "Use the Python API to insert metadata into XLT files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to XLT Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Xlt in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to XLT files in Python apps is straightforward. Just follow these steps.
      
      1. Open the XLT file you want to update.
