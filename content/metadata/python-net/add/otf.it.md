...
############################# Head ############################
head_title: "Aggiungi Metadata ai File OTF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file OTF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File OTF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Otf in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file OTF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file OTF che desideri aggiornare.
