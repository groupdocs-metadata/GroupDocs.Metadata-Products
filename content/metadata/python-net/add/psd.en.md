...
############################# Head ############################
head_title: "Add Metadata to PSD Files using Python"
head_description: "Use the Python API to insert metadata into PSD files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to PSD Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Psd in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to PSD files in Python apps is straightforward. Just follow these steps.
      
      1. Open the PSD file you want to update.
