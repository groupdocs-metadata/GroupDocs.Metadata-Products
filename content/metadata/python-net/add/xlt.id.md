...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas XLT Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas XLT. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas XLT dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Xlt dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas XLT dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas XLT yang ingin Anda perbarui.
