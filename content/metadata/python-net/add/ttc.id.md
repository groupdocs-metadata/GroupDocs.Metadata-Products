...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas TTC Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas TTC. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas TTC dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Ttc dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas TTC dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas TTC yang ingin Anda perbarui.
