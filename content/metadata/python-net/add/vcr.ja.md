...
############################# Head ############################
head_title: "Pythonを使用してVCRファイルにメタデータを追加"
head_description: "Python APIを使用してVCRファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでVCRファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでVcrにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでVCRファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
