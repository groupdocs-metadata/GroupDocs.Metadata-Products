...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DOCX utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DOCX. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DOCX in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Docx in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DOCX nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DOCX che desideri aggiornare.
