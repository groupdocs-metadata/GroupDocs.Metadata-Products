...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers ASF avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers ASF. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers ASF en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Asf en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers ASF dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier ASF que vous souhaitez mettre à jour.
