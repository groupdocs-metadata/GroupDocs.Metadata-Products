...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PPTX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PPTX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PPTX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Pptx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PPTX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PPTX que deseja atualizar.
