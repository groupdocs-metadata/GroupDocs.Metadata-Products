...
############################# Head ############################
head_title: "Pythonを使用してDXFファイルにメタデータを追加"
head_description: "Python APIを使用してDXFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでDXFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでDxfにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでDXFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
