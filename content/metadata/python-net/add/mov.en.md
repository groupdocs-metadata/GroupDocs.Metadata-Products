...
############################# Head ############################
head_title: "Add Metadata to MOV Files using Python"
head_description: "Use the Python API to insert metadata into MOV files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to MOV Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Mov in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to MOV files in Python apps is straightforward. Just follow these steps.
      
      1. Open the MOV file you want to update.
