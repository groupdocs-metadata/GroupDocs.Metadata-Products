...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers JP2 avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers JP2. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers JP2 en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Jp2 en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers JP2 dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier JP2 que vous souhaitez mettre à jour.
