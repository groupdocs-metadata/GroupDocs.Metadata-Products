...
############################# Head ############################
head_title: "Aggiungi Metadata ai File VSD utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file VSD. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File VSD in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Vsd in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file VSD nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file VSD che desideri aggiornare.
