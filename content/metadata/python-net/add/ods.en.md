...
############################# Head ############################
head_title: "Add Metadata to ODS Files using Python"
head_description: "Use the Python API to insert metadata into ODS files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to ODS Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Ods in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to ODS files in Python apps is straightforward. Just follow these steps.
      
      1. Open the ODS file you want to update.
