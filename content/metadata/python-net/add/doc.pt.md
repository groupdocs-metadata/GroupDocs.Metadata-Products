...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DOC usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DOC. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DOC em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Doc em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DOC em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DOC que deseja atualizar.
