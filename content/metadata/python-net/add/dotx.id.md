...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DOTX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DOTX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DOTX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Dotx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DOTX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DOTX yang ingin Anda perbarui.
