...
############################# Head ############################
head_title: "Add Metadata to DICOM Files using Python"
head_description: "Use the Python API to insert metadata into DICOM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DICOM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Dicom in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DICOM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DICOM file you want to update.
