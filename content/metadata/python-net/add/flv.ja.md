...
############################# Head ############################
head_title: "Pythonを使用してFLVファイルにメタデータを追加"
head_description: "Python APIを使用してFLVファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでFLVファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでFlvにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでFLVファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
