...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos XLSB usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos XLSB. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos XLSB em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Xlsb em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos XLSB em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo XLSB que deseja atualizar.
