...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas POT Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas POT. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas POT dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Pot dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas POT dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas POT yang ingin Anda perbarui.
