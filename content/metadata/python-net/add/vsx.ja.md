...
############################# Head ############################
head_title: "Pythonを使用してVSXファイルにメタデータを追加"
head_description: "Python APIを使用してVSXファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでVSXファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでVsxにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでVSXファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
