...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas ODT Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas ODT. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas ODT dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Odt dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas ODT dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas ODT yang ingin Anda perbarui.
