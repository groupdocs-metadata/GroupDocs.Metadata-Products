...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos ODS usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos ODS. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos ODS en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Ods en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos ODS en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo ODS que deseas actualizar.
