...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos TORRENT usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos TORRENT. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos TORRENT en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Torrent en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos TORRENT en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo TORRENT que deseas actualizar.
