...
############################# Head ############################
head_title: "Add Metadata to PPS Files using Python"
head_description: "Use the Python API to insert metadata into PPS files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to PPS Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Pps in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to PPS files in Python apps is straightforward. Just follow these steps.
      
      1. Open the PPS file you want to update.
