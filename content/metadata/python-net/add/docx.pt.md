...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DOCX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DOCX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DOCX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Docx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DOCX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DOCX que deseja atualizar.
