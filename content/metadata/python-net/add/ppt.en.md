...
############################# Head ############################
head_title: "Add Metadata to PPT Files using Python"
head_description: "Use the Python API to insert metadata into PPT files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to PPT Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Ppt in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to PPT files in Python apps is straightforward. Just follow these steps.
      
      1. Open the PPT file you want to update.
