...
############################# Head ############################
head_title: "Pythonを使用してPOTXファイルにメタデータを追加"
head_description: "Python APIを使用してPOTXファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでPOTXファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでPotxにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでPOTXファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいPOTXファイルを開きます。
