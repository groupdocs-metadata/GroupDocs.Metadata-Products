...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas PSD Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas PSD. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas PSD dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Psd dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas PSD dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas PSD yang ingin Anda perbarui.
