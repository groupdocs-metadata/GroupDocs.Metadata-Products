...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas XLSB Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas XLSB. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas XLSB dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Xlsb dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas XLSB dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas XLSB yang ingin Anda perbarui.
