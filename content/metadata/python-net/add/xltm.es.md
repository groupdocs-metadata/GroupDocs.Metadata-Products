...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos XLTM usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos XLTM. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos XLTM en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Xltm en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos XLTM en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo XLTM que deseas actualizar.
