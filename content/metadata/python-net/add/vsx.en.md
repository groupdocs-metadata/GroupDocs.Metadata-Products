...
############################# Head ############################
head_title: "Add Metadata to VSX Files using Python"
head_description: "Use the Python API to insert metadata into VSX files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to VSX Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Vsx in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to VSX files in Python apps is straightforward. Just follow these steps.
      
      1. Open the VSX file you want to update.
