...
############################# Head ############################
head_title: "Add Metadata to VCR Files using Python"
head_description: "Use the Python API to insert metadata into VCR files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to VCR Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Vcr in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to VCR files in Python apps is straightforward. Just follow these steps.
      
      1. Open the VCR file you want to update.
