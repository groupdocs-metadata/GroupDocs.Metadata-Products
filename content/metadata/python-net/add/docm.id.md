...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DOCM Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DOCM. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DOCM dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Docm dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DOCM dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DOCM yang ingin Anda perbarui.
