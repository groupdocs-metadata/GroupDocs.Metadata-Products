...
############################# Head ############################
head_title: "Aggiungi Metadata ai File FLV utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file FLV. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File FLV in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Flv in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file FLV nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file FLV che desideri aggiornare.
