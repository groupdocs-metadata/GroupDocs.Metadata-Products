...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas OTF Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas OTF. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas OTF dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Otf dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas OTF dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas OTF yang ingin Anda perbarui.
