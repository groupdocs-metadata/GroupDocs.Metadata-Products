...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DOTM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DOTM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DOTM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Dotm em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DOTM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DOTM que deseja atualizar.
