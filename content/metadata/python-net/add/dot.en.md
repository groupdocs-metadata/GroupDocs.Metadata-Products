...
############################# Head ############################
head_title: "Add Metadata to DOT Files using Python"
head_description: "Use the Python API to insert metadata into DOT files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DOT Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Dot in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DOT files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DOT file you want to update.
