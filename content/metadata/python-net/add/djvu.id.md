...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DJVU Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DJVU. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DJVU dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Djvu dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DJVU dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DJVU yang ingin Anda perbarui.
