...
############################# Head ############################
head_title: "Add Metadata to PPTM Files using Python"
head_description: "Use the Python API to insert metadata into PPTM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to PPTM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Pptm in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to PPTM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the PPTM file you want to update.
