...
############################# Head ############################
head_title: "Pythonを使用してMPPファイルにメタデータを追加"
head_description: "Python APIを使用してMPPファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでMPPファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでMppにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでMPPファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
