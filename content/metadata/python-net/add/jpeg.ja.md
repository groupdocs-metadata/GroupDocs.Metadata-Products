...
############################# Head ############################
head_title: "Pythonを使用してJPEGファイルにメタデータを追加"
head_description: "Python APIを使用してJPEGファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでJPEGファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでJpegにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでJPEGファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいJPEGファイルを開きます。
