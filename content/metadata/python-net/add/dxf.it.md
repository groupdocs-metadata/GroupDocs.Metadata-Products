...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DXF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DXF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DXF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Dxf in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DXF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DXF che desideri aggiornare.
