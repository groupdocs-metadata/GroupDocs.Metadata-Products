...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas TORRENT Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas TORRENT. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas TORRENT dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Torrent dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas TORRENT dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas TORRENT yang ingin Anda perbarui.
