...
############################# Head ############################
head_title: "Add Metadata to XLTX Files using Python"
head_description: "Use the Python API to insert metadata into XLTX files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to XLTX Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Xltx in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to XLTX files in Python apps is straightforward. Just follow these steps.
      
      1. Open the XLTX file you want to update.
