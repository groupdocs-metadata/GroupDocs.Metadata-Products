...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos PPTM usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos PPTM. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos PPTM en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Pptm en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos PPTM en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo PPTM que deseas actualizar.
