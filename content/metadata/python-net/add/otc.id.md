...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas OTC Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas OTC. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas OTC dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Otc dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas OTC dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas OTC yang ingin Anda perbarui.
