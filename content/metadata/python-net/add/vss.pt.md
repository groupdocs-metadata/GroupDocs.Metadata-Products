...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos VSS usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos VSS. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos VSS em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Vss em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos VSS em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo VSS que deseja atualizar.
