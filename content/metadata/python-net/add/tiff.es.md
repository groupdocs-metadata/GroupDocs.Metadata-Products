...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos TIFF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos TIFF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos TIFF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Tiff en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos TIFF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo TIFF que deseas actualizar.
