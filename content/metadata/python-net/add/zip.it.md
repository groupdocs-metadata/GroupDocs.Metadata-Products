...
############################# Head ############################
head_title: "Aggiungi Metadata ai File ZIP utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file ZIP. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File ZIP in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Zip in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file ZIP nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file ZIP che desideri aggiornare.
