...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos WAV usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos WAV. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos WAV em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Wav em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos WAV em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo WAV que deseja atualizar.
