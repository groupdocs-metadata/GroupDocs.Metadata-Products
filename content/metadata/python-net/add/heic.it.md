...
############################# Head ############################
head_title: "Aggiungi Metadata ai File HEIC utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file HEIC. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File HEIC in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Heic in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file HEIC nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file HEIC che desideri aggiornare.
