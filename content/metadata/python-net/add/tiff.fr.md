...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers TIFF avec Python"
head_description: "Utilisez l'API Python pour insérer des métadonnées dans les fichiers TIFF. Travaillez avec des normes telles que XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Ajouter des métadonnées aux fichiers TIFF en Python" 
...
steps:
    enable: true
    title: "Comment ajouter des métadonnées à Tiff en Python"
    content: |
      Avec [GroupDocs.Metadata](/metadata/python-net/), l'ajout de métadonnées aux fichiers TIFF dans les applications Python est simple. Suivez ces étapes.
      
      1. Ouvrez le fichier TIFF que vous souhaitez mettre à jour.
