...
############################# Head ############################
head_title: "Aggiungi Metadata ai File PNG utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file PNG. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File PNG in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Png in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file PNG nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file PNG che desideri aggiornare.
