...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas MSG Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas MSG. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas MSG dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Msg dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas MSG dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas MSG yang ingin Anda perbarui.
