...
############################# Head ############################
head_title: "Aggiungi Metadata ai File ODT utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file ODT. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File ODT in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Odt in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file ODT nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file ODT che desideri aggiornare.
