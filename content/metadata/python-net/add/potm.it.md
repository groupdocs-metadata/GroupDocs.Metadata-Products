...
############################# Head ############################
head_title: "Aggiungi Metadata ai File POTM utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file POTM. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File POTM in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Potm in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file POTM nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file POTM che desideri aggiornare.
