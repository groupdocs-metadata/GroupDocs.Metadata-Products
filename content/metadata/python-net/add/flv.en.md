...
############################# Head ############################
head_title: "Add Metadata to FLV Files using Python"
head_description: "Use the Python API to insert metadata into FLV files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to FLV Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Flv in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to FLV files in Python apps is straightforward. Just follow these steps.
      
      1. Open the FLV file you want to update.
