...
############################# Head ############################
head_title: "Pythonを使用してHEIFファイルにメタデータを追加"
head_description: "Python APIを使用してHEIFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでHEIFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでHeifにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでHEIFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
      
      1. 更新したいHEIFファイルを開きます。
