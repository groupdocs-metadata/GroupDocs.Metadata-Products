...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos DOTX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos DOTX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos DOTX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Dotx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos DOTX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo DOTX que deseja atualizar.
