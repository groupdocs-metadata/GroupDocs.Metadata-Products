...
############################# Head ############################
head_title: "Pythonを使用してEMFファイルにメタデータを追加"
head_description: "Python APIを使用してEMFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでEMFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでEmfにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでEMFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
