...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas WEBP Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas WEBP. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas WEBP dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Webp dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas WEBP dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas WEBP yang ingin Anda perbarui.
