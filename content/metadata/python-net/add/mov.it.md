...
############################# Head ############################
head_title: "Aggiungi Metadata ai File MOV utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file MOV. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File MOV in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Mov in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file MOV nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file MOV che desideri aggiornare.
