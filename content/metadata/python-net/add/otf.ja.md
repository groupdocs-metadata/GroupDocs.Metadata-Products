...
############################# Head ############################
head_title: "Pythonを使用してOTFファイルにメタデータを追加"
head_description: "Python APIを使用してOTFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでOTFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでOtfにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでOTFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
