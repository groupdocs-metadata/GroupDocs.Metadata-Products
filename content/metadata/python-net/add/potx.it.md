...
############################# Head ############################
head_title: "Aggiungi Metadata ai File POTX utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file POTX. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File POTX in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Potx in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file POTX nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file POTX che desideri aggiornare.
