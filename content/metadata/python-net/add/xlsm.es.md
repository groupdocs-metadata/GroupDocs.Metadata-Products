...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos XLSM usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos XLSM. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos XLSM en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Xlsm en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos XLSM en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo XLSM que deseas actualizar.
