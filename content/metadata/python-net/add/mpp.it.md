...
############################# Head ############################
head_title: "Aggiungi Metadata ai File MPP utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file MPP. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File MPP in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Mpp in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file MPP nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file MPP che desideri aggiornare.
