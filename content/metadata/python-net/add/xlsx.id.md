...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas XLSX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas XLSX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas XLSX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Xlsx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas XLSX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas XLSX yang ingin Anda perbarui.
