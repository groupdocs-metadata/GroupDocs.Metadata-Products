...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos XLTM usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos XLTM. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos XLTM em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Xltm em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos XLTM em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo XLTM que deseja atualizar.
