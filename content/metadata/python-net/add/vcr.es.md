...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos VCR usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos VCR. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos VCR en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Vcr en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos VCR en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo VCR que deseas actualizar.
