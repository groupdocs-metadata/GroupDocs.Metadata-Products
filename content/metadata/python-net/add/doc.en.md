...
############################# Head ############################
head_title: "Add Metadata to DOC Files using Python"
head_description: "Use the Python API to insert metadata into DOC files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DOC Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Doc in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DOC files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DOC file you want to update.
