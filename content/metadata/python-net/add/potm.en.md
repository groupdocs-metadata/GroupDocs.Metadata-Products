...
############################# Head ############################
head_title: "Add Metadata to POTM Files using Python"
head_description: "Use the Python API to insert metadata into POTM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to POTM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Potm in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to POTM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the POTM file you want to update.
