...
############################# Head ############################
head_title: "Add Metadata to PNG Files using Python"
head_description: "Use the Python API to insert metadata into PNG files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to PNG Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Png in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to PNG files in Python apps is straightforward. Just follow these steps.
      
      1. Open the PNG file you want to update.
