...
############################# Head ############################
head_title: "Pythonを使用してEMLファイルにメタデータを追加"
head_description: "Python APIを使用してEMLファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでEMLファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでEmlにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでEMLファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
