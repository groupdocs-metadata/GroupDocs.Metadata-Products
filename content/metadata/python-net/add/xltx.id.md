...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas XLTX Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas XLTX. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas XLTX dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Xltx dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas XLTX dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas XLTX yang ingin Anda perbarui.
