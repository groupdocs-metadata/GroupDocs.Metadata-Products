...
############################# Head ############################
head_title: "Add Metadata to POT Files using Python"
head_description: "Use the Python API to insert metadata into POT files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to POT Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Pot in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to POT files in Python apps is straightforward. Just follow these steps.
      
      1. Open the POT file you want to update.
