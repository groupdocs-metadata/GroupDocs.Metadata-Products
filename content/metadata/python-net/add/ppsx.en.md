...
############################# Head ############################
head_title: "Add Metadata to PPSX Files using Python"
head_description: "Use the Python API to insert metadata into PPSX files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to PPSX Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Ppsx in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to PPSX files in Python apps is straightforward. Just follow these steps.
      
      1. Open the PPSX file you want to update.
