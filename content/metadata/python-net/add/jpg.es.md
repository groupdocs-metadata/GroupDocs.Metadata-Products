...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos JPG usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos JPG. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos JPG en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Jpg en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos JPG en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo JPG que deseas actualizar.
