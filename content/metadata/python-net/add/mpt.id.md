...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas MPT Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas MPT. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas MPT dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Mpt dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas MPT dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas MPT yang ingin Anda perbarui.
