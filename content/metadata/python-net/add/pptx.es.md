...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos PPTX usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos PPTX. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos PPTX en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Pptx en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos PPTX en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo PPTX que deseas actualizar.
