...
############################# Head ############################
head_title: "Pythonを使用してMSGファイルにメタデータを追加"
head_description: "Python APIを使用してMSGファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでMSGファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでMsgにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでMSGファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
