...
############################# Head ############################
head_title: "Pythonを使用してZIPファイルにメタデータを追加"
head_description: "Python APIを使用してZIPファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでZIPファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでZipにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでZIPファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
