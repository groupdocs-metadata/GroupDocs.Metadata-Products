...
############################# Head ############################
head_title: "Додавання метаданих до файлів EML за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли EML. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів EML у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Eml у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів EML у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл EML, який хочете оновити.
