...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas FLV Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas FLV. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas FLV dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Flv dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas FLV dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas FLV yang ingin Anda perbarui.
