...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DXF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DXF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DXF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Dxf en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DXF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DXF que deseas actualizar.
