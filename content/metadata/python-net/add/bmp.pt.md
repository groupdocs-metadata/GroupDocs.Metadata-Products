...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos BMP usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos BMP. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos BMP em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Bmp em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos BMP em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo BMP que deseja atualizar.
