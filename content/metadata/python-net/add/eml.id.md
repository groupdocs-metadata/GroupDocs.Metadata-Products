...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas EML Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas EML. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas EML dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Eml dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas EML dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas EML yang ingin Anda perbarui.
