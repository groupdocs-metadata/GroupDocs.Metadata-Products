...
############################# Head ############################
head_title: "Aggiungi Metadata ai File EPUB utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file EPUB. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File EPUB in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Epub in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file EPUB nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file EPUB che desideri aggiornare.
