...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos PSD usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos PSD. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos PSD em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Psd em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos PSD em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo PSD que deseja atualizar.
