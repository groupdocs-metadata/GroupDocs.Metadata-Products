...
############################# Head ############################
head_title: "Add Metadata to DCM Files using Python"
head_description: "Use the Python API to insert metadata into DCM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to DCM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Dcm in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to DCM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the DCM file you want to update.
