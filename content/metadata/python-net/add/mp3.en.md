...
############################# Head ############################
head_title: "Add Metadata to MP3 Files using Python"
head_description: "Use the Python API to insert metadata into MP3 files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to MP3 Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Mp3 in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to MP3 files in Python apps is straightforward. Just follow these steps.
      
      1. Open the MP3 file you want to update.
