...
############################# Head ############################
head_title: "Add Metadata to XLSM Files using Python"
head_description: "Use the Python API to insert metadata into XLSM files. Work with standards like XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Add Metadata to XLSM Files in Python" 
...
steps:
    enable: true
    title: "How to Add Metadata to Xlsm in Python"
    content: |
      With [GroupDocs.Metadata](/metadata/python-net/), adding metadata to XLSM files in Python apps is straightforward. Just follow these steps.
      
      1. Open the XLSM file you want to update.
