...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas DCM Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas DCM. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas DCM dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Dcm dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas DCM dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas DCM yang ingin Anda perbarui.
