...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos DOTM usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos DOTM. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos DOTM en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Dotm en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos DOTM en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo DOTM que deseas actualizar.
