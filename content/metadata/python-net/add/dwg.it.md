...
############################# Head ############################
head_title: "Aggiungi Metadata ai File DWG utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file DWG. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File DWG in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Dwg in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file DWG nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file DWG che desideri aggiornare.
