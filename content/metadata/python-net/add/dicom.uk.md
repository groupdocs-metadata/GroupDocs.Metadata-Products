...
############################# Head ############################
head_title: "Додавання метаданих до файлів DICOM за допомогою Python"
head_description: "Використовуйте API Python для вставки метаданих у файли DICOM. Працюйте зі стандартами, такими як XMP, EXIF, IPTC, ID3 та інші."

############################# Header ############################
title: "Додавання метаданих до файлів DICOM у Python" 
...
steps:
    enable: true
    title: "Як додати метадані до Dicom у Python"
    content: |
      З [GroupDocs.Metadata](/metadata/python-net/) додавання метаданих до файлів DICOM у додатках Python є простим. Просто дотримуйтесь цих кроків.
      
      1. Відкрийте файл DICOM, який хочете оновити.
