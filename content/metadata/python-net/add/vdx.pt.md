...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos VDX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos VDX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos VDX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Vdx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos VDX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo VDX que deseja atualizar.
