...
############################# Head ############################
head_title: "Aggiungi Metadata ai File JPEG utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file JPEG. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File JPEG in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Jpeg in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file JPEG nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file JPEG che desideri aggiornare.
