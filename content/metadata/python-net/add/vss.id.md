...
############################# Head ############################
head_title: "Tambahkan Metadata ke Berkas VSS Menggunakan Python"
head_description: "Gunakan API Python untuk menyisipkan metadata ke dalam berkas VSS. Bekerja dengan standar seperti XMP, EXIF, IPTC, ID3, dan banyak lagi."

############################# Header ############################
title: "Tambahkan Metadata ke Berkas VSS dalam Python" 
...
steps:
    enable: true
    title: "Cara Menambahkan Metadata ke Vss dalam Python"
    content: |
      Dengan [GroupDocs.Metadata](/metadata/python-net/), menambahkan metadata ke berkas VSS dalam aplikasi Python sangatlah jelas. Cukup ikuti langkah-langkah ini.
      
      1. Buka berkas VSS yang ingin Anda perbarui.
