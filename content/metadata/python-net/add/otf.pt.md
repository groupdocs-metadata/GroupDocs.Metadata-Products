...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos OTF usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos OTF. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos OTF em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Otf em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos OTF em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo OTF que deseja atualizar.
