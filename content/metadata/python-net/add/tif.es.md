...
############################# Head ############################
head_title: "Agregar Metadatos a Archivos TIF usando Python"
head_description: "Utiliza la API de Python para insertar metadatos en archivos TIF. Trabaja con estándares como XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Agregar Metadatos a Archivos TIF en Python" 
...
steps:
    enable: true
    title: "Cómo Agregar Metadatos a Tif en Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), agregar metadatos a archivos TIF en aplicaciones de Python es sencillo. Solo sigue estos pasos.
      
      1. Abre el archivo TIF que deseas actualizar.
