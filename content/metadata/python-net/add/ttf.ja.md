...
############################# Head ############################
head_title: "Pythonを使用してTTFファイルにメタデータを追加"
head_description: "Python APIを使用してTTFファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでTTFファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでTtfにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでTTFファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
