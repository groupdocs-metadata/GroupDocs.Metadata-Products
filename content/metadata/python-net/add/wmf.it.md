...
############################# Head ############################
head_title: "Aggiungi Metadata ai File WMF utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file WMF. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File WMF in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Wmf in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file WMF nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file WMF che desideri aggiornare.
