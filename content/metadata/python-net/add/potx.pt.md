...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos POTX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos POTX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos POTX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Potx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos POTX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo POTX que deseja atualizar.
