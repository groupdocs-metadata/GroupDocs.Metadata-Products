...
############################# Head ############################
head_title: "Aggiungi Metadata ai File POT utilizzando Python"
head_description: "Utilizza l'API Python per inserire metadata nei file POT. Lavora con standard come XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiungi Metadata ai File POT in Python" 
...
steps:
    enable: true
    title: "Come Aggiungere Metadata a Pot in Python"
    content: |
      Con [GroupDocs.Metadata](/metadata/python-net/), aggiungere metadata ai file POT nelle applicazioni Python è semplice. Segui questi passaggi.
      
      1. Apri il file POT che desideri aggiornare.
