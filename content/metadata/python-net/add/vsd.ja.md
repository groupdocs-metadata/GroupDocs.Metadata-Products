...
############################# Head ############################
head_title: "Pythonを使用してVSDファイルにメタデータを追加"
head_description: "Python APIを使用してVSDファイルにメタデータを挿入します。XMP、EXIF、IPTC、ID3などの標準と連携します。"

############################# Header ############################
title: "PythonでVSDファイルにメタデータを追加" 
...
steps:
    enable: true
    title: "PythonでVsdにメタデータを追加する方法"
    content: |
      [GroupDocs.Metadata](/metadata/python-net/)を使用すると、PythonアプリでVSDファイルにメタデータを追加するのは簡単です。以下のステップに従ってください。
