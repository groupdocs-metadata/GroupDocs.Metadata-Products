...
############################# Head ############################
head_title: "Adicionar Metadados a Arquivos XLSX usando Python"
head_description: "Utilize a API Python para inserir metadados em arquivos XLSX. Trabalhe com padrões como XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Adicionar Metadados a Arquivos XLSX em Python" 
...
steps:
    enable: true
    title: "Como Adicionar Metadados a Xlsx em Python"
    content: |
      Com [GroupDocs.Metadata](/metadata/python-net/), adicionar metadados a arquivos XLSX em aplicativos Python é direto. Basta seguir estes passos.
      
      1. Abra o arquivo XLSX que deseja atualizar.
