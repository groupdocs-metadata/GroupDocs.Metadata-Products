...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Msg Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Msg. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Msg com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos MSG Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos MSG seguindo estes passos simples:
      
      1. Carregar o arquivo MSG usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo MSG atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo MSG
        ...
        def run():
            ...
            with gm.Metadata("input.msg") as metadata:
                ...
                # Salvar o arquivo MSG atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos MSG com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags MSG Integradas"
