...
############################# Head ############################
head_title: "Metadaten in Gif-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Gif-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Gif-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in GIF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in GIF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die GIF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte GIF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer GIF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.gif") as metadata:
                ...
                # Speichern Sie die aktualisierte GIF-Datei
...
more_features:
  enable: true
  title: "Metadaten in GIF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten GIF-Tags"
