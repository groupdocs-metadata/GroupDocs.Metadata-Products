...
############################# Head ############################
head_title: "使用 Python 编辑 Potx 文件中的元数据"
head_description: "使用 Python API 修改 Potx 文件中的元数据。支持 XMP、EXIF、IPTC、ID3 和其他元数据格式。"

############################# Header ############################
title: "使用 Python 修改 Potx 文件中的元数据" 
...
steps:
    enable: true
    title: "如何使用 Python 编辑 POTX 文件中的元数据"
    content: |
      使用 [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/)，Python 开发人员可以通过以下简单步骤更新 POTX 文件中的元数据：
      
      1. 使用 Metadata 类加载 POTX 文件。
      2. 定义条件以过滤您想要更改的元数据。
      3. 应用筛选器并设置新值。
      4. 将更新后的 POTX 文件保存到磁盘。
...
more_features:
  enable: true
  title: "使用 Python 编辑 POTX 文件中的元数据"
