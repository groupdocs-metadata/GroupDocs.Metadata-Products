...
############################# Head ############################
head_title: "Metadaten in Vss-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Vss-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Vss-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in VSS-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in VSS-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die VSS-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte VSS-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer VSS-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.vss") as metadata:
                ...
                # Speichern Sie die aktualisierte VSS-Datei
...
more_features:
  enable: true
  title: "Metadaten in VSS-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten VSS-Tags"
