...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Ppsm Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Ppsm. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Ppsm com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos PPSM Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos PPSM seguindo estes passos simples:
      
      1. Carregar o arquivo PPSM usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo PPSM atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo PPSM
        ...
        def run():
            ...
            with gm.Metadata("input.ppsm") as metadata:
                ...
                # Salvar o arquivo PPSM atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos PPSM com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags PPSM Integradas"
