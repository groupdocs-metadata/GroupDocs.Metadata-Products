...
############################# Head ############################
head_title: "Metadaten in Dot-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Dot-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Dot-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DOT-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DOT-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DOT-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DOT-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DOT-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.dot") as metadata:
                ...
                # Speichern Sie die aktualisierte DOT-Datei
...
more_features:
  enable: true
  title: "Metadaten in DOT-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DOT-Tags"
