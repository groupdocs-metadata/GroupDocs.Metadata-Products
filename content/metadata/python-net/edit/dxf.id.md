...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Dxf Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Dxf. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Dxf dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas DXF Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas DXF dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas DXF menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas DXF yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas DXF
        ...
        def run():
            ...
            with gm.Metadata("input.dxf") as metadata:
                ...
                # Simpan berkas DXF yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas DXF dengan Python"
