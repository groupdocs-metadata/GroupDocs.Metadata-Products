...
############################# Head ############################
head_title: "Metadaten in Heif-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Heif-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Heif-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in HEIF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in HEIF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die HEIF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte HEIF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer HEIF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.heif") as metadata:
                ...
                # Speichern Sie die aktualisierte HEIF-Datei
...
more_features:
  enable: true
  title: "Metadaten in HEIF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten HEIF-Tags"
