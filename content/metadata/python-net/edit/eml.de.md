...
############################# Head ############################
head_title: "Metadaten in Eml-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Eml-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Eml-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in EML-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in EML-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die EML-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte EML-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer EML-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.eml") as metadata:
                ...
                # Speichern Sie die aktualisierte EML-Datei
...
more_features:
  enable: true
  title: "Metadaten in EML-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten EML-Tags"
