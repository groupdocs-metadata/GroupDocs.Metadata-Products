...
############################# Head ############################
head_title: "Metadaten in Vsx-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Vsx-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Vsx-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in VSX-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in VSX-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die VSX-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte VSX-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer VSX-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.vsx") as metadata:
                ...
                # Speichern Sie die aktualisierte VSX-Datei
...
more_features:
  enable: true
  title: "Metadaten in VSX-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten VSX-Tags"
