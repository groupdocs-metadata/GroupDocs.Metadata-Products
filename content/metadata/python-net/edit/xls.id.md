...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Xls Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Xls. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Xls dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas XLS Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas XLS dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas XLS menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas XLS yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas XLS
        ...
        def run():
            ...
            with gm.Metadata("input.xls") as metadata:
                ...
                # Simpan berkas XLS yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas XLS dengan Python"
