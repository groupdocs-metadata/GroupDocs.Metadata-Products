...
############################# Head ############################
head_title: "Editar metadatos en archivos Vcr usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Vcr. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Vcr con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos VCR usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos VCR siguiendo estos pasos:
      
      1. Carga el archivo VCR usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo VCR actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo VCR
        ...
        def run():
            ...
            with gm.Metadata("input.vcr") as metadata:
                ...
                # Guardar el archivo VCR actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos VCR con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas VCR integradas"
