...
############################# Head ############################
head_title: "Metadaten in Zip-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Zip-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Zip-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in ZIP-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in ZIP-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die ZIP-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte ZIP-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer ZIP-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.zip") as metadata:
                ...
                # Speichern Sie die aktualisierte ZIP-Datei
...
more_features:
  enable: true
  title: "Metadaten in ZIP-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten ZIP-Tags"
