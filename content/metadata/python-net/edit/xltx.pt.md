...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Xltx Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Xltx. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Xltx com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos XLTX Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos XLTX seguindo estes passos simples:
      
      1. Carregar o arquivo XLTX usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo XLTX atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo XLTX
        ...
        def run():
            ...
            with gm.Metadata("input.xltx") as metadata:
                ...
                # Salvar o arquivo XLTX atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos XLTX com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags XLTX Integradas"
