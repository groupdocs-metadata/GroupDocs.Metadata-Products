...
############################# Head ############################
head_title: "Modifica i Metadata nei File Heic Utilizzando Python"
head_description: "Utilizza l'API Python per modificare i metadata nei file Heic. Supporta i formati di metadata XMP, EXIF, IPTC, ID3 e altri."

############################# Header ############################
title: "Modifica i Metadata nei File Heic con Python" 
...
steps:
    enable: true
    title: "Come Modificare i Metadata nei File HEIC Utilizzando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), gli sviluppatori Python possono aggiornare i metadata nei file HEIC seguendo questi passaggi:
      
      1. Carica il file HEIC utilizzando la classe Metadata.
      2. Definisci una condizione per filtrare i metadata che desideri modificare.
      3. Applica il filtro e imposta il nuovo valore.
      4. Salva il file HEIC aggiornato su disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambia la data di creazione di un file HEIC
...
more_features:
  ...
  features:
    ...
    # feature loop
    - title: "Utilizza i Tag HEIC Integrati"
