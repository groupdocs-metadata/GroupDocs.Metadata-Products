...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Eml Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Eml. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Eml com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos EML Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos EML seguindo estes passos simples:
      
      1. Carregar o arquivo EML usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo EML atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo EML
        ...
        def run():
            ...
            with gm.Metadata("input.eml") as metadata:
                ...
                # Salvar o arquivo EML atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos EML com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags EML Integradas"
