...
############################# Head ############################
head_title: "Metadaten in Otc-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Otc-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Otc-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in OTC-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in OTC-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die OTC-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte OTC-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer OTC-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.otc") as metadata:
                ...
                # Speichern Sie die aktualisierte OTC-Datei
...
more_features:
  enable: true
  title: "Metadaten in OTC-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten OTC-Tags"
