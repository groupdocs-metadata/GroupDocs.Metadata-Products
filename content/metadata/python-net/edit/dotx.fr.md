...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers Dotx avec Python"
head_description: "Utilisez l'API Python pour modifier les métadonnées dans les fichiers Dotx. Prend en charge les formats de métadonnées XMP, EXIF, IPTC, ID3 et d'autres."

############################# Header ############################
title: "Modifiez les métadonnées dans les fichiers Dotx avec Python" 
...
steps:
    enable: true
    title: "Comment modifier les métadonnées dans des fichiers DOTX en utilisant Python"
    content: |
      Avec [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), les développeurs Python peuvent mettre à jour les métadonnées dans des fichiers DOTX en suivant ces étapes simples:
      
      1. Chargez le fichier DOTX en utilisant la classe Metadata.
      ...
      4. Enregistrez le fichier DOTX mis à jour sur disque.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Changer la date de création d'un fichier DOTX
        ...
        def run():
            ...
            with gm.Metadata("input.dotx") as metadata:
                ...
                # Enregistrer le fichier DOTX mis à jour
...
more_features:
  enable: true
  title: "Modifier les métadonnées dans des fichiers DOTX avec Python"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisez les balises DOTX intégrées"
