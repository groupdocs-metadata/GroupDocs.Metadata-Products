...
############################# Head ############################
head_title: "Metadaten in Dotm-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Dotm-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Dotm-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DOTM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DOTM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DOTM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DOTM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DOTM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.dotm") as metadata:
                ...
                # Speichern Sie die aktualisierte DOTM-Datei
...
more_features:
  enable: true
  title: "Metadaten in DOTM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DOTM-Tags"
