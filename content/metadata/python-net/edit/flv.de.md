...
############################# Head ############################
head_title: "Metadaten in Flv-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Flv-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Flv-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in FLV-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in FLV-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die FLV-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte FLV-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer FLV-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.flv") as metadata:
                ...
                # Speichern Sie die aktualisierte FLV-Datei
...
more_features:
  enable: true
  title: "Metadaten in FLV-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten FLV-Tags"
