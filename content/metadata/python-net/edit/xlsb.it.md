...
############################# Head ############################
head_title: "Modifica i Metadata nei File Xlsb Utilizzando Python"
head_description: "Utilizza l'API Python per modificare i metadata nei file Xlsb. Supporta i formati di metadata XMP, EXIF, IPTC, ID3 e altri."

############################# Header ############################
title: "Modifica i Metadata nei File Xlsb con Python" 
...
steps:
    enable: true
    title: "Come Modificare i Metadata nei File XLSB Utilizzando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), gli sviluppatori Python possono aggiornare i metadata nei file XLSB seguendo questi passaggi:
      
      1. Carica il file XLSB utilizzando la classe Metadata.
      2. Definisci una condizione per filtrare i metadata che desideri modificare.
      3. Applica il filtro e imposta il nuovo valore.
      4. Salva il file XLSB aggiornato su disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambia la data di creazione di un file XLSB
...
more_features:
  ...
  features:
    ...
    # feature loop
    - title: "Utilizza i Tag XLSB Integrati"
