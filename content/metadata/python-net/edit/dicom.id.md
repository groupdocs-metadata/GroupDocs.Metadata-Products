...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Dicom Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Dicom. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Dicom dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas DICOM Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas DICOM dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas DICOM menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas DICOM yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas DICOM
        ...
        def run():
            ...
            with gm.Metadata("input.dicom") as metadata:
                ...
                # Simpan berkas DICOM yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas DICOM dengan Python"
  ...
  features:
    ...
    # feature loop
    - title: "Gunakan Tag DICOM Bawaan"
