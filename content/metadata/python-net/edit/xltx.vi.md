...
############################# Head ############################
head_title: "Chỉnh sửa siêu dữ liệu trong các tệp Xltx bằng Python"
head_description: "Sử dụng API Python để chỉnh sửa siêu dữ liệu trong các tệp Xltx. Hỗ trợ các định dạng siêu dữ liệu như XMP, EXIF, IPTC, ID3 và các định dạng khác."

############################# Header ############################
title: "Chỉnh sửa siêu dữ liệu trong các tệp Xltx bằng Python" 
...
steps:
    enable: true
    title: "Cách chỉnh sửa siêu dữ liệu trong các tệp XLTX bằng Python"
    content: |
      Với [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), các nhà phát triển Python có thể cập nhật siêu dữ liệu trong các tệp XLTX bằng cách làm theo các bước đơn giản sau:
      
      1. Tải tệp XLTX bằng cách sử dụng lớp Metadata.
      2. Định nghĩa một điều kiện để lọc siêu dữ liệu mà bạn muốn thay đổi.
      3. Áp dụng bộ lọc và đặt giá trị mới.
      4. Lưu tệp XLTX đã được cập nhật vào đĩa.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Thay đổi ngày tạo của tệp XLTX
...
more_features:
  ...
  features:
    ...
    # feature loop
    - title: "Sử dụng các thẻ XLTX tích hợp sẵn"
