...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Dwg Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Dwg. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Dwg com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos DWG Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos DWG seguindo estes passos simples:
      
      1. Carregar o arquivo DWG usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo DWG atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo DWG
        ...
        def run():
            ...
            with gm.Metadata("input.dwg") as metadata:
                ...
                # Salvar o arquivo DWG atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos DWG com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags DWG Integradas"
