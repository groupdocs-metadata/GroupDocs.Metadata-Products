...
############################# Head ############################
head_title: "Metadaten in Jp2-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Jp2-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Jp2-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in JP2-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in JP2-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die JP2-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte JP2-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer JP2-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.jp2") as metadata:
                ...
                # Speichern Sie die aktualisierte JP2-Datei
...
more_features:
  enable: true
  title: "Metadaten in JP2-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten JP2-Tags"
