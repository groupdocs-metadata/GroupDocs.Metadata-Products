...
############################# Head ############################
head_title: "Editar metadatos en archivos Asf usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Asf. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Asf con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos ASF usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos ASF siguiendo estos pasos:
      
      1. Carga el archivo ASF usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo ASF actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo ASF
        ...
        def run():
            ...
            with gm.Metadata("input.asf") as metadata:
                ...
                # Guardar el archivo ASF actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos ASF con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas ASF integradas"
