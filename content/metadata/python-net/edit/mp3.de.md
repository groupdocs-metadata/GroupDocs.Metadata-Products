...
############################# Head ############################
head_title: "Metadaten in Mp3-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Mp3-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Mp3-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in MP3-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in MP3-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die MP3-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte MP3-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer MP3-Datei
...
more_features:
  enable: true
  title: "Metadaten in MP3-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten MP3-Tags"
