...
############################# Head ############################
head_title: "Metadaten in Otf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Otf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Otf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in OTF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in OTF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die OTF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte OTF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer OTF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.otf") as metadata:
                ...
                # Speichern Sie die aktualisierte OTF-Datei
...
more_features:
  enable: true
  title: "Metadaten in OTF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten OTF-Tags"
