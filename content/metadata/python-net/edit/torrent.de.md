...
############################# Head ############################
head_title: "Metadaten in Torrent-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Torrent-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Torrent-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in TORRENT-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in TORRENT-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die TORRENT-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte TORRENT-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer TORRENT-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.torrent") as metadata:
                ...
                # Speichern Sie die aktualisierte TORRENT-Datei
...
more_features:
  enable: true
  title: "Metadaten in TORRENT-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten TORRENT-Tags"
