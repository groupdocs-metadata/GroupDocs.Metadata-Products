...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers Asf avec Python"
head_description: "Utilisez l'API Python pour modifier les métadonnées dans les fichiers Asf. Prend en charge les formats de métadonnées XMP, EXIF, IPTC, ID3 et d'autres."

############################# Header ############################
title: "Modifiez les métadonnées dans les fichiers Asf avec Python" 
...
steps:
    enable: true
    title: "Comment modifier les métadonnées dans des fichiers ASF en utilisant Python"
    content: |
      Avec [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), les développeurs Python peuvent mettre à jour les métadonnées dans des fichiers ASF en suivant ces étapes simples:
      
      1. Chargez le fichier ASF en utilisant la classe Metadata.
      ...
      4. Enregistrez le fichier ASF mis à jour sur disque.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Changer la date de création d'un fichier ASF
        ...
        def run():
            ...
            with gm.Metadata("input.asf") as metadata:
                ...
                # Enregistrer le fichier ASF mis à jour
...
more_features:
  enable: true
  title: "Modifier les métadonnées dans des fichiers ASF avec Python"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisez les balises ASF intégrées"
