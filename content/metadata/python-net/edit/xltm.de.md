...
############################# Head ############################
head_title: "Metadaten in Xltm-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Xltm-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Xltm-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in XLTM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in XLTM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die XLTM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte XLTM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer XLTM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.xltm") as metadata:
                ...
                # Speichern Sie die aktualisierte XLTM-Datei
...
more_features:
  enable: true
  title: "Metadaten in XLTM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten XLTM-Tags"
