...
############################# Head ############################
head_title: "Editar metadatos en archivos Avi usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Avi. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Avi con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos AVI usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos AVI siguiendo estos pasos:
      
      1. Carga el archivo AVI usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo AVI actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo AVI
        ...
        def run():
            ...
            with gm.Metadata("input.avi") as metadata:
                ...
                # Guardar el archivo AVI actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos AVI con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas AVI integradas"
