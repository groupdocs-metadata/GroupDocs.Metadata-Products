...
############################# Head ############################
head_title: "Metadaten in Jpeg-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Jpeg-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Jpeg-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in JPEG-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in JPEG-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die JPEG-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte JPEG-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer JPEG-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.jpeg") as metadata:
                ...
                # Speichern Sie die aktualisierte JPEG-Datei
...
more_features:
  enable: true
  title: "Metadaten in JPEG-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten JPEG-Tags"
