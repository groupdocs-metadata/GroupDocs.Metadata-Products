...
############################# Head ############################
head_title: "Metadaten in Pot-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Pot-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Pot-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in POT-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in POT-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die POT-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte POT-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer POT-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.pot") as metadata:
                ...
                # Speichern Sie die aktualisierte POT-Datei
...
more_features:
  enable: true
  title: "Metadaten in POT-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten POT-Tags"
