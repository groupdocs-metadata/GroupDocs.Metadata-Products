...
############################# Head ############################
head_title: "Metadaten in Potm-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Potm-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Potm-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in POTM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in POTM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die POTM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte POTM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer POTM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.potm") as metadata:
                ...
                # Speichern Sie die aktualisierte POTM-Datei
...
more_features:
  enable: true
  title: "Metadaten in POTM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten POTM-Tags"
