...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Png Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Png. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Png dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas PNG Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas PNG dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas PNG menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas PNG yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas PNG
        ...
        def run():
            ...
            with gm.Metadata("input.png") as metadata:
                ...
                # Simpan berkas PNG yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas PNG dengan Python"
