...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers Pot avec Python"
head_description: "Utilisez l'API Python pour modifier les métadonnées dans les fichiers Pot. Prend en charge les formats de métadonnées XMP, EXIF, IPTC, ID3 et d'autres."

############################# Header ############################
title: "Modifiez les métadonnées dans les fichiers Pot avec Python" 
...
steps:
    enable: true
    title: "Comment modifier les métadonnées dans des fichiers POT en utilisant Python"
    content: |
      Avec [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), les développeurs Python peuvent mettre à jour les métadonnées dans des fichiers POT en suivant ces étapes simples:
      
      1. Chargez le fichier POT en utilisant la classe Metadata.
      ...
      4. Enregistrez le fichier POT mis à jour sur disque.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Changer la date de création d'un fichier POT
        ...
        def run():
            ...
            with gm.Metadata("input.pot") as metadata:
                ...
                # Enregistrer le fichier POT mis à jour
...
more_features:
  enable: true
  title: "Modifier les métadonnées dans des fichiers POT avec Python"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisez les balises POT intégrées"
