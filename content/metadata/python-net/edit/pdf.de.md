...
############################# Head ############################
head_title: "Metadaten in Pdf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Pdf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Pdf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in PDF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in PDF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die PDF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte PDF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer PDF-Datei
...
more_features:
  enable: true
  title: "Metadaten in PDF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten PDF-Tags"
