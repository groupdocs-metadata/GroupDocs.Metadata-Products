...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Heif Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Heif. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Heif com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos HEIF Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos HEIF seguindo estes passos simples:
      
      1. Carregar o arquivo HEIF usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo HEIF atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo HEIF
        ...
        def run():
            ...
            with gm.Metadata("input.heif") as metadata:
                ...
                # Salvar o arquivo HEIF atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos HEIF com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags HEIF Integradas"
