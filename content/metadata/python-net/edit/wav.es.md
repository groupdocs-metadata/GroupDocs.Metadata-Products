...
############################# Head ############################
head_title: "Editar metadatos en archivos Wav usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Wav. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Wav con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos WAV usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos WAV siguiendo estos pasos:
      
      1. Carga el archivo WAV usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo WAV actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo WAV
        ...
        def run():
            ...
            with gm.Metadata("input.wav") as metadata:
                ...
                # Guardar el archivo WAV actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos WAV con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas WAV integradas"
