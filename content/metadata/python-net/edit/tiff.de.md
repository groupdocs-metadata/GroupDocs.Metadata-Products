...
############################# Head ############################
head_title: "Metadaten in Tiff-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Tiff-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Tiff-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in TIFF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in TIFF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die TIFF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte TIFF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer TIFF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.tiff") as metadata:
                ...
                # Speichern Sie die aktualisierte TIFF-Datei
...
more_features:
  enable: true
  title: "Metadaten in TIFF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten TIFF-Tags"
