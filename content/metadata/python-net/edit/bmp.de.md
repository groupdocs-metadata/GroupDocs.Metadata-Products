...
############################# Head ############################
head_title: "Metadaten in Bmp-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Bmp-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Bmp-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in BMP-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in BMP-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die BMP-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte BMP-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer BMP-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.bmp") as metadata:
                ...
                # Speichern Sie die aktualisierte BMP-Datei
...
more_features:
  enable: true
  title: "Metadaten in BMP-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten BMP-Tags"
