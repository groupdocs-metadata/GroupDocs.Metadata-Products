...
############################# Head ############################
head_title: "Metadaten in Ppsm-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Ppsm-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Ppsm-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in PPSM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in PPSM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die PPSM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte PPSM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer PPSM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.ppsm") as metadata:
                ...
                # Speichern Sie die aktualisierte PPSM-Datei
...
more_features:
  enable: true
  title: "Metadaten in PPSM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten PPSM-Tags"
