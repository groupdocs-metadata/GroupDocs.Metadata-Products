...
############################# Head ############################
head_title: "Editar metadatos en archivos Docx usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Docx. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Docx con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos DOCX usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos DOCX siguiendo estos pasos:
      
      1. Carga el archivo DOCX usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo DOCX actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo DOCX
        ...
        def run():
            ...
            with gm.Metadata("input.docx") as metadata:
                ...
                # Guardar el archivo DOCX actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos DOCX con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas DOCX integradas"
