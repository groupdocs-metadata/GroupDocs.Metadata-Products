...
############################# Head ############################
head_title: "Metadaten in Ods-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Ods-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Ods-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in ODS-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in ODS-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die ODS-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte ODS-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer ODS-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.ods") as metadata:
                ...
                # Speichern Sie die aktualisierte ODS-Datei
...
more_features:
  enable: true
  title: "Metadaten in ODS-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten ODS-Tags"
