...
############################# Head ############################
head_title: "Metadaten in Mpt-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Mpt-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Mpt-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in MPT-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in MPT-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die MPT-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte MPT-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer MPT-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.mpt") as metadata:
                ...
                # Speichern Sie die aktualisierte MPT-Datei
...
more_features:
  enable: true
  title: "Metadaten in MPT-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten MPT-Tags"
