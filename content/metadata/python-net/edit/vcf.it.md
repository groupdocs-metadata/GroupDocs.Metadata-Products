...
############################# Head ############################
head_title: "Modifica i Metadata nei File Vcf Utilizzando Python"
head_description: "Utilizza l'API Python per modificare i metadata nei file Vcf. Supporta i formati di metadata XMP, EXIF, IPTC, ID3 e altri."

############################# Header ############################
title: "Modifica i Metadata nei File Vcf con Python" 
...
steps:
    enable: true
    title: "Come Modificare i Metadata nei File VCF Utilizzando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), gli sviluppatori Python possono aggiornare i metadata nei file VCF seguendo questi passaggi:
      
      1. Carica il file VCF utilizzando la classe Metadata.
      2. Definisci una condizione per filtrare i metadata che desideri modificare.
      3. Applica il filtro e imposta il nuovo valore.
      4. Salva il file VCF aggiornato su disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambia la data di creazione di un file VCF
...
more_features:
  ...
  features:
    ...
    # feature loop
    - title: "Utilizza i Tag VCF Integrati"
