...
############################# Head ############################
head_title: "Metadaten in Pps-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Pps-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Pps-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in PPS-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in PPS-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die PPS-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte PPS-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer PPS-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.pps") as metadata:
                ...
                # Speichern Sie die aktualisierte PPS-Datei
...
more_features:
  enable: true
  title: "Metadaten in PPS-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten PPS-Tags"
