...
############################# Head ############################
head_title: "Metadaten in Vcr-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Vcr-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Vcr-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in VCR-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in VCR-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die VCR-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte VCR-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer VCR-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.vcr") as metadata:
                ...
                # Speichern Sie die aktualisierte VCR-Datei
...
more_features:
  enable: true
  title: "Metadaten in VCR-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten VCR-Tags"
