...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Jp2 Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Jp2. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Jp2 dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas JP2 Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas JP2 dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas JP2 menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas JP2 yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas JP2
        ...
        def run():
            ...
            with gm.Metadata("input.jp2") as metadata:
                ...
                # Simpan berkas JP2 yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas JP2 dengan Python"
