...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Odt Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Odt. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Odt dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas ODT Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas ODT dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas ODT menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas ODT yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas ODT
        ...
        def run():
            ...
            with gm.Metadata("input.odt") as metadata:
                ...
                # Simpan berkas ODT yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas ODT dengan Python"
