...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Ppsx Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Ppsx. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Ppsx com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos PPSX Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos PPSX seguindo estes passos simples:
      
      1. Carregar o arquivo PPSX usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo PPSX atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo PPSX
        ...
        def run():
            ...
            with gm.Metadata("input.ppsx") as metadata:
                ...
                # Salvar o arquivo PPSX atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos PPSX com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags PPSX Integradas"
