...
############################# Head ############################
head_title: "Metadaten in Xlt-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Xlt-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Xlt-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in XLT-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in XLT-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die XLT-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte XLT-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer XLT-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.xlt") as metadata:
                ...
                # Speichern Sie die aktualisierte XLT-Datei
...
more_features:
  enable: true
  title: "Metadaten in XLT-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten XLT-Tags"
