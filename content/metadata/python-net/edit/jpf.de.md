...
############################# Head ############################
head_title: "Metadaten in Jpf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Jpf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Jpf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in JPF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in JPF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die JPF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte JPF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer JPF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.jpf") as metadata:
                ...
                # Speichern Sie die aktualisierte JPF-Datei
...
more_features:
  enable: true
  title: "Metadaten in JPF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten JPF-Tags"
