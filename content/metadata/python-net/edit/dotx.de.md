...
############################# Head ############################
head_title: "Metadaten in Dotx-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Dotx-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Dotx-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DOTX-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DOTX-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DOTX-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DOTX-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DOTX-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.dotx") as metadata:
                ...
                # Speichern Sie die aktualisierte DOTX-Datei
...
more_features:
  enable: true
  title: "Metadaten in DOTX-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DOTX-Tags"
