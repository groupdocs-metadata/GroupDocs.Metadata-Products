...
############################# Head ############################
head_title: "Editar metadatos en archivos Jp2 usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Jp2. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Jp2 con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos JP2 usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos JP2 siguiendo estos pasos:
      
      1. Carga el archivo JP2 usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo JP2 actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo JP2
        ...
        def run():
            ...
            with gm.Metadata("input.jp2") as metadata:
                ...
                # Guardar el archivo JP2 actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos JP2 con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas JP2 integradas"
