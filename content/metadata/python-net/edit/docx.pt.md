...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Docx Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Docx. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Docx com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos DOCX Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos DOCX seguindo estes passos simples:
      
      1. Carregar o arquivo DOCX usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo DOCX atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo DOCX
        ...
        def run():
            ...
            with gm.Metadata("input.docx") as metadata:
                ...
                # Salvar o arquivo DOCX atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos DOCX com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags DOCX Integradas"
