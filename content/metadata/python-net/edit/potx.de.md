...
############################# Head ############################
head_title: "Metadaten in Potx-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Potx-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Potx-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in POTX-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in POTX-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die POTX-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte POTX-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer POTX-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.potx") as metadata:
                ...
                # Speichern Sie die aktualisierte POTX-Datei
...
more_features:
  enable: true
  title: "Metadaten in POTX-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten POTX-Tags"
