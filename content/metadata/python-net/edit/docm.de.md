...
############################# Head ############################
head_title: "Metadaten in Docm-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Docm-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Docm-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DOCM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DOCM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DOCM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DOCM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DOCM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.docm") as metadata:
                ...
                # Speichern Sie die aktualisierte DOCM-Datei
...
more_features:
  enable: true
  title: "Metadaten in DOCM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DOCM-Tags"
