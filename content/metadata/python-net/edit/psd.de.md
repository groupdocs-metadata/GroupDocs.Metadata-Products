...
############################# Head ############################
head_title: "Metadaten in Psd-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Psd-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Psd-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in PSD-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in PSD-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die PSD-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte PSD-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer PSD-Datei
...
more_features:
  enable: true
  title: "Metadaten in PSD-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten PSD-Tags"
