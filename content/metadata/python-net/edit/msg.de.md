...
############################# Head ############################
head_title: "Metadaten in Msg-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Msg-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Msg-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in MSG-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in MSG-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die MSG-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte MSG-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer MSG-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.msg") as metadata:
                ...
                # Speichern Sie die aktualisierte MSG-Datei
...
more_features:
  enable: true
  title: "Metadaten in MSG-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten MSG-Tags"
