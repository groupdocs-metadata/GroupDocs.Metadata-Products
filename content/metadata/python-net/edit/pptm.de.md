...
############################# Head ############################
head_title: "Metadaten in Pptm-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Pptm-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Pptm-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in PPTM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in PPTM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die PPTM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte PPTM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer PPTM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.pptm") as metadata:
                ...
                # Speichern Sie die aktualisierte PPTM-Datei
...
more_features:
  enable: true
  title: "Metadaten in PPTM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten PPTM-Tags"
