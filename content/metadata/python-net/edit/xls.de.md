...
############################# Head ############################
head_title: "Metadaten in Xls-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Xls-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Xls-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in XLS-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in XLS-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die XLS-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte XLS-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer XLS-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.xls") as metadata:
                ...
                # Speichern Sie die aktualisierte XLS-Datei
...
more_features:
  enable: true
  title: "Metadaten in XLS-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten XLS-Tags"
