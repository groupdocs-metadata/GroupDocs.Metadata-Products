...
############################# Head ############################
head_title: "Editar metadatos en archivos Ppsm usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Ppsm. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Ppsm con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos PPSM usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos PPSM siguiendo estos pasos:
      
      1. Carga el archivo PPSM usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo PPSM actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo PPSM
        ...
        def run():
            ...
            with gm.Metadata("input.ppsm") as metadata:
                ...
                # Guardar el archivo PPSM actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos PPSM con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas PPSM integradas"
