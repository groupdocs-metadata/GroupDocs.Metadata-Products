...
############################# Head ############################
head_title: "Edit Metadata in Eml Files Using Python"
head_description: "Use the Python API to modify metadata in Eml files. Supports XMP, EXIF, IPTC, ID3, and other metadata formats."

############################# Header ############################
title: "Modify Metadata in Eml Files with Python" 
...
steps:
    enable: true
    title: "How to Edit Metadata in EML Files Using Python"
    content: |
      With [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), Python developers can update metadata in EML files by following these simple steps:
      
      1. Load the EML file using the Metadata class.
      2. Define a condition to filter the metadata you want to change.
      3. Apply the filter and set the new value.
      4. Save the updated EML file to disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Change the creation date of a EML file
...
more_features:
  enable: true
  title: "Edit Metadata in EML Files with Python"
