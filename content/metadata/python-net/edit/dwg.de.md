...
############################# Head ############################
head_title: "Metadaten in Dwg-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Dwg-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Dwg-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DWG-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DWG-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DWG-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DWG-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DWG-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.dwg") as metadata:
                ...
                # Speichern Sie die aktualisierte DWG-Datei
...
more_features:
  enable: true
  title: "Metadaten in DWG-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DWG-Tags"
