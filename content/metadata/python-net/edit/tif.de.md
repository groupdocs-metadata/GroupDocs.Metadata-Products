...
############################# Head ############################
head_title: "Metadaten in Tif-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Tif-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Tif-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in TIF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in TIF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die TIF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte TIF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer TIF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.tif") as metadata:
                ...
                # Speichern Sie die aktualisierte TIF-Datei
...
more_features:
  enable: true
  title: "Metadaten in TIF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten TIF-Tags"
