...
############################# Head ############################
head_title: "Metadaten in Xlsm-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Xlsm-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Xlsm-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in XLSM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in XLSM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die XLSM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte XLSM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer XLSM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.xlsm") as metadata:
                ...
                # Speichern Sie die aktualisierte XLSM-Datei
...
more_features:
  enable: true
  title: "Metadaten in XLSM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten XLSM-Tags"
