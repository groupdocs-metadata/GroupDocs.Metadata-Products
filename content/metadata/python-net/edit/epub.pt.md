...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Epub Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Epub. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Epub com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos EPUB Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos EPUB seguindo estes passos simples:
      
      1. Carregar o arquivo EPUB usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo EPUB atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo EPUB
        ...
        def run():
            ...
            with gm.Metadata("input.epub") as metadata:
                ...
                # Salvar o arquivo EPUB atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos EPUB com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags EPUB Integradas"
