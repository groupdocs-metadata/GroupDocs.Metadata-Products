...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Torrent Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Torrent. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Torrent dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas TORRENT Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas TORRENT dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas TORRENT menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas TORRENT yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas TORRENT
        ...
        def run():
            ...
            with gm.Metadata("input.torrent") as metadata:
                ...
                # Simpan berkas TORRENT yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas TORRENT dengan Python"
  ...
  features:
    ...
    # feature loop
    - title: "Gunakan Tag TORRENT Bawaan"
