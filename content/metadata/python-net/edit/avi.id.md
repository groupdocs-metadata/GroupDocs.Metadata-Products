...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Avi Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Avi. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Avi dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas AVI Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas AVI dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas AVI menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas AVI yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas AVI
        ...
        def run():
            ...
            with gm.Metadata("input.avi") as metadata:
                ...
                # Simpan berkas AVI yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas AVI dengan Python"
