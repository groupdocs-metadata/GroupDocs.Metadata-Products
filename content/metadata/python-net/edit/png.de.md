...
############################# Head ############################
head_title: "Metadaten in Png-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Png-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Png-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in PNG-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in PNG-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die PNG-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte PNG-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer PNG-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.png") as metadata:
                ...
                # Speichern Sie die aktualisierte PNG-Datei
...
more_features:
  enable: true
  title: "Metadaten in PNG-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten PNG-Tags"
