...
############################# Head ############################
head_title: "Metadaten in Pptx-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Pptx-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Pptx-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in PPTX-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in PPTX-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die PPTX-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte PPTX-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer PPTX-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.pptx") as metadata:
                ...
                # Speichern Sie die aktualisierte PPTX-Datei
...
more_features:
  enable: true
  title: "Metadaten in PPTX-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten PPTX-Tags"
