...
############################# Head ############################
head_title: "Metadaten in Ttf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Ttf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Ttf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in TTF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in TTF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die TTF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte TTF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer TTF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.ttf") as metadata:
                ...
                # Speichern Sie die aktualisierte TTF-Datei
...
more_features:
  enable: true
  title: "Metadaten in TTF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten TTF-Tags"
