...
############################# Head ############################
head_title: "Editar metadatos en archivos Potm usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Potm. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Potm con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos POTM usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos POTM siguiendo estos pasos:
      
      1. Carga el archivo POTM usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo POTM actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo POTM
        ...
        def run():
            ...
            with gm.Metadata("input.potm") as metadata:
                ...
                # Guardar el archivo POTM actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos POTM con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas POTM integradas"
