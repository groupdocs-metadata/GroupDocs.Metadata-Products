...
############################# Head ############################
head_title: "Editar metadatos en archivos Torrent usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Torrent. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Torrent con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos TORRENT usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos TORRENT siguiendo estos pasos:
      
      1. Carga el archivo TORRENT usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo TORRENT actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo TORRENT
        ...
        def run():
            ...
            with gm.Metadata("input.torrent") as metadata:
                ...
                # Guardar el archivo TORRENT actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos TORRENT con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas TORRENT integradas"
