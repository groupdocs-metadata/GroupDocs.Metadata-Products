...
############################# Head ############################
head_title: "Metadaten in Wmf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Wmf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Wmf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in WMF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in WMF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die WMF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte WMF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer WMF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.wmf") as metadata:
                ...
                # Speichern Sie die aktualisierte WMF-Datei
...
more_features:
  enable: true
  title: "Metadaten in WMF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten WMF-Tags"
