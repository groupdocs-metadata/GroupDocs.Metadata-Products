...
############################# Head ############################
head_title: "Metadaten in Jpg-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Jpg-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Jpg-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in JPG-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in JPG-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die JPG-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte JPG-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer JPG-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.jpg") as metadata:
                ...
                # Speichern Sie die aktualisierte JPG-Datei
...
more_features:
  enable: true
  title: "Metadaten in JPG-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten JPG-Tags"
