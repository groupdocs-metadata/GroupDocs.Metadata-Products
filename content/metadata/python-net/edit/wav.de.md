...
############################# Head ############################
head_title: "Metadaten in Wav-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Wav-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Wav-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in WAV-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in WAV-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die WAV-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte WAV-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer WAV-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.wav") as metadata:
                ...
                # Speichern Sie die aktualisierte WAV-Datei
...
more_features:
  enable: true
  title: "Metadaten in WAV-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten WAV-Tags"
