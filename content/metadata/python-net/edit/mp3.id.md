...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Mp3 Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Mp3. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Mp3 dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas MP3 Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas MP3 dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas MP3 menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas MP3 yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas MP3
        ...
        def run():
            ...
            with gm.Metadata("input.mp3") as metadata:
                ...
                # Simpan berkas MP3 yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas MP3 dengan Python"
