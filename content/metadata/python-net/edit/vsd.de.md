...
############################# Head ############################
head_title: "Metadaten in Vsd-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Vsd-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Vsd-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in VSD-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in VSD-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die VSD-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte VSD-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer VSD-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.vsd") as metadata:
                ...
                # Speichern Sie die aktualisierte VSD-Datei
...
more_features:
  enable: true
  title: "Metadaten in VSD-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten VSD-Tags"
