...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers Vsx avec Python"
head_description: "Utilisez l'API Python pour modifier les métadonnées dans les fichiers Vsx. Prend en charge les formats de métadonnées XMP, EXIF, IPTC, ID3 et d'autres."

############################# Header ############################
title: "Modifiez les métadonnées dans les fichiers Vsx avec Python" 
...
steps:
    enable: true
    title: "Comment modifier les métadonnées dans des fichiers VSX en utilisant Python"
    content: |
      Avec [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), les développeurs Python peuvent mettre à jour les métadonnées dans des fichiers VSX en suivant ces étapes simples:
      
      1. Chargez le fichier VSX en utilisant la classe Metadata.
      ...
      4. Enregistrez le fichier VSX mis à jour sur disque.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Changer la date de création d'un fichier VSX
        ...
        def run():
            ...
            with gm.Metadata("input.vsx") as metadata:
                ...
                # Enregistrer le fichier VSX mis à jour
...
more_features:
  enable: true
  title: "Modifier les métadonnées dans des fichiers VSX avec Python"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisez les balises VSX intégrées"
