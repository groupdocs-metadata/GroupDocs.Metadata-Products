...
############################# Head ############################
head_title: "Metadaten in Djvu-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Djvu-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Djvu-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DJVU-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DJVU-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DJVU-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DJVU-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DJVU-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.djvu") as metadata:
                ...
                # Speichern Sie die aktualisierte DJVU-Datei
...
more_features:
  enable: true
  title: "Metadaten in DJVU-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DJVU-Tags"
