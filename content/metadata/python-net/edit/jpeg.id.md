...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Jpeg Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Jpeg. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Jpeg dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas JPEG Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas JPEG dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas JPEG menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas JPEG yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas JPEG
        ...
        def run():
            ...
            with gm.Metadata("input.jpeg") as metadata:
                ...
                # Simpan berkas JPEG yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas JPEG dengan Python"
