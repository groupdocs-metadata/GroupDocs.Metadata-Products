...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Xlsm Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Xlsm. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Xlsm com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos XLSM Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos XLSM seguindo estes passos simples:
      
      1. Carregar o arquivo XLSM usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo XLSM atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo XLSM
        ...
        def run():
            ...
            with gm.Metadata("input.xlsm") as metadata:
                ...
                # Salvar o arquivo XLSM atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos XLSM com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags XLSM Integradas"
