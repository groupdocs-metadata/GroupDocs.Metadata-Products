...
############################# Head ############################
head_title: "Metadaten in Doc-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Doc-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Doc-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DOC-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DOC-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DOC-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DOC-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DOC-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.doc") as metadata:
                ...
                # Speichern Sie die aktualisierte DOC-Datei
...
more_features:
  enable: true
  title: "Metadaten in DOC-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DOC-Tags"
