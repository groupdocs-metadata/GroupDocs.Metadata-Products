...
############################# Head ############################
head_title: "Editar metadatos en archivos Pdf usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Pdf. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Pdf con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos PDF usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos PDF siguiendo estos pasos:
      
      1. Carga el archivo PDF usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo PDF actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo PDF
...
more_features:
  enable: true
  title: "Editar metadatos en archivos PDF con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas PDF integradas"
