...
############################# Head ############################
head_title: "Metadaten in Asf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Asf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Asf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in ASF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in ASF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die ASF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte ASF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer ASF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.asf") as metadata:
                ...
                # Speichern Sie die aktualisierte ASF-Datei
...
more_features:
  enable: true
  title: "Metadaten in ASF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten ASF-Tags"
