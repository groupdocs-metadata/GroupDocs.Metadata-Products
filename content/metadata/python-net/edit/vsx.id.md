...
############################# Head ############################
head_title: "Edit Metadata dalam Berkas Vsx Menggunakan Python"
head_description: "Gunakan API Python untuk mengubah metadata dalam berkas Vsx. Mendukung format metadata XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Modifikasi Metadata dalam Berkas Vsx dengan Python" 
...
steps:
    enable: true
    title: "Cara Mengedit Metadata dalam Berkas VSX Menggunakan Python"
    content: |
      Dengan [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), pengembang Python dapat memperbarui metadata dalam berkas VSX dengan mengikuti langkah-langkah sederhana berikut:
      
      1. Muat berkas VSX menggunakan kelas Metadata.
      2. Tentukan kondisi untuk memfilter metadata yang ingin diubah.
      3. Terapkan filter dan tetapkan nilai baru.
      4. Simpan berkas VSX yang telah diperbarui ke disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ubah tanggal pembuatan berkas VSX
        ...
        def run():
            ...
            with gm.Metadata("input.vsx") as metadata:
                ...
                # Simpan berkas VSX yang telah diperbarui
...
more_features:
  enable: true
  title: "Edit Metadata dalam Berkas VSX dengan Python"
