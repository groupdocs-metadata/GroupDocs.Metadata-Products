...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Dicom Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Dicom. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Dicom com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos DICOM Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos DICOM seguindo estes passos simples:
      
      1. Carregar o arquivo DICOM usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo DICOM atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo DICOM
        ...
        def run():
            ...
            with gm.Metadata("input.dicom") as metadata:
                ...
                # Salvar o arquivo DICOM atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos DICOM com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags DICOM Integradas"
