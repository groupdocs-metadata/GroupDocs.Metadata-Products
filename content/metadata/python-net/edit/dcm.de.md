...
############################# Head ############################
head_title: "Metadaten in Dcm-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Dcm-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Dcm-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DCM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DCM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DCM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DCM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DCM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.dcm") as metadata:
                ...
                # Speichern Sie die aktualisierte DCM-Datei
...
more_features:
  enable: true
  title: "Metadaten in DCM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DCM-Tags"
