...
############################# Head ############################
head_title: "Metadaten in Heic-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Heic-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Heic-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in HEIC-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in HEIC-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die HEIC-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte HEIC-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer HEIC-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.heic") as metadata:
                ...
                # Speichern Sie die aktualisierte HEIC-Datei
...
more_features:
  enable: true
  title: "Metadaten in HEIC-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten HEIC-Tags"
