...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Asf Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Asf. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Asf com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos ASF Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos ASF seguindo estes passos simples:
      
      1. Carregar o arquivo ASF usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo ASF atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo ASF
        ...
        def run():
            ...
            with gm.Metadata("input.asf") as metadata:
                ...
                # Salvar o arquivo ASF atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos ASF com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags ASF Integradas"
