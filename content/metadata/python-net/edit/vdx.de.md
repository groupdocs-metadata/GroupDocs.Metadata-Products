...
############################# Head ############################
head_title: "Metadaten in Vdx-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Vdx-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Vdx-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in VDX-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in VDX-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die VDX-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte VDX-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer VDX-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.vdx") as metadata:
                ...
                # Speichern Sie die aktualisierte VDX-Datei
...
more_features:
  enable: true
  title: "Metadaten in VDX-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten VDX-Tags"
