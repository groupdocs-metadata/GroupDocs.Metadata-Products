...
############################# Head ############################
head_title: "Metadaten in Vcf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Vcf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Vcf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in VCF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in VCF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die VCF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte VCF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer VCF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.vcf") as metadata:
                ...
                # Speichern Sie die aktualisierte VCF-Datei
...
more_features:
  enable: true
  title: "Metadaten in VCF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten VCF-Tags"
