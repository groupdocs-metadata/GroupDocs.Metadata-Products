...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Xlt Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Xlt. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Xlt com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos XLT Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos XLT seguindo estes passos simples:
      
      1. Carregar o arquivo XLT usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo XLT atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo XLT
        ...
        def run():
            ...
            with gm.Metadata("input.xlt") as metadata:
                ...
                # Salvar o arquivo XLT atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos XLT com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags XLT Integradas"
