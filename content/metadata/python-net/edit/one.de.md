...
############################# Head ############################
head_title: "Metadaten in One-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in One-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in One-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in ONE-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in ONE-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die ONE-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte ONE-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer ONE-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.one") as metadata:
                ...
                # Speichern Sie die aktualisierte ONE-Datei
...
more_features:
  enable: true
  title: "Metadaten in ONE-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten ONE-Tags"
