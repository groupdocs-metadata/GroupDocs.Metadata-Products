...
############################# Head ############################
head_title: "Metadaten in Epub-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Epub-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Epub-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in EPUB-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in EPUB-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die EPUB-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte EPUB-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer EPUB-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.epub") as metadata:
                ...
                # Speichern Sie die aktualisierte EPUB-Datei
...
more_features:
  enable: true
  title: "Metadaten in EPUB-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten EPUB-Tags"
