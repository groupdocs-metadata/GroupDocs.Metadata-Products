...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers Heif avec Python"
head_description: "Utilisez l'API Python pour modifier les métadonnées dans les fichiers Heif. Prend en charge les formats de métadonnées XMP, EXIF, IPTC, ID3 et d'autres."

############################# Header ############################
title: "Modifiez les métadonnées dans les fichiers Heif avec Python" 
...
steps:
    enable: true
    title: "Comment modifier les métadonnées dans des fichiers HEIF en utilisant Python"
    content: |
      Avec [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), les développeurs Python peuvent mettre à jour les métadonnées dans des fichiers HEIF en suivant ces étapes simples:
      
      1. Chargez le fichier HEIF en utilisant la classe Metadata.
      ...
      4. Enregistrez le fichier HEIF mis à jour sur disque.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Changer la date de création d'un fichier HEIF
        ...
        def run():
            ...
            with gm.Metadata("input.heif") as metadata:
                ...
                # Enregistrer le fichier HEIF mis à jour
...
more_features:
  enable: true
  title: "Modifier les métadonnées dans des fichiers HEIF avec Python"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisez les balises HEIF intégrées"
