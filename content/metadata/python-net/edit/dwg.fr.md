...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers Dwg avec Python"
head_description: "Utilisez l'API Python pour modifier les métadonnées dans les fichiers Dwg. Prend en charge les formats de métadonnées XMP, EXIF, IPTC, ID3 et d'autres."

############################# Header ############################
title: "Modifiez les métadonnées dans les fichiers Dwg avec Python" 
...
steps:
    enable: true
    title: "Comment modifier les métadonnées dans des fichiers DWG en utilisant Python"
    content: |
      Avec [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), les développeurs Python peuvent mettre à jour les métadonnées dans des fichiers DWG en suivant ces étapes simples:
      
      1. Chargez le fichier DWG en utilisant la classe Metadata.
      ...
      4. Enregistrez le fichier DWG mis à jour sur disque.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Changer la date de création d'un fichier DWG
        ...
        def run():
            ...
            with gm.Metadata("input.dwg") as metadata:
                ...
                # Enregistrer le fichier DWG mis à jour
...
more_features:
  enable: true
  title: "Modifier les métadonnées dans des fichiers DWG avec Python"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisez les balises DWG intégrées"
