...
############################# Head ############################
head_title: "Edit Metadata in Vsdx Files Using Python"
head_description: "Use the Python API to modify metadata in Vsdx files. Supports XMP, EXIF, IPTC, ID3, and other metadata formats."

############################# Header ############################
title: "Modify Metadata in Vsdx Files with Python" 
...
steps:
    enable: true
    title: "How to Edit Metadata in VSDX Files Using Python"
    content: |
      With [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), Python developers can update metadata in VSDX files by following these simple steps:
      
      1. Load the VSDX file using the Metadata class.
      2. Define a condition to filter the metadata you want to change.
      3. Apply the filter and set the new value.
      4. Save the updated VSDX file to disk.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Change the creation date of a VSDX file
...
more_features:
  enable: true
  title: "Edit Metadata in VSDX Files with Python"
