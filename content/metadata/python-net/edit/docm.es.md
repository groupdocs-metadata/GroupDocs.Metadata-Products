...
############################# Head ############################
head_title: "Editar metadatos en archivos Docm usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Docm. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Docm con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos DOCM usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos DOCM siguiendo estos pasos:
...
more_features:
  enable: true
  title: "Editar metadatos en archivos DOCM con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas DOCM integradas"
