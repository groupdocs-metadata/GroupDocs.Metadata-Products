...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Jp2 Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Jp2. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Jp2 com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos JP2 Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos JP2 seguindo estes passos simples:
      
      1. Carregar o arquivo JP2 usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo JP2 atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo JP2
        ...
        def run():
            ...
            with gm.Metadata("input.jp2") as metadata:
                ...
                # Salvar o arquivo JP2 atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos JP2 com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags JP2 Integradas"
