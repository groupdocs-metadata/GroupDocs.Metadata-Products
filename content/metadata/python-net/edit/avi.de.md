...
############################# Head ############################
head_title: "Metadaten in Avi-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Avi-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Avi-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in AVI-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in AVI-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die AVI-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte AVI-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer AVI-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.avi") as metadata:
                ...
                # Speichern Sie die aktualisierte AVI-Datei
...
more_features:
  enable: true
  title: "Metadaten in AVI-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten AVI-Tags"
