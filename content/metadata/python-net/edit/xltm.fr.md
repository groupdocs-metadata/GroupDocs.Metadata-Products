...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers Xltm avec Python"
head_description: "Utilisez l'API Python pour modifier les métadonnées dans les fichiers Xltm. Prend en charge les formats de métadonnées XMP, EXIF, IPTC, ID3 et d'autres."

############################# Header ############################
title: "Modifiez les métadonnées dans les fichiers Xltm avec Python" 
...
steps:
    enable: true
    title: "Comment modifier les métadonnées dans des fichiers XLTM en utilisant Python"
    content: |
      Avec [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), les développeurs Python peuvent mettre à jour les métadonnées dans des fichiers XLTM en suivant ces étapes simples:
      
      1. Chargez le fichier XLTM en utilisant la classe Metadata.
      ...
      4. Enregistrez le fichier XLTM mis à jour sur disque.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Changer la date de création d'un fichier XLTM
        ...
        def run():
            ...
            with gm.Metadata("input.xltm") as metadata:
                ...
                # Enregistrer le fichier XLTM mis à jour
...
more_features:
  enable: true
  title: "Modifier les métadonnées dans des fichiers XLTM avec Python"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisez les balises XLTM intégrées"
