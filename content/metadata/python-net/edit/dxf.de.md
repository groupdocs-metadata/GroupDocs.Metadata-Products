...
############################# Head ############################
head_title: "Metadaten in Dxf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Dxf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Dxf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DXF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DXF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DXF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DXF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DXF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.dxf") as metadata:
                ...
                # Speichern Sie die aktualisierte DXF-Datei
...
more_features:
  enable: true
  title: "Metadaten in DXF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DXF-Tags"
