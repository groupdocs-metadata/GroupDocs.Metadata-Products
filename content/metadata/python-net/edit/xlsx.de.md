...
############################# Head ############################
head_title: "Metadaten in Xlsx-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Xlsx-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Xlsx-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in XLSX-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in XLSX-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die XLSX-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte XLSX-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer XLSX-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.xlsx") as metadata:
                ...
                # Speichern Sie die aktualisierte XLSX-Datei
...
more_features:
  enable: true
  title: "Metadaten in XLSX-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten XLSX-Tags"
