...
############################# Head ############################
head_title: "Editar Metadados em Arquivos Tiff Usando Python"
head_description: "Use a API Python para modificar metadados em arquivos Tiff. Suporta formatos de metadados como XMP, EXIF, IPTC, ID3 e outros."

############################# Header ############################
title: "Modificar Metadados em Arquivos Tiff com Python" 
...
steps:
    enable: true
    title: "Como Editar Metadados em Arquivos TIFF Usando Python"
    content: |
      Com [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), desenvolvedores Python podem atualizar metadados em arquivos TIFF seguindo estes passos simples:
      
      1. Carregar o arquivo TIFF usando a classe Metadata.
      2. Definir uma condição para filtrar os metadados que você deseja alterar.
      3. Aplicar o filtro e definir o novo valor.
      4. Salvar o arquivo TIFF atualizado no disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mudar a data de criação de um arquivo TIFF
        ...
        def run():
            ...
            with gm.Metadata("input.tiff") as metadata:
                ...
                # Salvar o arquivo TIFF atualizado
...
more_features:
  enable: true
  title: "Editar Metadados em Arquivos TIFF com Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usar Tags TIFF Integradas"
