...
############################# Head ############################
head_title: "Metadaten in Xlsb-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Xlsb-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Xlsb-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in XLSB-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in XLSB-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die XLSB-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte XLSB-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer XLSB-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.xlsb") as metadata:
                ...
                # Speichern Sie die aktualisierte XLSB-Datei
...
more_features:
  enable: true
  title: "Metadaten in XLSB-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten XLSB-Tags"
