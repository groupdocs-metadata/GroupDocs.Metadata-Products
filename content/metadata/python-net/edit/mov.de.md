...
############################# Head ############################
head_title: "Metadaten in Mov-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Mov-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Mov-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in MOV-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in MOV-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die MOV-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte MOV-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer MOV-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.mov") as metadata:
                ...
                # Speichern Sie die aktualisierte MOV-Datei
...
more_features:
  enable: true
  title: "Metadaten in MOV-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten MOV-Tags"
