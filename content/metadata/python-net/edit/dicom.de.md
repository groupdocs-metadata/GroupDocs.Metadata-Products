...
############################# Head ############################
head_title: "Metadaten in Dicom-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Dicom-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Dicom-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DICOM-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DICOM-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DICOM-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DICOM-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DICOM-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.dicom") as metadata:
                ...
                # Speichern Sie die aktualisierte DICOM-Datei
...
more_features:
  enable: true
  title: "Metadaten in DICOM-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DICOM-Tags"
