...
############################# Head ############################
head_title: "Metadaten in Vsdx-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Vsdx-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Vsdx-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in VSDX-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in VSDX-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die VSDX-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte VSDX-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer VSDX-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.vsdx") as metadata:
                ...
                # Speichern Sie die aktualisierte VSDX-Datei
...
more_features:
  enable: true
  title: "Metadaten in VSDX-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten VSDX-Tags"
