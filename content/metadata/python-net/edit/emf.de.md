...
############################# Head ############################
head_title: "Metadaten in Emf-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Emf-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Emf-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in EMF-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in EMF-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die EMF-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte EMF-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer EMF-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.emf") as metadata:
                ...
                # Speichern Sie die aktualisierte EMF-Datei
...
more_features:
  enable: true
  title: "Metadaten in EMF-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten EMF-Tags"
