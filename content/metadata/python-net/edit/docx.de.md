...
############################# Head ############################
head_title: "Metadaten in Docx-Dateien mit Python bearbeiten"
head_description: "Verwenden Sie die Python-API, um Metadaten in Docx-Dateien zu ändern. Unterstützt XMP, EXIF, IPTC, ID3 und andere Metadatenformate."

############################# Header ############################
title: "Metadaten in Docx-Dateien mit Python ändern" 
...
steps:
    enable: true
    title: "Wie man Metadaten in DOCX-Dateien mit Python bearbeitet"
    content: |
      Mit [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/) können Python-Entwickler Metadaten in DOCX-Dateien durch Befolgung dieser einfachen Schritte aktualisieren:
      
      1. Laden Sie die DOCX-Datei mit der Metadata-Klasse.
      ...
      4. Speichern Sie die aktualisierte DOCX-Datei auf der Festplatte.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ändern Sie das Erstellungsdatum einer DOCX-Datei
        ...
        def run():
            ...
            with gm.Metadata("input.docx") as metadata:
                ...
                # Speichern Sie die aktualisierte DOCX-Datei
...
more_features:
  enable: true
  title: "Metadaten in DOCX-Dateien mit Python bearbeiten"
  ...
  features:
    ...
    # feature loop
    - title: "Verwendung von integrierten DOCX-Tags"
