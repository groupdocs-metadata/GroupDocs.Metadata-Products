...
############################# Head ############################
head_title: "Editar metadatos en archivos Mpp usando Python"
head_description: "Utiliza la API de Python para modificar metadatos en archivos Mpp. Soporta formatos de metadatos como XMP, EXIF, IPTC, ID3 y otros."

############################# Header ############################
title: "Modificar metadatos en archivos Mpp con Python" 
...
steps:
    enable: true
    title: "Cómo editar metadatos en archivos MPP usando Python"
    content: |
      Con [GroupDocs.Metadata for Python via .NET](https://products.groupdocs.com/metadata/python-net/), los desarrolladores de Python pueden actualizar metadatos en archivos MPP siguiendo estos pasos:
      
      1. Carga el archivo MPP usando la clase Metadata.
      2. Define una condición para filtrar los metadatos que deseas cambiar.
      3. Aplica el filtro y establece el nuevo valor.
      4. Guarda el archivo MPP actualizado en el disco.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cambiar la fecha de creación de un archivo MPP
        ...
        def run():
            ...
            with gm.Metadata("input.mpp") as metadata:
                ...
                # Guardar el archivo MPP actualizado
...
more_features:
  enable: true
  title: "Editar metadatos en archivos MPP con Python"
  ...
  features:
    ...
    # feature loop
    - title: "Usa etiquetas MPP integradas"
