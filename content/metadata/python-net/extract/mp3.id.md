...
############################# Head ############################
head_title: "Akses dan Ekstrak Metadata dari Berkas MP3 dalam Python"
head_description: "API Python yang independen dari platform untuk membaca dan menarik metadata dari berkas MP3. Kompatibel dengan XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Baca Metadata dari MP3 Menggunakan Python" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari MP3 Menggunakan Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) membantu pengembang Python mengekstrak metadata dari berkas MP3 hanya dengan beberapa langkah:
      
      1. Buka berkas MP3 menggunakan instance kelas Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ambil metadata dari berkas MP3
