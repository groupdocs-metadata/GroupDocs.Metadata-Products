...
############################# Head ############################
head_title: "Acesse e Extraia Metadados de Arquivos XLTM em Python"
head_description: "API Python independente de plataforma para ler e extrair metadados de arquivos XLTM. Compatível com XMP, EXIF, IPTC, ID3 e mais."

############################# Header ############################
title: "Leia Metadados de XLTM Usando Python" 
...
steps:
    enable: true
    title: "Como Extrair Metadados de XLTM Usando Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) ajuda desenvolvedores Python a extrair metadados de arquivos XLTM em apenas algumas etapas:
      
      1. Abra o arquivo XLTM usando uma instância de classe Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Obtenha metadados de um arquivo XLTM
