...
############################# Head ############################
head_title: "Отримання і витягування метаданих з файлів DOCX у Python"
head_description: "Платформонезалежний Python API для читання та вилучення метаданих з файлів DOCX. Сумісний з XMP, EXIF, IPTC, ID3 та ін."

############################# Header ############################
title: "Читання метаданих з DOCX за допомогою Python" 
...
steps:
    enable: true
    title: "Як витягнути метадані з DOCX за допомогою Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) допомагає розробникам Python витягувати метадані з файлів DOCX за кілька простих кроків:
      
      1. Відкрийте файл DOCX за допомогою екземпляра класу Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Отримати метадані з файлу DOCX
