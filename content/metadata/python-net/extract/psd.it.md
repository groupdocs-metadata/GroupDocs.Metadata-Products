...
############################# Head ############################
head_title: "Accedi e Estrai i Metadati dai File PSD in Python"
head_description: "API Python indipendente dalla piattaforma per leggere ed estrarre metadati dai file PSD. Compatibile con XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Leggi i Metadati dai PSD Usando Python" 
...
steps:
    enable: true
    title: "Come Estrarre Metadati da PSD Usando Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) aiuta gli sviluppatori Python ad estrarre metadati dai file PSD con pochi passaggi:
      
      1. Apri il file PSD utilizzando un'istanza della classe Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ottieni metadati da un file PSD
