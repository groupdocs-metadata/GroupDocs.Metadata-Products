...
############################# Head ############################
head_title: "Akses dan Ekstrak Metadata dari Berkas EPUB dalam Python"
head_description: "API Python yang independen dari platform untuk membaca dan menarik metadata dari berkas EPUB. Kompatibel dengan XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Baca Metadata dari EPUB Menggunakan Python" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari EPUB Menggunakan Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) membantu pengembang Python mengekstrak metadata dari berkas EPUB hanya dengan beberapa langkah:
      
      1. Buka berkas EPUB menggunakan instance kelas Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ambil metadata dari berkas EPUB
