...
############################# Head ############################
head_title: "Zugriff auf und Extraktion von Metadaten aus VDX-Dateien in Python"
head_description: "Plattformunabhängige Python-API zum Lesen und Abrufen von Metadaten aus VDX-Dateien. Kompatibel mit XMP, EXIF, IPTC, ID3 und mehr."

############################# Header ############################
title: "Metadaten aus VDX mit Python lesen" 
...
steps:
    enable: true
    title: "Wie man Metadaten aus VDX mit Python extrahiert"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) hilft Python-Entwicklern, Metadaten aus VDX-Dateien mit nur wenigen Schritten zu extrahieren:
      
      1. Python-Instanz verwenden, um die VDX-Datei zu öffnen.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Metadaten aus einer VDX-Datei abrufen
