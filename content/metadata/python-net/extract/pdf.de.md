...
############################# Head ############################
head_title: "Zugriff auf und Extraktion von Metadaten aus PDF-Dateien in Python"
head_description: "Plattformunabhängige Python-API zum Lesen und Abrufen von Metadaten aus PDF-Dateien. Kompatibel mit XMP, EXIF, IPTC, ID3 und mehr."

############################# Header ############################
title: "Metadaten aus PDF mit Python lesen" 
...
steps:
    enable: true
    title: "Wie man Metadaten aus PDF mit Python extrahiert"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) hilft Python-Entwicklern, Metadaten aus PDF-Dateien mit nur wenigen Schritten zu extrahieren:
      
      1. Python-Instanz verwenden, um die PDF-Datei zu öffnen.
