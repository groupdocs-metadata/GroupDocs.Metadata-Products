...
############################# Head ############################
head_title: "Acceder y Extraer Metadatos de Archivos VCR en Python"
head_description: "API Python independiente de la plataforma para leer y extraer metadatos de archivos VCR. Compatible con XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Leer Metadatos de VCR Usando Python" 
...
steps:
    enable: true
    title: "Cómo Extraer Metadatos de VCR Usando Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) ayuda a los desarrolladores de Python a extraer metadatos de archivos VCR en solo unos pocos pasos:
      
      1. Abre el archivo VCR utilizando una instancia de la clase Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Obtener metadatos de un archivo VCR
