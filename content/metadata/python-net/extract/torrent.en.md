...
############################# Head ############################
head_title: "Access and Extract Metadata from TORRENT Files in Python"
head_description: "Platform-independent Python API to read and pull out metadata from TORRENT files. Compatible with XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Read Metadata from TORRENT Using Python" 
...
steps:
    enable: true
    title: "How to Extract Metadata from TORRENT Using Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) helps Python developers easily extract metadata from TORRENT files with just a few steps:
      
      1. Open the TORRENT file using a Python class instance.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Get metadata from a TORRENT file
