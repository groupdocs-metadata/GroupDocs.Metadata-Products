...
############################# Head ############################
head_title: "Acceder y Extraer Metadatos de Archivos DOT en Python"
head_description: "API Python independiente de la plataforma para leer y extraer metadatos de archivos DOT. Compatible con XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Leer Metadatos de DOT Usando Python" 
...
steps:
    enable: true
    title: "Cómo Extraer Metadatos de DOT Usando Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) ayuda a los desarrolladores de Python a extraer metadatos de archivos DOT en solo unos pocos pasos:
      
      1. Abre el archivo DOT utilizando una instancia de la clase Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Obtener metadatos de un archivo DOT
