...
############################# Head ############################
head_title: "Acesse e Extraia Metadados de Arquivos POT em Python"
head_description: "API Python independente de plataforma para ler e extrair metadados de arquivos POT. Compatível com XMP, EXIF, IPTC, ID3 e mais."

############################# Header ############################
title: "Leia Metadados de POT Usando Python" 
...
steps:
    enable: true
    title: "Como Extrair Metadados de POT Usando Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) ajuda desenvolvedores Python a extrair metadados de arquivos POT em apenas algumas etapas:
      
      1. Abra o arquivo POT usando uma instância de classe Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Obtenha metadados de um arquivo POT
