...
############################# Head ############################
head_title: "Accedi e Estrai i Metadati dai File TTF in Python"
head_description: "API Python indipendente dalla piattaforma per leggere ed estrarre metadati dai file TTF. Compatibile con XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Leggi i Metadati dai TTF Usando Python" 
...
steps:
    enable: true
    title: "Come Estrarre Metadati da TTF Usando Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) aiuta gli sviluppatori Python ad estrarre metadati dai file TTF con pochi passaggi:
      
      1. Apri il file TTF utilizzando un'istanza della classe Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ottieni metadati da un file TTF
