...
############################# Head ############################
head_title: "Acesse e Extraia Metadados de Arquivos MP3 em Python"
head_description: "API Python independente de plataforma para ler e extrair metadados de arquivos MP3. Compatível com XMP, EXIF, IPTC, ID3 e mais."

############################# Header ############################
title: "Leia Metadados de MP3 Usando Python" 
...
steps:
    enable: true
    title: "Como Extrair Metadados de MP3 Usando Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) ajuda desenvolvedores Python a extrair metadados de arquivos MP3 em apenas algumas etapas:
      
      1. Abra o arquivo MP3 usando uma instância de classe Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Obtenha metadados de um arquivo MP3
