...
############################# Head ############################
head_title: "Acesse e Extraia Metadados de Arquivos MSG em Python"
head_description: "API Python independente de plataforma para ler e extrair metadados de arquivos MSG. Compatível com XMP, EXIF, IPTC, ID3 e mais."

############################# Header ############################
title: "Leia Metadados de MSG Usando Python" 
...
steps:
    enable: true
    title: "Como Extrair Metadados de MSG Usando Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) ajuda desenvolvedores Python a extrair metadados de arquivos MSG em apenas algumas etapas:
      
      1. Abra o arquivo MSG usando uma instância de classe Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Obtenha metadados de um arquivo MSG
