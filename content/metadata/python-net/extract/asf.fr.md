...
############################# Head ############################
head_title: "Accédez et extrayez les métadonnées des fichiers ASF en Python"
head_description: "API Python indépendante de la plateforme pour lire et extraire les métadonnées des fichiers ASF. Compatible avec XMP, EXIF, IPTC, ID3, et plus."

############################# Header ############################
title: "Lire les métadonnées des ASF avec Python" 
...
steps:
    enable: true
    title: "Comment Extraire des Métadonnées d'un ASF avec Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) aide les développeurs Python à extraire les métadonnées des fichiers ASF en quelques étapes :
      
      1. Ouvrez le fichier ASF en utilisant une instance de classe Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Obtenez les métadonnées d'un fichier ASF
