...
############################# Head ############################
head_title: "Отримання і витягування метаданих з файлів VSDX у Python"
head_description: "Платформонезалежний Python API для читання та вилучення метаданих з файлів VSDX. Сумісний з XMP, EXIF, IPTC, ID3 та ін."

############################# Header ############################
title: "Читання метаданих з VSDX за допомогою Python" 
...
steps:
    enable: true
    title: "Як витягнути метадані з VSDX за допомогою Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) допомагає розробникам Python витягувати метадані з файлів VSDX за кілька простих кроків:
      
      1. Відкрийте файл VSDX за допомогою екземпляра класу Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Отримати метадані з файлу VSDX
