...
############################# Head ############################
head_title: "Zugriff auf und Extraktion von Metadaten aus EPUB-Dateien in Python"
head_description: "Plattformunabhängige Python-API zum Lesen und Abrufen von Metadaten aus EPUB-Dateien. Kompatibel mit XMP, EXIF, IPTC, ID3 und mehr."

############################# Header ############################
title: "Metadaten aus EPUB mit Python lesen" 
...
steps:
    enable: true
    title: "Wie man Metadaten aus EPUB mit Python extrahiert"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) hilft Python-Entwicklern, Metadaten aus EPUB-Dateien mit nur wenigen Schritten zu extrahieren:
      
      1. Python-Instanz verwenden, um die EPUB-Datei zu öffnen.
