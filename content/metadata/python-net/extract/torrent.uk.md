...
############################# Head ############################
head_title: "Отримання і витягування метаданих з файлів TORRENT у Python"
head_description: "Платформонезалежний Python API для читання та вилучення метаданих з файлів TORRENT. Сумісний з XMP, EXIF, IPTC, ID3 та ін."

############################# Header ############################
title: "Читання метаданих з TORRENT за допомогою Python" 
...
steps:
    enable: true
    title: "Як витягнути метадані з TORRENT за допомогою Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) допомагає розробникам Python витягувати метадані з файлів TORRENT за кілька простих кроків:
      
      1. Відкрийте файл TORRENT за допомогою екземпляра класу Python.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Отримати метадані з файлу TORRENT
