...
############################# Head ############################
head_title: "Zugriff auf und Extraktion von Metadaten aus XLSB-Dateien in Python"
head_description: "Plattformunabhängige Python-API zum Lesen und Abrufen von Metadaten aus XLSB-Dateien. Kompatibel mit XMP, EXIF, IPTC, ID3 und mehr."

############################# Header ############################
title: "Metadaten aus XLSB mit Python lesen" 
...
steps:
    enable: true
    title: "Wie man Metadaten aus XLSB mit Python extrahiert"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) hilft Python-Entwicklern, Metadaten aus XLSB-Dateien mit nur wenigen Schritten zu extrahieren:
      
      1. Python-Instanz verwenden, um die XLSB-Datei zu öffnen.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Metadaten aus einer XLSB-Datei abrufen
