...
############################# Head ############################
head_title: "Zugriff auf und Extraktion von Metadaten aus MSG-Dateien in Python"
head_description: "Plattformunabhängige Python-API zum Lesen und Abrufen von Metadaten aus MSG-Dateien. Kompatibel mit XMP, EXIF, IPTC, ID3 und mehr."

############################# Header ############################
title: "Metadaten aus MSG mit Python lesen" 
...
steps:
    enable: true
    title: "Wie man Metadaten aus MSG mit Python extrahiert"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) hilft Python-Entwicklern, Metadaten aus MSG-Dateien mit nur wenigen Schritten zu extrahieren:
      
      1. Python-Instanz verwenden, um die MSG-Datei zu öffnen.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Metadaten aus einer MSG-Datei abrufen
