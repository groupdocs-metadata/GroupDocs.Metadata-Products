...
############################# Head ############################
head_title: "Clean Metadata from EPUB Files in Python Apps"
head_description: "Use the Python API to strip metadata from EPUB files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in EPUB Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from EPUB in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from EPUB files by following a few steps.
      
      1. Open the EPUB file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in EPUB format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a EPUB file
