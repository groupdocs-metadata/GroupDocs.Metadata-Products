...
############################# Head ############################
head_title: "Clean Metadata from XLT Files in Python Apps"
head_description: "Use the Python API to strip metadata from XLT files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in XLT Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from XLT in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from XLT files by following a few steps.
      
      1. Open the XLT file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in XLT format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a XLT file
