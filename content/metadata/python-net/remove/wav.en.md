...
############################# Head ############################
head_title: "Clean Metadata from WAV Files in Python Apps"
head_description: "Use the Python API to strip metadata from WAV files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in WAV Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from WAV in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from WAV files by following a few steps.
      
      1. Open the WAV file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in WAV format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a WAV file
