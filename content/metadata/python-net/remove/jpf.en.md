...
############################# Head ############################
head_title: "Clean Metadata from JPF Files in Python Apps"
head_description: "Use the Python API to strip metadata from JPF files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in JPF Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from JPF in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from JPF files by following a few steps.
      
      1. Open the JPF file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in JPF format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a JPF file
