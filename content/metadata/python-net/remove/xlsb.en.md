...
############################# Head ############################
head_title: "Clean Metadata from XLSB Files in Python Apps"
head_description: "Use the Python API to strip metadata from XLSB files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in XLSB Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from XLSB in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from XLSB files by following a few steps.
      
      1. Open the XLSB file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in XLSB format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a XLSB file
