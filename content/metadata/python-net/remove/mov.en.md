...
############################# Head ############################
head_title: "Clean Metadata from MOV Files in Python Apps"
head_description: "Use the Python API to strip metadata from MOV files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in MOV Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from MOV in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from MOV files by following a few steps.
      
      1. Open the MOV file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in MOV format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a MOV file
