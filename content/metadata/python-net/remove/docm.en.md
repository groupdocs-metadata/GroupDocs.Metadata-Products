...
############################# Head ############################
head_title: "Clean Metadata from DOCM Files in Python Apps"
head_description: "Use the Python API to strip metadata from DOCM files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in DOCM Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from DOCM in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from DOCM files by following a few steps.
      
      1. Open the DOCM file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in DOCM format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a DOCM file
