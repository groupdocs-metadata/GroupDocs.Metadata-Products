...
############################# Head ############################
head_title: "Clean Metadata from WEBP Files in Python Apps"
head_description: "Use the Python API to strip metadata from WEBP files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in WEBP Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from WEBP in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from WEBP files by following a few steps.
      
      1. Open the WEBP file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in WEBP format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a WEBP file
