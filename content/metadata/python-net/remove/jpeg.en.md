...
############################# Head ############################
head_title: "Clean Metadata from JPEG Files in Python Apps"
head_description: "Use the Python API to strip metadata from JPEG files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in JPEG Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from JPEG in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from JPEG files by following a few steps.
      
      1. Open the JPEG file using the Metadata class.
      2. Remove all metadata in the loaded file.
      3. Handle the result of the cleanup process.
      4. Save the updated file in JPEG format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Erase metadata from a JPEG file
