...
############################# Head ############################
head_title: "Metadaten aus XLS-Dateien in Python-Apps bereinigen"
head_description: "Verwenden Sie die Python API, um Metadaten aus XLS-Dateien zu entfernen. Unterstützt Formate wie XMP, EXIF, IPTC, ID3 und andere."

############################# Header ############################
title: "Metadaten in XLS mit Python löschen" 
...
steps:
    enable: true
    title: "So entfernen Sie Metadaten aus XLS in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) ermöglicht es Entwicklern, Metadaten aus XLS-Dateien durch die Befolgung einiger Schritte zu bereinigen.
      
      1. Öffnen Sie die XLS-Datei mit der Metadata-Klasse.
      2. Entfernen Sie alle Metadaten in der geladenen Datei.
      3. Verarbeiten Sie das Ergebnis des Bereinigungsprozesses.
      4. Speichern Sie die aktualisierte Datei im XLS-Format.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Metadaten aus einer XLS-Datei löschen
