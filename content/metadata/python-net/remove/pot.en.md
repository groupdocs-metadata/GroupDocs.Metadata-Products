...
############################# Head ############################
head_title: "Clean Metadata from POT Files in Python Apps"
head_description: "Use the Python API to strip metadata from POT files. Supports formats like XMP, EXIF, IPTC, ID3, and others."

############################# Header ############################
title: "Delete Metadata in POT Using Python" 
...
steps:
    enable: true
    title: "How to Remove Metadata from POT in Python"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/python-net/) makes it simple for developers to clean metadata from POT files by following a few steps.
