...
############################# Head ############################
head_title: "Edit Metadata ke File Jpeg di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke JPEG di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file JPEG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file JPEG melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format JPEG.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam JPEG untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti JPEG Bawaan"
