...
############################# Head ############################
head_title: "Edit Metadata ke File Jpf di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke JPF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file JPF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file JPF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format JPF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam JPF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti JPF Bawaan"
