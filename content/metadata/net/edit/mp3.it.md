...
############################# Head ############################
head_title: "Modifica i metadati in file Mp3 nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per modificare le informazioni sui metadati nei file Mp3. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiorna i metadati del file Mp3 in C#" 
...
steps:
    enable: true
    title: "Passaggi per l'aggiornamento dei metadati su MP3 in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) consente agli sviluppatori di .NET di modificare facilmente le informazioni sui metadati nei file MP3 dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica il file MP3 tramite un'istanza della classe Metadata.
      ...
      4. Salva le modifiche sul disco nel formato MP3.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifica la data di creazione di MP3
...
more_features:
  enable: true
  title: "Gestisci le proprietà dei metadati interni di MP3 per le app .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Sfruttare le proprietà MP3 integrate"
