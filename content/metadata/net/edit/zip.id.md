...
############################# Head ############################
head_title: "Edit Metadata ke File Zip di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke ZIP di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file ZIP dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file ZIP melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format ZIP.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam ZIP untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti ZIP Bawaan"
