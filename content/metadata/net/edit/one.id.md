...
############################# Head ############################
head_title: "Edit Metadata ke File One di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke ONE di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file ONE dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file ONE melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format ONE.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam ONE untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti ONE Bawaan"
