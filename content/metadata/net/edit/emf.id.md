...
############################# Head ############################
head_title: "Edit Metadata ke File Emf di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke EMF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file EMF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file EMF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format EMF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam EMF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti EMF Bawaan"
