...
############################# Head ############################
head_title: "Modifica i metadati in file Asf nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per modificare le informazioni sui metadati nei file Asf. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiorna i metadati del file Asf in C#" 
...
steps:
    enable: true
    title: "Passaggi per l'aggiornamento dei metadati su ASF in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) consente agli sviluppatori di .NET di modificare facilmente le informazioni sui metadati nei file ASF dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica il file ASF tramite un'istanza della classe Metadata.
      ...
      4. Salva le modifiche sul disco nel formato ASF.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifica la data di creazione di ASF
...
more_features:
  enable: true
  title: "Gestisci le proprietà dei metadati interni di ASF per le app .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Sfruttare le proprietà ASF integrate"
