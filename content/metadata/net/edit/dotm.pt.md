...
############################# Head ############################
head_title: "Edite metadados para arquivos Dotm em aplicativos C#"
head_description: "API de processamento de metadados C# para editar informações de metadados em arquivos Dotm. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Dotm em C#" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para DOTM em C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) torna mais fácil para os desenvolvedores de .NET editar informações de metadados em arquivos DOTM de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o arquivo DOTM por meio de uma instância da classe Metadata.
      ...
      4. Salve as alterações no disco no formato DOTM.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar data de criação de DOTM
...
more_features:
  enable: true
  title: "Gerenciar propriedades de metadados internos DOTM para aplicativos .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aproveitando propriedades integradas de DOTM"
