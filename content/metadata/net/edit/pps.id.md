...
############################# Head ############################
head_title: "Edit Metadata ke File Pps di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke PPS di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file PPS dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file PPS melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format PPS.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam PPS untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti PPS Bawaan"
