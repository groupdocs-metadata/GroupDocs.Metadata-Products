...
############################# Head ############################
head_title: "Edite metadados para arquivos Jp2 em aplicativos C#"
head_description: "API de processamento de metadados C# para editar informações de metadados em arquivos Jp2. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Jp2 em C#" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para JP2 em C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) torna mais fácil para os desenvolvedores de .NET editar informações de metadados em arquivos JP2 de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o arquivo JP2 por meio de uma instância da classe Metadata.
      ...
      4. Salve as alterações no disco no formato JP2.
...
more_features:
  enable: true
  title: "Gerenciar propriedades de metadados internos JP2 para aplicativos .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aproveitando propriedades integradas de JP2"
