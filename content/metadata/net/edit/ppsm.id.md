...
############################# Head ############################
head_title: "Edit Metadata ke File Ppsm di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke PPSM di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file PPSM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file PPSM melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format PPSM.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam PPSM untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti PPSM Bawaan"
