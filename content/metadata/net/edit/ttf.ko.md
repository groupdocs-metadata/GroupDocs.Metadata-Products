...
############################# Head ############################
head_title: "Edit Metadata to TTF Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to edit metadata information to TTF files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title_left: "Steps for Updating Metadata to TTF in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/ko/metadata/net/) makes it easy for .NET developers to edit metadata information to TTF files from within their applications by implementing a few easy steps.
        
        * Load TTF filevia an instance of Metadata class.
        ...
        * Save the changes to disc in TTF format.
...
demos:
    ...
    content: |
       Update metadata information to TTF file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
