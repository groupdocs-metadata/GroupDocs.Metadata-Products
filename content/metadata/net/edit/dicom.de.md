...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/de/metadata/net/) makes it easy for .NET developers to edit metadata information to DICOM files from within their applications by implementing a few easy steps.
