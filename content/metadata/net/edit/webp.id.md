...
############################# Head ############################
head_title: "Edit Metadata ke File Webp di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke WEBP di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file WEBP dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file WEBP melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format WEBP.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam WEBP untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti WEBP Bawaan"
