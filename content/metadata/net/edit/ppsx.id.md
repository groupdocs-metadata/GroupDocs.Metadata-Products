...
############################# Head ############################
head_title: "Edit Metadata ke File Ppsx di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke PPSX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file PPSX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file PPSX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format PPSX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam PPSX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti PPSX Bawaan"
