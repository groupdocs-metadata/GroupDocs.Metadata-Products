...
############################# Head ############################
head_title: "Editar metadatos en archivos Vsdx en aplicaciones C#"
head_description: "C# API de procesamiento de metadatos para editar información de metadatos en archivos Vsdx. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Actualizar metadatos del archivo Vsdx en C#" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos a VSDX en C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET editar información de metadatos en archivos VSDX desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue el archivo VSDX a través de una instancia de la clase Metadata.
      ...
      4. Guarde los cambios en el disco en formato VSDX.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar fecha de creación de VSDX
...
more_features:
  enable: true
  title: "Administrar VSDX propiedades de metadatos internos para aplicaciones .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aprovechando las propiedades integradas VSDX"
