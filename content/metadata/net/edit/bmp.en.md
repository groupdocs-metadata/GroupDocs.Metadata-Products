...
############################# Head ############################
head_title: "Edit Metadata to Bmp Files in C# Applications"
head_description: "C# metadata processing API to edit metadata information to Bmp files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to BMP in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to BMP files from within their applications by implementing a few easy steps.
      
      1. Load BMP file via an instance of Metadata class.
      ...
      4. Save the changes to disc in BMP format.
...
more_features:
  enable: true
  title: "Manage BMP Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in BMP Properties"
