...
############################# Head ############################
head_title: "Chỉnh sửa siêu dữ liệu thành tệp Avi trong ứng dụng C#"
head_description: "API xử lý siêu dữ liệu C# để chỉnh sửa thông tin siêu dữ liệu thành tệp Avi. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Cập nhật siêu dữ liệu của tệp Avi trong C#" 
...
steps:
    enable: true
    title: "Các bước để cập nhật siêu dữ liệu lên AVI trong C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) giúp nhà phát triển .NET dễ dàng chỉnh sửa thông tin siêu dữ liệu thành tệp AVI từ bên trong ứng dụng của họ bằng cách thực hiện một vài bước đơn giản.
      
      1. Tải tệp AVI thông qua một phiên bản của lớp Metadata.
      ...
      4. Lưu các thay đổi vào đĩa ở định dạng AVI.
...
more_features:
  enable: true
  title: "Quản lý thuộc tính siêu dữ liệu bên trong AVI cho ứng dụng .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Tận dụng các thuộc tính AVI tích hợp sẵn"
