...
############################# Head ############################
head_title: "Edit Metadata ke File Dxf di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file Dxf. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DXF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DXF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DXF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DXF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DXF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DXF Bawaan"
