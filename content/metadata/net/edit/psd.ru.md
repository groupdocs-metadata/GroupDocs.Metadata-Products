...
############################# Head ############################
head_title: "Редактирование метаданных в PSD файлах в C# приложениях"
head_description: "API обработки метаданных C# для редактирования метаданных в файлы PSD. Работайте со стандартами метаданных XMP, EXIF, IPTC, ID3 и т. д."
...
steps:
    enable: true
    title_left: "Этапы обновления метаданных до PSD в C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/ru/metadata/net/) позволяет разработчикам .NET легко редактировать метаданные в файлы PSD из своих приложений, выполнив несколько простых шагов.
        
        * Загрузите файл PSD через экземпляр класса Metadata.
        ...
        * Сохраните изменения на диске в формате PSD.
...
demos:
    ...
    content: |
       Обновите метаданные до файла PSD прямо сейчас, посетив веб-сайт [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
