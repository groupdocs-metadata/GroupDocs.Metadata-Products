...
############################# Head ############################
head_title: "Edit Metadata ke File Eml di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke EML di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file EML dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file EML melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format EML.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam EML untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti EML Bawaan"
