...
steps:
    enable: true
    title: "Steps for Updating Metadata to DOCM in C#"
    content: |
      **[GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/)** makes it easy for .NET developers to edit metadata information to DOCM files from within their applications by implementing a few easy steps.
      
      1. Load DOCM file via an instance of Metadata class.
      ...
      4. Save the changes to disc in DOCM format.
...
more_features:
  enable: true
  title: "Manage DOCM Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in DOCM Properties"
