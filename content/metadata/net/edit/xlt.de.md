...
############################# Head ############################
head_title: "Edit Metadata to XLT Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to edit metadata information to XLT files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata Of XLT File  In C#"
...
steps:
    enable: true
    title_left: "Steps for Updating Metadata to XLT in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/de/metadata/net/) makes it easy for .NET developers to edit metadata information to XLT files from within their applications by implementing a few easy steps.
        
        * Load XLT filevia an instance of Metadata class.
        ...
        * Save the changes to disc in XLT format.
...
demos:
    ...
    content: |
       Update metadata information to XLT file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
