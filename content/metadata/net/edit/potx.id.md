...
############################# Head ############################
head_title: "Edit Metadata ke File Potx di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke POTX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file POTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file POTX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format POTX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam POTX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti POTX Bawaan"
