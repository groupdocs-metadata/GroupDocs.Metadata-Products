...
############################# Head ############################
head_title: "Edit Metadata ke File Vsdx di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke VSDX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file VSDX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file VSDX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format VSDX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam VSDX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti VSDX Bawaan"
