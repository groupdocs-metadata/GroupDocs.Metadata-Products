...
############################# Head ############################
head_title: "Edit Metadata ke File Pot di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke POT di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file POT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file POT melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format POT.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam POT untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti POT Bawaan"
