...
############################# Head ############################
head_title: "Edite metadados para arquivos Xlsm em aplicativos C#"
head_description: "API de processamento de metadados C# para editar informações de metadados em arquivos Xlsm. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Xlsm em C#" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para XLSM em C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) torna mais fácil para os desenvolvedores de .NET editar informações de metadados em arquivos XLSM de dentro de seus aplicativos, implementando algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Gerenciar propriedades de metadados internos XLSM para aplicativos .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aproveitando propriedades integradas de XLSM"
