...
############################# Head ############################
head_title: "Edit Metadata ke File Wav di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke WAV di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file WAV dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file WAV melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format WAV.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam WAV untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti WAV Bawaan"
