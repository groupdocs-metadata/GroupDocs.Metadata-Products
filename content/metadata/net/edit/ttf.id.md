...
############################# Head ############################
head_title: "Edit Metadata ke File Ttf di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke TTF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file TTF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file TTF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format TTF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam TTF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti TTF Bawaan"
