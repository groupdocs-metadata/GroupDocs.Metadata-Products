...
steps:
    enable: true
    title: "Steps for Updating Metadata to JPG in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to JPG files from within their applications by implementing a few easy steps.
      
      1. Load JPG file via an instance of Metadata class.
      ...
      4. Save the changes to disc in JPG format.
...
more_features:
  enable: true
  title: "Manage JPG Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in JPG Properties"
