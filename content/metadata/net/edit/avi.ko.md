...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/ko/metadata/net/) makes it easy for .NET developers to edit metadata information to AVI files from within their applications by implementing a few easy steps.
