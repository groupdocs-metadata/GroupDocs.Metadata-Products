...
############################# Head ############################
head_title: "Chỉnh sửa siêu dữ liệu thành tệp Dotx trong ứng dụng C#"
head_description: "API xử lý siêu dữ liệu C# để chỉnh sửa thông tin siêu dữ liệu thành tệp Dotx. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Cập nhật siêu dữ liệu của tệp Dotx trong C#" 
...
steps:
    enable: true
    title: "Các bước để cập nhật siêu dữ liệu lên DOTX trong C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) giúp nhà phát triển .NET dễ dàng chỉnh sửa thông tin siêu dữ liệu thành tệp DOTX từ bên trong ứng dụng của họ bằng cách thực hiện một vài bước đơn giản.
      
      1. Tải tệp DOTX thông qua một phiên bản của lớp Metadata.
      ...
      4. Lưu các thay đổi vào đĩa ở định dạng DOTX.
...
more_features:
  enable: true
  title: "Quản lý thuộc tính siêu dữ liệu bên trong DOTX cho ứng dụng .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Tận dụng các thuộc tính DOTX tích hợp sẵn"
