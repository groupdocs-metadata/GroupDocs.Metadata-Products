...
############################# Head ############################
head_title: "Edit Metadata ke File Avi di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke AVI di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file AVI dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file AVI melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format AVI.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam AVI untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti AVI Bawaan"
