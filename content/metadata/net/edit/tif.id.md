...
############################# Head ############################
head_title: "Edit Metadata ke File Tif di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke TIF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file TIF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file TIF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format TIF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam TIF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti TIF Bawaan"
