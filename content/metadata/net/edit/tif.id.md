...
############################# Head ############################
head_title: "Edit Metadata ke TIF File di C# Aplikasi"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file TIF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke TIF di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk mengedit informasi metadata ke file TIF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
       Perbarui informasi metadata ke file TIF sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
