...
############################# Head ############################
head_title: "Edit Metadata ke File Dwg di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DWG di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DWG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DWG melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DWG.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DWG untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DWG Bawaan"
