...
############################# Head ############################
head_title: "Edit Metadata ke DWG File di C# Aplikasi"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file DWG. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Perbarui Metadata File DWG Di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke DWG di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk mengedit informasi metadata ke file DWG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        
        * Muat file DWG melalui instance kelas Metadata.
        ...
        * Simpan perubahan ke disk dalam format DWG.
...
demos:
    ...
    content: |
       Perbarui informasi metadata ke file DWG sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
