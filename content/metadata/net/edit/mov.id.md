...
############################# Head ############################
head_title: "Edit Metadata ke File Mov di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke MOV di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file MOV dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file MOV melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format MOV.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam MOV untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti MOV Bawaan"
