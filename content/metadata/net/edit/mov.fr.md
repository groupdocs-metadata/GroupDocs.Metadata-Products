...
############################# Head ############################
head_title: "Edit Metadata to MOV Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to edit metadata information to MOV files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata Of MOV File  In C#"
...
steps:
    enable: true
    title_left: "Steps for Updating Metadata to MOV in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/fr/metadata/net/) makes it easy for .NET developers to edit metadata information to MOV files from within their applications by implementing a few easy steps.
        
        * Load MOV filevia an instance of Metadata class.
        ...
        * Save the changes to disc in MOV format.
...
demos:
    ...
    content: |
       Update metadata information to MOV file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
