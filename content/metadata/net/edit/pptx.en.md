...
steps:
    enable: true
    title: "Steps for Updating Metadata to PPTX in C#"
    content: |
      **[GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/)** makes it easy for .NET developers to edit metadata information to PPTX files from within their applications by implementing a few easy steps.
      
      1. Load PPTX file via an instance of Metadata class.
      ...
      4. Save the changes to disc in PPTX format.
...
more_features:
  enable: true
  title: "Manage PPTX Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in PPTX Properties"
