...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/ru/metadata/net/) makes it easy for .NET developers to edit metadata information to ASF files from within their applications by implementing a few easy steps.
