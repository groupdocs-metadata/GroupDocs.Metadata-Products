...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/metadata/net/) makes it easy for .NET developers to edit metadata information to WEBP files from within their applications by implementing a few easy steps.
