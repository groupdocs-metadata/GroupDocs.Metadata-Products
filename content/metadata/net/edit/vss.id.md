...
############################# Head ############################
head_title: "Edit Metadata ke File Vss di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke VSS di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file VSS dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file VSS melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format VSS.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam VSS untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti VSS Bawaan"
