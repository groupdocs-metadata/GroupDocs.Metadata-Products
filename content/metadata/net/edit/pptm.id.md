...
############################# Head ############################
head_title: "Edit Metadata ke File Pptm di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke PPTM di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file PPTM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file PPTM melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format PPTM.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam PPTM untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti PPTM Bawaan"
