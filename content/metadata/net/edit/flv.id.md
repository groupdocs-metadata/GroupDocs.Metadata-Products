...
############################# Head ############################
head_title: "Edit Metadata ke File Flv di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke FLV di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file FLV dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file FLV melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format FLV.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam FLV untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti FLV Bawaan"
