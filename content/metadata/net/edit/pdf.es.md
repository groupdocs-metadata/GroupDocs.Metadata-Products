...
############################# Head ############################
head_title: "Editar metadatos en archivos Pdf en aplicaciones C#"
head_description: "C# API de procesamiento de metadatos para editar información de metadatos en archivos Pdf. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Actualizar metadatos del archivo Pdf en C#" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos a PDF en C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET editar información de metadatos en archivos PDF desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue el archivo PDF a través de una instancia de la clase Metadata.
      ...
      4. Guarde los cambios en el disco en formato PDF.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar fecha de creación de PDF
...
more_features:
  enable: true
  title: "Administrar PDF propiedades de metadatos internos para aplicaciones .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aprovechando las propiedades integradas PDF"
