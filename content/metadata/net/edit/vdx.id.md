...
############################# Head ############################
head_title: "Edit Metadata ke File Vdx di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file Vdx. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke VDX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file VDX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file VDX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format VDX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam VDX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti VDX Bawaan"
