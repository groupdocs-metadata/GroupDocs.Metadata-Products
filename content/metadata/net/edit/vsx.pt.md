...
############################# Head ############################
head_title: "Edite metadados para arquivos Vsx em aplicativos C#"
head_description: "API de processamento de metadados C# para editar informações de metadados em arquivos Vsx. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Vsx em C#" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para VSX em C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) torna mais fácil para os desenvolvedores de .NET editar informações de metadados em arquivos VSX de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o arquivo VSX por meio de uma instância da classe Metadata.
      ...
      4. Salve as alterações no disco no formato VSX.
...
more_features:
  enable: true
  title: "Gerenciar propriedades de metadados internos VSX para aplicativos .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aproveitando propriedades integradas de VSX"
