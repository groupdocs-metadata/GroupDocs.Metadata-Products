...
############################# Head ############################
head_title: "Edit Metadata ke File Mpp di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke MPP di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file MPP dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file MPP melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format MPP.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam MPP untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti MPP Bawaan"
