...
head_title: "Sunting &amp; Perbarui Metadata File MPP di Aplikasi C# .NET"
head_description: "C# .NET metadata editing API untuk memperbarui informasi metadata dari file MPP. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Perbarui Metadata File MPP di C#"
...
steps:
    ...
    content_left: |
        ...
        * Simpan perubahan ke disk dalam format MPP.
...
demos:
    ...
    content: |
        Perbarui informasi metadata file MPP sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
