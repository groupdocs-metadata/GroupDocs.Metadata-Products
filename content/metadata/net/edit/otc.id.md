...
############################# Head ############################
head_title: "Edit Metadata ke File Otc di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke OTC di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file OTC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file OTC melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format OTC.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam OTC untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti OTC Bawaan"
