...
############################# Head ############################
head_title: "Modifica i metadati in file Torrent nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per modificare le informazioni sui metadati nei file Torrent. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiorna i metadati del file Torrent in C#" 
...
steps:
    enable: true
    title: "Passaggi per l'aggiornamento dei metadati su TORRENT in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) consente agli sviluppatori di .NET di modificare facilmente le informazioni sui metadati nei file TORRENT dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica il file TORRENT tramite un'istanza della classe Metadata.
      ...
      4. Salva le modifiche sul disco nel formato TORRENT.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifica la data di creazione di TORRENT
...
more_features:
  enable: true
  title: "Gestisci le proprietà dei metadati interni di TORRENT per le app .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Sfruttare le proprietà TORRENT integrate"
