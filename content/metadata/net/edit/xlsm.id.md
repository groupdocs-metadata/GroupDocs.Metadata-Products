...
############################# Head ############################
head_title: "Edit Metadata ke File Xlsm di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke XLSM di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file XLSM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file XLSM melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format XLSM.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam XLSM untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti XLSM Bawaan"
