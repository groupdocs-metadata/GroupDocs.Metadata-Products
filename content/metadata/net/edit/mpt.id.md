...
############################# Head ############################
head_title: "Edit Metadata ke File Mpt di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke MPT di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file MPT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file MPT melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format MPT.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam MPT untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti MPT Bawaan"
