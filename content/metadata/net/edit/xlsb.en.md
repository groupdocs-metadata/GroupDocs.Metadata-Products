...
steps:
    enable: true
    title: "Steps for Updating Metadata to XLSB in C#"
    content: |
      **[GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/)** makes it easy for .NET developers to edit metadata information to XLSB files from within their applications by implementing a few easy steps.
...
more_features:
  enable: true
  title: "Manage XLSB Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in XLSB Properties"
