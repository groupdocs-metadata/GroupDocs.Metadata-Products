...
############################# Head ############################
head_title: "Редагувати метадані файлів Dotm у програмах C#"
head_description: "API обробки метаданих C# для редагування інформації метаданих у файлах Dotm. Робота зі стандартами метаданих XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Оновити метадані файлу Dotm у C#" 
...
steps:
    enable: true
    title: "Кроки для оновлення метаданих до DOTM у C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) дозволяє розробникам .NET редагувати метадані файлів DOTM у своїх програмах, виконавши кілька простих кроків.
      
      1. Завантажте файл DOTM через екземпляр класу Metadata.
      ...
      4. Збережіть зміни на диску у форматі DOTM.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Редагувати дату створення DOTM
...
more_features:
  enable: true
  title: "Керування внутрішніми властивостями метаданих DOTM для програм .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Використання вбудованих властивостей DOTM"
