...
############################# Head ############################
head_title: "Edit Metadata ke File Dot di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DOT di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DOT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DOT melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DOT.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DOT untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DOT Bawaan"
