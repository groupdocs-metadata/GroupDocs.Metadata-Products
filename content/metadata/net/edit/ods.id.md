...
############################# Head ############################
head_title: "Edit Metadata ke File Ods di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke ODS di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file ODS dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file ODS melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format ODS.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam ODS untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti ODS Bawaan"
