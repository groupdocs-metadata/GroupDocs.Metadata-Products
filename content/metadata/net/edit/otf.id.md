...
############################# Head ############################
head_title: "Edit Metadata ke File Otf di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke OTF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file OTF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file OTF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format OTF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam OTF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti OTF Bawaan"
