...
############################# Head ############################
head_title: "Edit Metadata ke File Vsx di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke VSX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file VSX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file VSX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format VSX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam VSX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti VSX Bawaan"
