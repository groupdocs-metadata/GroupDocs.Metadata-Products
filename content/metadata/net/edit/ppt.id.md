...
############################# Head ############################
head_title: "Edit Metadata ke File Ppt di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke PPT di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file PPT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file PPT melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format PPT.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam PPT untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti PPT Bawaan"
