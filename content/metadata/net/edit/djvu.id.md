...
head_title: "Sunting &amp; Perbarui Metadata File DJVU di Aplikasi C# .NET"
head_description: "C# .NET metadata editing API untuk memperbarui informasi metadata dari file DJVU. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Perbarui Metadata File DJVU di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui DJVU Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk mengedit dan mengedit informasi metadata dari file DJVU dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Muat file DJVU melalui instance kelas Metadata.
...
demos:
    ...
    content: |
        Perbarui informasi metadata file DJVU sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
