...
############################# Head ############################
head_title: "Edit Metadata ke File Djvu di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DJVU di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DJVU dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DJVU melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DJVU.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DJVU untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DJVU Bawaan"
