...
############################# Head ############################
head_title: "Edit Metadata ke File Dicom di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DICOM di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DICOM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DICOM melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DICOM.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DICOM untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DICOM Bawaan"
