...
head_title: "Sunting &amp; Perbarui Metadata File TTF di Aplikasi C# .NET"
head_description: "C# .NET metadata editing API untuk memperbarui informasi metadata file TTF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Perbarui Metadata File TTF di C#"
...
steps:
    ...
    content_left: |
        ...
        * Simpan perubahan ke disk dalam format DCM.
...
demos:
    ...
    content: |
        Perbarui informasi metadata file TTF sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
