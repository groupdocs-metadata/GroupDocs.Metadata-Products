...
############################# Head ############################
head_title: "Edit Metadata ke DCM File di C# Aplikasi"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file DCM. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Perbarui Metadata File DCM Di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke DCM di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk mengedit informasi metadata ke file DCM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        
        * Muat file DCM melalui instance kelas Metadata.
...
demos:
    ...
    content: |
       Perbarui informasi metadata ke file DCM sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
