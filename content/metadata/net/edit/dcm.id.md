...
############################# Head ############################
head_title: "Edit Metadata ke File Dcm di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DCM di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DCM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DCM melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DCM.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DCM untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DCM Bawaan"
