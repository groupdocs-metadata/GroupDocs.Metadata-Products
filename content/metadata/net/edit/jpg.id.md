...
############################# Head ############################
head_title: "Edit Metadata ke File Jpg di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke JPG di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file JPG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file JPG melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format JPG.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam JPG untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti JPG Bawaan"
