...
############################# Head ############################
head_title: "Edit Metadata ke File Pdf di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke PDF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file PDF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file PDF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format PDF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam PDF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti PDF Bawaan"
