...
############################# Head ############################
head_title: "Edit Metadata ke ODT File di C# Aplikasi"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke ODT di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk mengedit informasi metadata ke file ODT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
