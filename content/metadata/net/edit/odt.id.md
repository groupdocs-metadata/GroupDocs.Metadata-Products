...
############################# Head ############################
head_title: "Edit Metadata ke File Odt di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file Odt. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke ODT di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file ODT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file ODT melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format ODT.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam ODT untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti ODT Bawaan"
