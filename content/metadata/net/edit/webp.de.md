...
############################# Head ############################
head_title: "Bearbeiten Sie Metadaten in Webp-Dateien in C#-Anwendungen"
head_description: "C#-Metadatenverarbeitungs-API zum Bearbeiten von Metadateninformationen in Webp-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten der Datei Webp in C# aktualisieren" 
...
steps:
    enable: true
    title: "Schritte zum Aktualisieren von Metadaten auf WEBP in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) erleichtert .NET-Entwicklern das Bearbeiten von Metadateninformationen zu WEBP-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
      
      1. Laden Sie die Datei WEBP über eine Instanz der Klasse Metadata.
      ...
      4. Speichern Sie die Änderungen im WEBP-Format auf der Disc.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Bearbeiten Sie das Erstellungsdatum WEBP
...
more_features:
  enable: true
  title: "Verwalten Sie die inneren Metadateneigenschaften von WEBP für .NET-Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Nutzung integrierter WEBP-Eigenschaften"
