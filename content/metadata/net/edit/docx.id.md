...
############################# Head ############################
head_title: "Edit Metadata ke File Docx di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DOCX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DOCX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DOCX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DOCX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DOCX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DOCX Bawaan"
