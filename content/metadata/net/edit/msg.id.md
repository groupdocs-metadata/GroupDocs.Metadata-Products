...
############################# Head ############################
head_title: "Edit Metadata ke File Msg di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke MSG di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file MSG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file MSG melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format MSG.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam MSG untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti MSG Bawaan"
