...
############################# Head ############################
head_title: "Edit Metadata ke File Epub di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke EPUB di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file EPUB dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file EPUB melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format EPUB.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam EPUB untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti EPUB Bawaan"
