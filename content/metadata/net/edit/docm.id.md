...
############################# Head ############################
head_title: "Edit Metadata ke File Docm di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DOCM di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DOCM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DOCM melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DOCM.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DOCM untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DOCM Bawaan"
