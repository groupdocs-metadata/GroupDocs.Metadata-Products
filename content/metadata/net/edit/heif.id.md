...
############################# Head ############################
head_title: "Edit Metadata ke HEIF File di C# Aplikasi"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file HEIF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Perbarui Metadata File HEIF Di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke HEIF di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk mengedit informasi metadata ke file HEIF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        
        * Muat file HEIF melalui instance kelas Metadata.
        ...
        * Simpan perubahan ke disk dalam format HEIF.
...
demos:
    ...
    content: |
       Perbarui informasi metadata ke file HEIF sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
