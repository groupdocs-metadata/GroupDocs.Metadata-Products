...
############################# Head ############################
head_title: "Edit Metadata ke File Heif di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke HEIF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file HEIF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file HEIF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format HEIF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam HEIF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti HEIF Bawaan"
