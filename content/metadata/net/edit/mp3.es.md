...
############################# Head ############################
head_title: "Editar metadatos en archivos Mp3 en aplicaciones C#"
head_description: "C# API de procesamiento de metadatos para editar información de metadatos en archivos Mp3. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Actualizar metadatos del archivo Mp3 en C#" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos a MP3 en C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET editar información de metadatos en archivos MP3 desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue el archivo MP3 a través de una instancia de la clase Metadata.
      ...
      4. Guarde los cambios en el disco en formato MP3.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar fecha de creación de MP3
...
more_features:
  enable: true
  title: "Administrar MP3 propiedades de metadatos internos para aplicaciones .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aprovechando las propiedades integradas MP3"
