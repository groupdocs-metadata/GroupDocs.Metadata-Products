...
############################# Head ############################
head_title: "Edit Metadata ke File Vcf di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file Vcf. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke VCF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file VCF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file VCF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format VCF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam VCF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti VCF Bawaan"
