...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](/metadata/net/) makes it easy for .NET developers to edit and edit metadata information from WMF files from within their applications by implementing a few easy steps.
