...
############################# Head ############################
head_title: "Edit Metadata ke File Xlsb di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke XLSB di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file XLSB dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file XLSB melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format XLSB.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam XLSB untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti XLSB Bawaan"
