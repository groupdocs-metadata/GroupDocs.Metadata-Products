...
############################# Head ############################
head_title: "Edit Metadata ke File Jp2 di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke JP2 di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file JP2 dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file JP2 melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format JP2.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam JP2 untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti JP2 Bawaan"
