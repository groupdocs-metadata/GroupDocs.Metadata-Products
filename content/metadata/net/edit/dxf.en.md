...
steps:
    enable: true
    title: "Steps for Updating Metadata to DXF in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to DXF files from within their applications by implementing a few easy steps.
      
      1. Load DXF file via an instance of Metadata class.
      ...
      4. Save the changes to disc in DXF format.
...
more_features:
  enable: true
  title: "Manage DXF Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in DXF Properties"
