...
############################# Head ############################
head_title: "Edit Metadata ke File Wmf di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke WMF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file WMF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file WMF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format WMF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam WMF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti WMF Bawaan"
