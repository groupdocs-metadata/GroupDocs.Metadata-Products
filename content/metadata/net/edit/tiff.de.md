...
############################# Head ############################
head_title: "Edit Metadata to TIFF Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to edit metadata information to TIFF files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata Of TIFF File  In C#"
...
steps:
    enable: true
    title_left: "Steps for Updating Metadata to TIFF in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/de/metadata/net/) makes it easy for .NET developers to edit metadata information to TIFF files from within their applications by implementing a few easy steps.
        
        * Load TIFF filevia an instance of Metadata class.
...
demos:
    ...
    content: |
       Update metadata information to TIFF file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
