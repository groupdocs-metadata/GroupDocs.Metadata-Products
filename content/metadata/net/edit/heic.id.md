...
############################# Head ############################
head_title: "Edit Metadata ke File Heic di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke HEIC di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file HEIC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file HEIC melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format HEIC.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam HEIC untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti HEIC Bawaan"
