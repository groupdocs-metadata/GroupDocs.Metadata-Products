...
############################# Head ############################
head_title: "Edit Metadata to Jp2 Files in C# Applications"
head_description: "C# metadata processing API to edit metadata information to Jp2 files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to JP2 in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to JP2 files from within their applications by implementing a few easy steps.
      
      1. Load JP2 file via an instance of Metadata class.
      ...
      4. Save the changes to disc in JP2 format.
...
more_features:
  enable: true
  title: "Manage JP2 Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in JP2 Properties"
