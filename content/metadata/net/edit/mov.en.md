...
steps:
    enable: true
    title: "Steps for Updating Metadata to MOV in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to MOV files from within their applications by implementing a few easy steps.
      
      1. Load MOV file via an instance of Metadata class.
      ...
      4. Save the changes to disc in MOV format.
...
more_features:
  enable: true
  title: "Manage MOV Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in MOV Properties"
