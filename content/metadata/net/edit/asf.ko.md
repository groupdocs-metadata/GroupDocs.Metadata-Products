...
############################# Head ############################
head_title: "Edit Metadata to ASF Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to edit metadata information to ASF files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title_left: "Steps for Updating Metadata to ASF in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/ko/metadata/net/) makes it easy for .NET developers to edit metadata information to ASF files from within their applications by implementing a few easy steps.
        
        * Load ASF filevia an instance of Metadata class.
...
demos:
    ...
    content: |
       Update metadata information to ASF file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
