...
steps:
    enable: true
    title: "Steps for Updating Metadata to FLV in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to FLV files from within their applications by implementing a few easy steps.
      
      1. Load FLV file via an instance of Metadata class.
      ...
      4. Save the changes to disc in FLV format.
...
more_features:
  enable: true
  title: "Manage FLV Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in FLV Properties"
