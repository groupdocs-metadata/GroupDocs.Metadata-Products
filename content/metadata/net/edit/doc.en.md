...
steps:
    enable: true
    title: "Steps for Updating Metadata to DOC in C#"
    content: |
      **[GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/)** makes it easy for .NET developers to edit metadata information to DOC files from within their applications by implementing a few easy steps.
      
      1. Load DOC file via an instance of Metadata class.
      ...
      4. Save the changes to disc in DOC format.
...
more_features:
  enable: true
  title: "Manage DOC Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in DOC Properties"
