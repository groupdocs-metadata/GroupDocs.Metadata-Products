...
############################# Head ############################
head_title: "Edit Metadata to JPG Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to edit metadata information to JPG files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title_left: "Steps for Updating Metadata to JPG in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/fr/metadata/net/) makes it easy for .NET developers to edit metadata information to JPG files from within their applications by implementing a few easy steps.
        
        * Load JPG filevia an instance of Metadata class.
...
demos:
    ...
    content: |
       Update metadata information to JPG file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
