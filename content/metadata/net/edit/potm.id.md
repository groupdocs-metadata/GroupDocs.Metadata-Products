...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) makes it easy for .NET developers to edit metadata information to POTM files from within their applications by implementing a few easy steps.
