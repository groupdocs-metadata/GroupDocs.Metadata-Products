...
############################# Head ############################
head_title: "Edit Metadata to XLTM Files in C# Applications"
head_description: "C# metadata processing API to edit metadata information to XLTM files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/metadata/net/) makes it easy for .NET developers to edit metadata information to XLTM files from within their applications by implementing a few easy steps.
