...
head_title: "Sunting &amp; Perbarui Metadata File DOTX di Aplikasi C# .NET"
head_description: "C# .NET metadata editing API untuk memperbarui informasi metadata dari file DOTX. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Perbarui Metadata File DOTX di C#"
...
steps:
    ...
    content_left: |
        ...
        * Simpan perubahan ke disk dalam format DOTX.
