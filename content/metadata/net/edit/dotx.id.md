...
############################# Head ############################
head_title: "Edit Metadata ke File Dotx di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke DOTX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file DOTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file DOTX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format DOTX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam DOTX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti DOTX Bawaan"
