...
############################# Head ############################
head_title: "Edit Metadata ke File Torrent di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke TORRENT di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file TORRENT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file TORRENT melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format TORRENT.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Edit tanggal pembuatan TORRENT
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam TORRENT untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti TORRENT Bawaan"
