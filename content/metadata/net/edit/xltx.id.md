...
############################# Head ############################
head_title: "Edit Metadata ke File Xltx di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke XLTX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file XLTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file XLTX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format XLTX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam XLTX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti XLTX Bawaan"
