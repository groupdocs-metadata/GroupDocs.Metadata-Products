...
steps:
    enable: true
    title: "Steps for Updating Metadata to POT in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to POT files from within their applications by implementing a few easy steps.
      
      1. Load POT file via an instance of Metadata class.
      ...
      4. Save the changes to disc in POT format.
...
more_features:
  enable: true
  title: "Manage POT Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in POT Properties"
