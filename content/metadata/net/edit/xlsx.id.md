...
############################# Head ############################
head_title: "Edit Metadata ke File Xlsx di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke XLSX di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file XLSX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file XLSX melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format XLSX.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam XLSX untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti XLSX Bawaan"
