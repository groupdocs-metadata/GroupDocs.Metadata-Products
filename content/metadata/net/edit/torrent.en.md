...
steps:
    enable: true
    title: "Steps for Updating Metadata to TORRENT in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to TORRENT files from within their applications by implementing a few easy steps.
      
      1. Load TORRENT file via an instance of Metadata class.
      ...
      4. Save the changes to disc in TORRENT format.
...
more_features:
  enable: true
  title: "Manage TORRENT Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in TORRENT Properties"
