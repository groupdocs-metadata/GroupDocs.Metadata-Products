...
############################# Head ############################
head_title: "Modifica i metadati in file Vcr nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per modificare le informazioni sui metadati nei file Vcr. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiorna i metadati del file Vcr in C#" 
...
steps:
    enable: true
    title: "Passaggi per l'aggiornamento dei metadati su VCR in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) consente agli sviluppatori di .NET di modificare facilmente le informazioni sui metadati nei file VCR dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica il file VCR tramite un'istanza della classe Metadata.
      ...
      4. Salva le modifiche sul disco nel formato VCR.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifica la data di creazione di VCR
...
more_features:
  enable: true
  title: "Gestisci le proprietà dei metadati interni di VCR per le app .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Sfruttare le proprietà VCR integrate"
