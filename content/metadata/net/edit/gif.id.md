...
############################# Head ############################
head_title: "Edit Metadata ke File Gif di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke GIF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file GIF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file GIF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format GIF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam GIF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti GIF Bawaan"
