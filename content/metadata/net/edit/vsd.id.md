...
############################# Head ############################
head_title: "Edit Metadata ke File Vsd di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke VSD di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file VSD dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file VSD melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format VSD.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam VSD untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti VSD Bawaan"
