...
############################# Head ############################
head_title: "Edite metadados para arquivos Xltm em aplicativos C#"
head_description: "API de processamento de metadados C# para editar informações de metadados em arquivos Xltm. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Xltm em C#" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para XLTM em C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) torna mais fácil para os desenvolvedores de .NET editar informações de metadados em arquivos XLTM de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o arquivo XLTM por meio de uma instância da classe Metadata.
      ...
      4. Salve as alterações no disco no formato XLTM.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar data de criação de XLTM
...
more_features:
  enable: true
  title: "Gerenciar propriedades de metadados internos XLTM para aplicativos .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aproveitando propriedades integradas de XLTM"
