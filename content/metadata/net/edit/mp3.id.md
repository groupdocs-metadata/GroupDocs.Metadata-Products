...
############################# Head ############################
head_title: "Edit Metadata ke File Mp3 di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke MP3 di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file MP3 dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file MP3 melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format MP3.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam MP3 untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti MP3 Bawaan"
