...
head_title: "Sunting &amp; Perbarui Metadata File MP3 di Aplikasi C# .NET"
head_description: "C# .NET metadata editing API untuk memperbarui informasi metadata dari file MP3. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Perbarui Metadata File MP3 di C#"
...
about:
    ...
    content: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) menawarkan serangkaian fitur manajemen metadata lanjutan, yang memungkinkan pengembang untuk dengan mudah membaca, MP3, menghapus, menemukan, membandingkan, mengganti, dan mengekspor informasi metadata dari gambar dan format dokumen tanpa menggunakan perangkat lunak eksternal apa pun. Gunakan API manipulasi metadata untuk mengedit detail metadata dari PDF, Microsoft Office Word, spreadsheet Excel, presentasi PowerPoint, email Outlook, OneNote, Visio, Project, AutoCAD, Arsip, dan format file Multimedia bersama dengan dukungan untuk bekerja dengan banyak fitur pemrosesan metadata lainnya.

steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui MP3 Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk mengedit dan mengedit informasi metadata dari file MP3 dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Muat file MP3 melalui instance kelas Metadata.
        ...
        * Simpan perubahan ke disk dalam format MP3.
...
demos:
    ...
    content: |
        Perbarui informasi metadata file MP3 sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
...
about_formats:
    ...
    format:
        - icon: "far fa-file-mp3"
          title: "Tentang Format Berkas MP3"
          content: |
            File dengan ekstensi MP3 adalah format file yang dikodekan secara digital untuk file audio yang secara formal didasarkan pada MPEG-1 Audio Layer III atau MPEG-2 Audio Layer III. Ini dikembangkan oleh Moving Picture Experts Group (MPEG) yang menggunakan kompresi audio Layer 3. Kompresi yang dicapai oleh format file MP3 adalah 1/10 ukuran file .WAV atau .AIF. Format ini memberikan keuntungan dari streaming file audio tersebut melalui internet untuk mendengarkan online yang sebelumnya tidak mungkin karena ukuran file yang besar dari file audio. Kualitas suara file audio MP3 dapat dikontrol dengan pengaturan parameter seperti bit rate, sample rate, joint atau stereo normal.
