...
############################# Head ############################
head_title: "Edit Metadata to Mpp Files in C# Applications"
head_description: "C# metadata processing API to edit metadata information to Mpp files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to MPP in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to MPP files from within their applications by implementing a few easy steps.
      
      1. Load MPP file via an instance of Metadata class.
      ...
      4. Save the changes to disc in MPP format.
...
more_features:
  enable: true
  title: "Manage MPP Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in MPP Properties"
