...
steps:
    enable: true
    title: "Steps for Updating Metadata to VSDX in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to VSDX files from within their applications by implementing a few easy steps.
      
      1. Load VSDX file via an instance of Metadata class.
      ...
      4. Save the changes to disc in VSDX format.
...
more_features:
  enable: true
  title: "Manage VSDX Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in VSDX Properties"
