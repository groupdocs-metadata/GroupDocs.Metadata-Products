...
############################# Head ############################
head_title: "Edit Metadata to Webp Files in C# Applications"
head_description: "C# metadata processing API to edit metadata information to Webp files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to WEBP in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to WEBP files from within their applications by implementing a few easy steps.
      
      1. Load WEBP file via an instance of Metadata class.
      ...
      4. Save the changes to disc in WEBP format.
...
more_features:
  enable: true
  title: "Manage WEBP Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in WEBP Properties"
