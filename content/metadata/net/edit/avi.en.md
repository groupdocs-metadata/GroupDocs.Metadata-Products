...
############################# Head ############################
head_title: "Edit Metadata to Avi Files in C# Applications"
head_description: "C# metadata processing API to edit metadata information to Avi files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to AVI in C#"
    content: |
      **[GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/)** makes it easy for .NET developers to edit metadata information to AVI files from within their applications by implementing a few easy steps.
      
      1. Load AVI file via an instance of Metadata class.
      ...
      4. Save the changes to disc in AVI format.
...
more_features:
  enable: true
  title: "Manage AVI Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in AVI Properties"
