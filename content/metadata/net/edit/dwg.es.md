...
############################# Head ############################
head_title: "Editar metadatos en archivos Dwg en aplicaciones C#"
head_description: "C# API de procesamiento de metadatos para editar información de metadatos en archivos Dwg. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Actualizar metadatos del archivo Dwg en C#" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos a DWG en C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET editar información de metadatos en archivos DWG desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue el archivo DWG a través de una instancia de la clase Metadata.
      ...
      4. Guarde los cambios en el disco en formato DWG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar fecha de creación de DWG
...
more_features:
  enable: true
  title: "Administrar DWG propiedades de metadatos internos para aplicaciones .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aprovechando las propiedades integradas DWG"
