...
steps:
    enable: true
    title: "Steps for Updating Metadata to OTF in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to OTF files from within their applications by implementing a few easy steps.
      
      1. Load OTF file via an instance of Metadata class.
      ...
      4. Save the changes to disc in OTF format.
...
more_features:
  enable: true
  title: "Manage OTF Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in OTF Properties"
