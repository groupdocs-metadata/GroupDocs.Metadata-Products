...
############################# Head ############################
head_title: "Edit Metadata ke File Tiff di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke TIFF di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file TIFF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file TIFF melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format TIFF.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam TIFF untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti TIFF Bawaan"
