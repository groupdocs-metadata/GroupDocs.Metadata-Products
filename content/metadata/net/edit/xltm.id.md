...
############################# Head ############################
head_title: "Edit Metadata ke File Xltm di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke XLTM di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file XLTM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file XLTM melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format XLTM.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam XLTM untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti XLTM Bawaan"
