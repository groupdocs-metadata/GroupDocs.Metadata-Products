...
############################# Head ############################
head_title: "Edit Metadata to XLSX Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to edit metadata information to XLSX files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title_left: "Steps for Updating Metadata to XLSX in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/de/metadata/net/) makes it easy for .NET developers to edit metadata information to XLSX files from within their applications by implementing a few easy steps.
        
        * Load XLSX filevia an instance of Metadata class.
...
demos:
    ...
    content: |
       Update metadata information to XLSX file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
