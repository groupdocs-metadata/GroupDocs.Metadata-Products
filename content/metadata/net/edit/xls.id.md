...
############################# Head ############################
head_title: "Edit Metadata ke File Xls di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk mengedit informasi metadata ke file Xls. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke XLS di C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengedit informasi metadata ke file XLS dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file XLS melalui instance kelas Metadata.
      ...
      4. Simpan perubahan ke disk dalam format XLS.
...
more_features:
  enable: true
  title: "Kelola Properti Metadata Dalam XLS untuk Aplikasi .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Properti XLS Bawaan"
