...
############################# Head ############################
head_title: "Edit Metadata ke PPTX File di C# Aplikasi"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke PPTX di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk mengedit informasi metadata ke file PPTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
       Perbarui informasi metadata ke file PPTX sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
