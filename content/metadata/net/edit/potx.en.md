...
steps:
    enable: true
    title: "Steps for Updating Metadata to POTX in C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to edit metadata information to POTX files from within their applications by implementing a few easy steps.
      
      1. Load POTX file via an instance of Metadata class.
      ...
      4. Save the changes to disc in POTX format.
...
more_features:
  enable: true
  title: "Manage POTX Inner Metadata Properties for .NET Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging Built-in POTX Properties"
