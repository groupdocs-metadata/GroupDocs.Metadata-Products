...
############################# Head ############################
head_title: "Edite metadados para arquivos Mp3 em aplicativos C#"
head_description: "API de processamento de metadados C# para editar informações de metadados em arquivos Mp3. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Mp3 em C#" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para MP3 em C#"
    content: |
      [GroupDocs.Metadata for .NET](https://products.groupdocs.com/metadata/net/) torna mais fácil para os desenvolvedores de .NET editar informações de metadados em arquivos MP3 de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o arquivo MP3 por meio de uma instância da classe Metadata.
      ...
      4. Salve as alterações no disco no formato MP3.
...
more_features:
  enable: true
  title: "Gerenciar propriedades de metadados internos MP3 para aplicativos .NET"
  ...
  features:
    ...
    # feature loop
    - title: "Aproveitando propriedades integradas de MP3"
