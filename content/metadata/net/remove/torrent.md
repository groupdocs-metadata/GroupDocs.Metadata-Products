...
############################# Head ############################
head_title: "Remove Metadata to TORRENT Files in C# Applications"
head_description: "C# metadata processing API to remove metadata information to TORRENT files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
