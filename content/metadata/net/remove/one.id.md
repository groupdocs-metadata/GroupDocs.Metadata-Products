...
head_title: "Hapus Metadata dari ONE File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file ONE. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Hapus Metadata dari File ONE di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus ONE Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file ONE dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Muat ONE dengan instance kelas Metadata.
        ...
        * Simpan kembali perubahan dalam format ONE.
