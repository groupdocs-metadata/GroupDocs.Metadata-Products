...
############################# Head ############################
head_title: "Supprimer les métadonnées des fichiers TIFF dans les applications C#"
head_description: "C# API de traitement des métadonnées pour supprimer les informations de métadonnées des fichiers TIFF. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Supprimer les métadonnées du fichier TIFF dans C#" 
...
steps:
    enable: true
    title: "Étapes pour supprimer les métadonnées TIFF dans C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) permet aux développeurs .NET de supprimer facilement les détails des métadonnées des fichiers TIFF à partir de leurs applications en mettant en œuvre quelques étapes simples.
      
      1. Chargez TIFF avec une instance de la classe Metadata.
      ...
      4. Enregistrez à nouveau les modifications au format TIFF.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Supprimer les métadonnées du fichier TIFF
