...
############################# Head ############################
head_title: "Eliminar metadatos de archivos HEIF en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos HEIF. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo HEIF en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos HEIF en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos HEIF desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue HEIF con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato HEIF.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo HEIF
