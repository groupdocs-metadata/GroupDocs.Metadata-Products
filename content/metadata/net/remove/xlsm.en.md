...
steps:
    enable: true
    title: "Steps for Removing XLSM Metadata in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to remove metadata details to XLSM files from within their applications by implementing a few easy steps.
