...
############################# Head ############################
head_title: "Entfernen Sie Metadaten zu PSD-Dateien in C#-Anwendungen"
head_description: "C#-Metadatenverarbeitungs-API zum Entfernen von Metadateninformationen aus PSD-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten aus der Datei PSD in C# entfernen" 
...
steps:
    enable: true
    title: "Schritte zum Entfernen von PSD-Metadaten in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) erleichtert .NET-Entwicklern das Entfernen von Metadatendetails zu PSD-Dateien aus ihren Anwendungen, indem sie ein paar einfache Schritte implementieren.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Entfernen Sie PSD-Dateimetadaten
