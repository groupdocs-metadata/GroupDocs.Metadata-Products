...
############################# Head ############################
head_title: "Rimuovi i metadati dai file WMF nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per rimuovere le informazioni sui metadati nei file WMF. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Rimuovi metadati dal file WMF in C#" 
...
steps:
    enable: true
    title: "Passaggi per rimuovere i metadati di WMF in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) semplifica agli sviluppatori di .NET la rimozione dei dettagli dei metadati nei file WMF dalle loro applicazioni implementando alcuni semplici passaggi.
      ...
      4. Salva nuovamente le modifiche nel formato WMF.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Rimuovi i metadati del file WMF
