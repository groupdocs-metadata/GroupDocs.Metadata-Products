...
############################# Head ############################
head_title: "Eliminar metadatos de archivos MP3 en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos MP3. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo MP3 en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos MP3 en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos MP3 desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue MP3 con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato MP3.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo MP3
