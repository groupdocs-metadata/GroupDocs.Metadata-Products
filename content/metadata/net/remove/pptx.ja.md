...
head_title: "C＃.NETアプリケーションでPPTXファイルのメタデータを削除する"
head_description: "PPTXファイルのメタデータ情報を削除するC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "C＃でPPTXファイルからメタデータを削除する"
...
steps:
    enable: true
    title_left: "C＃でPPTXメタデータを削除する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からPPTXファイルからメタデータの詳細を簡単に削除できます。
