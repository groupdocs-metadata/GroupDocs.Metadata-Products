...
############################# Head ############################
head_title: "Eliminar metadatos de archivos EML en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos EML. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo EML en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos EML en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos EML desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue EML con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato EML.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo EML
