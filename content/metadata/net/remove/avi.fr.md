...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/fr/metadata/net/) makes it easy for .NET developers to remove  metadata details to AVI files from within their applications by implementing a few easy steps.
