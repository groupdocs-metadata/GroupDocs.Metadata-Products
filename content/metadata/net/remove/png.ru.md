...
############################# Head ############################
head_title: "Remove Metadata to PNG Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to remove metadata information to PNG files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Remove Metadata From PNG File In C#"
...
steps:
    enable: true
    title_left: "Steps for Removing PNG Metadata in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/ru/metadata/net/) makes it easy for .NET developers to remove  metadata details to PNG files from within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
       Delete metadata information of PNG file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
