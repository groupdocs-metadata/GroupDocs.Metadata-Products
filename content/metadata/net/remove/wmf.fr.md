...
############################# Head ############################
head_title: "Supprimer les métadonnées des fichiers WMF dans les applications C#"
head_description: "C# API de traitement des métadonnées pour supprimer les informations de métadonnées des fichiers WMF. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Supprimer les métadonnées du fichier WMF dans C#" 
...
steps:
    enable: true
    title: "Étapes pour supprimer les métadonnées WMF dans C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) permet aux développeurs .NET de supprimer facilement les détails des métadonnées des fichiers WMF à partir de leurs applications en mettant en œuvre quelques étapes simples.
      
      1. Chargez WMF avec une instance de la classe Metadata.
      ...
      4. Enregistrez à nouveau les modifications au format WMF.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Supprimer les métadonnées du fichier WMF
