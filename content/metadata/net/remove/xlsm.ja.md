...
head_title: "C＃.NETアプリケーションでXLSMファイルのメタデータを削除する"
head_description: "XLSMファイルのメタデータ情報を削除するためのC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "C＃でXLSMファイルからメタデータを削除する"
...
steps:
    enable: true
    title_left: "C＃でXLSMメタデータを削除する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からXLSMファイルからメタデータの詳細を簡単に削除できます。
