...
############################# Head ############################
head_title: "Eliminar metadatos de archivos HEIC en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos HEIC. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo HEIC en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos HEIC en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos HEIC desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue HEIC con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato HEIC.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo HEIC
