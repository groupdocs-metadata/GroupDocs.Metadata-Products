...
############################# Head ############################
head_title: "Remova metadados de arquivos TIFF em aplicativos C#"
head_description: "API de processamento de metadados C# para remover informações de metadados de arquivos TIFF. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Remover metadados do arquivo TIFF em C#" 
...
steps:
    enable: true
    title: "Etapas para remover metadados TIFF em C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) torna mais fácil para os desenvolvedores de .NET remover detalhes de metadados de arquivos TIFF de dentro de seus aplicativos, implementando algumas etapas fáceis.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Remover metadados do arquivo TIFF
