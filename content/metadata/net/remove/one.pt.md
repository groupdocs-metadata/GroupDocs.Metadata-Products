...
############################# Head ############################
head_title: "Remova metadados de arquivos ONE em aplicativos C#"
head_description: "API de processamento de metadados C# para remover informações de metadados de arquivos ONE. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Remover metadados do arquivo ONE em C#" 
...
steps:
    enable: true
    title: "Etapas para remover metadados ONE em C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) torna mais fácil para os desenvolvedores de .NET remover detalhes de metadados de arquivos ONE de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue ONE com uma instância da classe Metadata.
      ...
      4. Salve as alterações no formato ONE.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Remover metadados do arquivo ONE
