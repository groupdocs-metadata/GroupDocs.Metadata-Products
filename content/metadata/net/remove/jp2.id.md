...
head_title: "Hapus Metadata dari JP2 File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file JP2. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Hapus Metadata dari File JP2 di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus JP2 Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file JP2 dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Simpan kembali perubahan dalam format JP2.
