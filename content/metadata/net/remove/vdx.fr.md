...
############################# Head ############################
head_title: "Supprimer les métadonnées des fichiers VDX dans les applications C#"
head_description: "C# API de traitement des métadonnées pour supprimer les informations de métadonnées des fichiers VDX. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Supprimer les métadonnées du fichier VDX dans C#" 
...
steps:
    enable: true
    title: "Étapes pour supprimer les métadonnées VDX dans C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) permet aux développeurs .NET de supprimer facilement les détails des métadonnées des fichiers VDX à partir de leurs applications en mettant en œuvre quelques étapes simples.
      
      1. Chargez VDX avec une instance de la classe Metadata.
      ...
      4. Enregistrez à nouveau les modifications au format VDX.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Supprimer les métadonnées du fichier VDX
