...
head_title: "Hapus Metadata dari ODT File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file ODT. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Hapus Metadata dari File ODT di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus ODT Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file ODT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Simpan kembali perubahan dalam format ODT.
