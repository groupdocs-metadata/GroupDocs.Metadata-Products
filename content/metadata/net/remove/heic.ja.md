...
head_title: "C＃.NETアプリケーションでHEICファイルのメタデータを削除する"
head_description: "HEICファイルのメタデータ情報を削除するC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "C＃でHEICファイルからメタデータを削除する"
...
steps:
    enable: true
    title_left: "C＃でHEICメタデータを削除する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からHEICファイルからメタデータの詳細を簡単に削除できます。
