...
############################# Head ############################
head_title: "Eliminar metadatos de archivos JPG en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos JPG. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo JPG en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos JPG en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos JPG desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue JPG con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato JPG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo JPG
