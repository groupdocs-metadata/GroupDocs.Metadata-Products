...
############################# Head ############################
head_title: "Eliminar metadatos de archivos DOTM en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos DOTM. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo DOTM en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos DOTM en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos DOTM desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue DOTM con una instancia de la clase Metadata.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo DOTM
