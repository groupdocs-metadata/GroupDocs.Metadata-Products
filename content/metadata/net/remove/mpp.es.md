...
############################# Head ############################
head_title: "Eliminar metadatos de archivos MPP en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos MPP. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo MPP en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos MPP en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos MPP desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue MPP con una instancia de la clase Metadata.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo MPP
