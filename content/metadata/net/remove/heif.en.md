...
steps:
    enable: true
    title: "Steps for Removing HEIF Metadata in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to remove metadata details to HEIF files from within their applications by implementing a few easy steps.
      
      1. Load HEIF with an instance of Metadata class.
