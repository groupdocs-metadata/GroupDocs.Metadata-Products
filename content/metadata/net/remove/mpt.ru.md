...
############################# Head ############################
head_title: "Remove Metadata to MPT Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to remove metadata information to MPT files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Remove Metadata From MPT File In C#"
...
steps:
    enable: true
    title_left: "Steps for Removing MPT Metadata in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/ru/metadata/net/) makes it easy for .NET developers to remove  metadata details to MPT files from within their applications by implementing a few easy steps.
        
        * Load MPT with an instance of Metadata class.
        * Use a predicate to find desired metadata properties.
        * Use Metadata.RemoveProperties method to remove the properties.
        * Save the changes back in MPT format.
...
demos:
    ...
    content: |
       Delete metadata information of MPT file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
