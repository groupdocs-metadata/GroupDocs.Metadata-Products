...
head_title: "Hapus Metadata dari MSG File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file MSG. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus MSG Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file MSG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
