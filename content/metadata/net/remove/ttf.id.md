...
############################# Head ############################
head_title: "Hapus Metadata ke File TTF di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk menghapus informasi metadata ke file TTF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Hapus Metadata Dari File TTF Di C#" 
...
steps:
    enable: true
    title: "Langkah-langkah Menghapus Metadata TTF di C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata pada file TTF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat TTF dengan instance kelas Metadata.
      ...
      4. Simpan kembali perubahan dalam format TTF.
