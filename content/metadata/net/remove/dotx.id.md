...
############################# Head ############################
head_title: "Hapus Metadata ke File DOTX di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk menghapus informasi metadata ke file DOTX. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Hapus Metadata Dari File DOTX Di C#" 
...
steps:
    enable: true
    title: "Langkah-langkah Menghapus Metadata DOTX di C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata pada file DOTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
