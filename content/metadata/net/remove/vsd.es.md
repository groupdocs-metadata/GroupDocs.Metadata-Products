...
############################# Head ############################
head_title: "Eliminar metadatos de archivos VSD en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos VSD. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo VSD en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos VSD en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos VSD desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue VSD con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato VSD.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo VSD
