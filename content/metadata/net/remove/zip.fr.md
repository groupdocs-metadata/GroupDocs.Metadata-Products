...
############################# Head ############################
head_title: "Supprimer les métadonnées des fichiers ZIP dans les applications C#"
head_description: "C# API de traitement des métadonnées pour supprimer les informations de métadonnées des fichiers ZIP. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Supprimer les métadonnées du fichier ZIP dans C#" 
...
steps:
    enable: true
    title: "Étapes pour supprimer les métadonnées ZIP dans C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) permet aux développeurs .NET de supprimer facilement les détails des métadonnées des fichiers ZIP à partir de leurs applications en mettant en œuvre quelques étapes simples.
      
      1. Chargez ZIP avec une instance de la classe Metadata.
      ...
      4. Enregistrez à nouveau les modifications au format ZIP.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Supprimer les métadonnées du fichier ZIP
