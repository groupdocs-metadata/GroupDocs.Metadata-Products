...
############################# Head ############################
head_title: "Hapus Metadata ke File OTC di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk menghapus informasi metadata ke file OTC. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Menghapus Metadata OTC di C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata pada file OTC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat OTC dengan instance kelas Metadata.
      ...
      4. Simpan kembali perubahan dalam format OTC.
