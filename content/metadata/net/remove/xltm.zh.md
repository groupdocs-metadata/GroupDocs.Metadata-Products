...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/zh/metadata/net/) makes it easy for .NET developers to remove  metadata details to XLTM files from within their applications by implementing a few easy steps.
