...
head_title: "Hapus Metadata dari TORRENT File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file TORRENT. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Hapus Metadata dari File TORRENT di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus TORRENT Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file TORRENT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
