...
############################# Head ############################
head_title: "Entfernen Sie Metadaten zu JPEG-Dateien in C#-Anwendungen"
head_description: "C#-Metadatenverarbeitungs-API zum Entfernen von Metadateninformationen aus JPEG-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten aus der Datei JPEG in C# entfernen" 
...
steps:
    enable: true
    title: "Schritte zum Entfernen von JPEG-Metadaten in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) erleichtert .NET-Entwicklern das Entfernen von Metadatendetails zu JPEG-Dateien aus ihren Anwendungen, indem sie ein paar einfache Schritte implementieren.
      
      1. Laden Sie JPEG mit einer Instanz der Klasse Metadata.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Entfernen Sie JPEG-Dateimetadaten
