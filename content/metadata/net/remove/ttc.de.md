...
############################# Head ############################
head_title: "Entfernen Sie Metadaten zu TTC-Dateien in C#-Anwendungen"
head_description: "C#-Metadatenverarbeitungs-API zum Entfernen von Metadateninformationen aus TTC-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten aus der Datei TTC in C# entfernen" 
...
steps:
    enable: true
    title: "Schritte zum Entfernen von TTC-Metadaten in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) erleichtert .NET-Entwicklern das Entfernen von Metadatendetails zu TTC-Dateien aus ihren Anwendungen, indem sie ein paar einfache Schritte implementieren.
      
      1. Laden Sie TTC mit einer Instanz der Klasse Metadata.
      ...
      4. Speichern Sie die Änderungen im TTC-Format.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Entfernen Sie TTC-Dateimetadaten
