...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/es/metadata/net/) makes it easy for .NET developers to remove  metadata details to ZIP files from within their applications by implementing a few easy steps.
