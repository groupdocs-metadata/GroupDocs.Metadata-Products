...
head_title: "Hapus Metadata dari JPEG File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file JPEG. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Hapus Metadata dari File JPEG di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus JPEG Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file JPEG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Simpan kembali perubahan dalam format JPEG.
