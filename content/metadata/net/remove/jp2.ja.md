...
head_title: "C＃.NETアプリケーションでJP2ファイルのメタデータを削除する"
head_description: "JP2ファイルのメタデータ情報を削除するC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作する."

title: "C＃でJP2ファイルからメタデータを削除する"
...
steps:
    enable: true
    title_left: "C＃でJP2メタデータを削除する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からJP2ファイルからメタデータの詳細を簡単に削除できます。
