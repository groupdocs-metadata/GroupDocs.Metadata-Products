...
############################# Head ############################
head_title: "Rimuovi i metadati dai file MKV nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per rimuovere le informazioni sui metadati nei file MKV. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Rimuovi metadati dal file MKV in C#" 
...
steps:
    enable: true
    title: "Passaggi per rimuovere i metadati di MKV in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) semplifica agli sviluppatori di .NET la rimozione dei dettagli dei metadati nei file MKV dalle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica MKV con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato MKV.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Rimuovi i metadati del file MKV
