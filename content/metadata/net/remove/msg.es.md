...
############################# Head ############################
head_title: "Eliminar metadatos de archivos MSG en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos MSG. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo MSG en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos MSG en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos MSG desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue MSG con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato MSG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo MSG
