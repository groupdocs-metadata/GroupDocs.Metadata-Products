...
############################# Head ############################
head_title: "Rimuovi i metadati dai file ONE nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per rimuovere le informazioni sui metadati nei file ONE. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Rimuovi metadati dal file ONE in C#" 
...
steps:
    enable: true
    title: "Passaggi per rimuovere i metadati di ONE in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) semplifica agli sviluppatori di .NET la rimozione dei dettagli dei metadati nei file ONE dalle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica ONE con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato ONE.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Rimuovi i metadati del file ONE
