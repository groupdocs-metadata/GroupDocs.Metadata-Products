...
head_title: "Hapus Metadata dari TTC File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file TTC. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Hapus Metadata dari File TTC di C# .NET"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus TTC Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file TTC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
        Hapus informasi metadata file TTC sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
