...
############################# Head ############################
head_title: "Hapus Metadata ke File TTC di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk menghapus informasi metadata ke file TTC. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Hapus Metadata Dari File TTC Di C#" 
...
steps:
    enable: true
    title: "Langkah-langkah Menghapus Metadata TTC di C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata pada file TTC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat TTC dengan instance kelas Metadata.
      ...
      4. Simpan kembali perubahan dalam format TTC.
