...
############################# Head ############################
head_title: "Entfernen Sie Metadaten zu DCM-Dateien in C#-Anwendungen"
head_description: "C#-Metadatenverarbeitungs-API zum Entfernen von Metadateninformationen aus DCM-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten aus der Datei DCM in C# entfernen" 
...
steps:
    enable: true
    title: "Schritte zum Entfernen von DCM-Metadaten in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) erleichtert .NET-Entwicklern das Entfernen von Metadatendetails zu DCM-Dateien aus ihren Anwendungen, indem sie ein paar einfache Schritte implementieren.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Entfernen Sie DCM-Dateimetadaten
