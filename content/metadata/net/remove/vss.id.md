...
head_title: "Hapus Metadata dari VSS File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file VSS. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Hapus Metadata dari File VSS di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus VSS Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file VSS dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Simpan kembali perubahan dalam format VSS.
