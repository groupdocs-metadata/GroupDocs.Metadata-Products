...
steps:
    enable: true
    title: "Steps for Removing ASF Metadata in C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) makes it easy for .NET developers to remove metadata details to ASF files from within their applications by implementing a few easy steps.
