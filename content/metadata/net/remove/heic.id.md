...
head_title: "Hapus Metadata dari HEIC File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menghapus informasi metadata dari file HEIC. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Hapus Metadata dari File HEIC di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus HEIC Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata dari file HEIC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Simpan kembali perubahan dalam format HEIC.
