...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/ja/metadata/net/) makes it easy for .NET developers to remove  metadata details to ONE files from within their applications by implementing a few easy steps.
