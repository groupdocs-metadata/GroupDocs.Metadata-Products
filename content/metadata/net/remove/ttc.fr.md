...
############################# Head ############################
head_title: "Supprimer les métadonnées des fichiers TTC dans les applications C#"
head_description: "C# API de traitement des métadonnées pour supprimer les informations de métadonnées des fichiers TTC. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Supprimer les métadonnées du fichier TTC dans C#" 
...
steps:
    enable: true
    title: "Étapes pour supprimer les métadonnées TTC dans C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) permet aux développeurs .NET de supprimer facilement les détails des métadonnées des fichiers TTC à partir de leurs applications en mettant en œuvre quelques étapes simples.
      
      1. Chargez TTC avec une instance de la classe Metadata.
      ...
      4. Enregistrez à nouveau les modifications au format TTC.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Supprimer les métadonnées du fichier TTC
