...
############################# Head ############################
head_title: "Supprimer les métadonnées des fichiers VSX dans les applications C#"
head_description: "C# API de traitement des métadonnées pour supprimer les informations de métadonnées des fichiers VSX. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Supprimer les métadonnées du fichier VSX dans C#" 
...
steps:
    enable: true
    title: "Étapes pour supprimer les métadonnées VSX dans C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) permet aux développeurs .NET de supprimer facilement les détails des métadonnées des fichiers VSX à partir de leurs applications en mettant en œuvre quelques étapes simples.
      
      1. Chargez VSX avec une instance de la classe Metadata.
      ...
      4. Enregistrez à nouveau les modifications au format VSX.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Supprimer les métadonnées du fichier VSX
