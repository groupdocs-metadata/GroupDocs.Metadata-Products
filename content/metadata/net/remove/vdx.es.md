...
############################# Head ############################
head_title: "Eliminar metadatos de archivos VDX en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos VDX. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo VDX en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos VDX en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos VDX desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue VDX con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato VDX.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo VDX
