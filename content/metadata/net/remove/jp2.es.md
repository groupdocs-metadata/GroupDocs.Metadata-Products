...
############################# Head ############################
head_title: "Eliminar metadatos de archivos JP2 en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos JP2. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo JP2 en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos JP2 en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos JP2 desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue JP2 con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato JP2.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo JP2
