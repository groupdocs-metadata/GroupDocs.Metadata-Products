...
############################# Head ############################
head_title: "Supprimer les métadonnées des fichiers JPEG dans les applications C#"
head_description: "C# API de traitement des métadonnées pour supprimer les informations de métadonnées des fichiers JPEG. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Supprimer les métadonnées du fichier JPEG dans C#" 
...
steps:
    enable: true
    title: "Étapes pour supprimer les métadonnées JPEG dans C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) permet aux développeurs .NET de supprimer facilement les détails des métadonnées des fichiers JPEG à partir de leurs applications en mettant en œuvre quelques étapes simples.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Supprimer les métadonnées du fichier JPEG
