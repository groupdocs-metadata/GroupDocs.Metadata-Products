...
############################# Head ############################
head_title: "Supprimer les métadonnées des fichiers TIF dans les applications C#"
head_description: "C# API de traitement des métadonnées pour supprimer les informations de métadonnées des fichiers TIF. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Supprimer les métadonnées du fichier TIF dans C#" 
...
steps:
    enable: true
    title: "Étapes pour supprimer les métadonnées TIF dans C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) permet aux développeurs .NET de supprimer facilement les détails des métadonnées des fichiers TIF à partir de leurs applications en mettant en œuvre quelques étapes simples.
      
      1. Chargez TIF avec une instance de la classe Metadata.
      ...
      4. Enregistrez à nouveau les modifications au format TIF.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Supprimer les métadonnées du fichier TIF
