...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/ko/metadata/net/) makes it easy for .NET developers to remove  metadata details to DOTM files from within their applications by implementing a few easy steps.
