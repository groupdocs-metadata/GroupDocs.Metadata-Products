...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](/metadata/net/) makes it easy for .NET developers to remove metadata details from OTC files from within their applications by implementing a few easy steps.
