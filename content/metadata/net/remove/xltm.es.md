...
############################# Head ############################
head_title: "Eliminar metadatos de archivos XLTM en aplicaciones C#"
head_description: "API de procesamiento de metadatos C# para eliminar información de metadatos de archivos XLTM. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos del archivo XLTM en C#" 
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos XLTM en C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET eliminar detalles de metadatos de archivos XLTM desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      ...
      4. Guarde los cambios nuevamente en formato XLTM.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar metadatos del archivo XLTM
