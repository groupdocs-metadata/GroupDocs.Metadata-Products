...
############################# Head ############################
head_title: "Remove Metadata to ONE Files in C# Applications"
head_description: "C# metadata processing API to remove metadata information to ONE files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
