...
############################# Head ############################
head_title: "Hapus Metadata ke File PPSM di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk menghapus informasi metadata ke file PPSM. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Menghapus Metadata PPSM di C#"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET untuk menghapus detail metadata pada file PPSM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
