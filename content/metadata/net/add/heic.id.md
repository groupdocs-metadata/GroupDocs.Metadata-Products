...
############################# Head ############################
head_title: "Tambahkan Metadata ke File HEIC di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke Heic di C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file HEIC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
