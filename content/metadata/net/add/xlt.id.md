...
############################# Head ############################
head_title: "Tambahkan Metadata ke File XLT di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk menambahkan informasi metadata ke file XLT. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke Xlt di C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file XLT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
