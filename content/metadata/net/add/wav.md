...
############################# Head ############################
head_title: "Add Metadata to WAV Files in C# Applications"
head_description: "C# metadata processing API to add metadata information to WAV files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
