...
############################# Head ############################
head_title: "Agregar metadatos a archivos TORRENT en aplicaciones C#"
head_description: "C# API de procesamiento de metadatos para agregar información de metadatos a archivos TORRENT. Trabajar con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a TORRENT en C#" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a Torrent en C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) facilita a los desarrolladores de .NET agregar detalles de metadatos a archivos TORRENT desde sus aplicaciones mediante la implementación de unos sencillos pasos.
