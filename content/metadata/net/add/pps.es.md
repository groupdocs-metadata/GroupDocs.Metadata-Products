...
steps:
    ...
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) facilita a los desarrolladores de .NET agregar detalles de metadatos a archivos PPS desde sus aplicaciones mediante la implementación de unos sencillos pasos.
