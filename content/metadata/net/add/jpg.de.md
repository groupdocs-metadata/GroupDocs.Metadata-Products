...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) erleichtert .NET-Entwicklern das Hinzufügen von Metadatendetails zu JPG-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
