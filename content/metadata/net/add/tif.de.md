...
############################# Head ############################
head_title: "Fügen Sie Metadaten zu TIF-Dateien in C#-Anwendungen hinzu"
head_description: "C#-Metadatenverarbeitungs-API zum Hinzufügen von Metadateninformationen zu TIF-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw"

############################# Header ############################
title: "Hinzufügen von Metadaten zu TIF in C#" 
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen von Metadaten zu Tif in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) erleichtert .NET-Entwicklern das Hinzufügen von Metadatendetails zu TIF-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
