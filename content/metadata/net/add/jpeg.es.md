...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) facilita a los desarrolladores de .NET agregar detalles de metadatos a archivos JPEG desde sus aplicaciones mediante la implementación de unos sencillos pasos.
