...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/es/metadata/net/) makes it easy for .NET developers to add metadata details to JPEG files from within their applications by implementing a few easy steps.
