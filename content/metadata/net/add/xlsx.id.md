...
############################# Head ############################
head_title: "Tambahkan Metadata ke XLSX File di C# Aplikasi"
head_description: "C# API pemrosesan metadata untuk menambahkan informasi metadata ke file XLSX. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menambahkan Metadata ke XLSX di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file XLSX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
