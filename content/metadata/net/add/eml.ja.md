...
head_title: "C＃.NETアプリケーションのEMLファイルにメタデータを追加する"
head_description: "C＃.NETメタデータ処理APIを使用して、EMLファイルにメタデータ情報を追加します。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "C＃でEMLにメタデータを追加する"
...
steps:
    enable: true
    title_left: "C＃でEMLメタデータを追加する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からEMLファイルにメタデータの詳細を簡単に追加できます。
