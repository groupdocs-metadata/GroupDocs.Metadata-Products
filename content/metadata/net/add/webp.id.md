...
head_title: "Tambahkan Metadata ke WEBP File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menambahkan informasi metadata ke file WEBP. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Menambahkan Metadata ke WEBP di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan WEBP Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file WEBP dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
