...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) дозволяє розробникам .NET легко додавати деталі метаданих до файлів DJVU зі своїх програм, виконавши кілька простих кроків.
