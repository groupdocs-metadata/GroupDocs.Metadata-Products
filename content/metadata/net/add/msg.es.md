...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/es/metadata/net/) makes it easy for .NET developers to add metadata details to MSG files from within their applications by implementing a few easy steps.
