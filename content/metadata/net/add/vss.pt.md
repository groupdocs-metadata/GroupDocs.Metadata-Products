...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) torna mais fácil para os desenvolvedores de .NET adicionar detalhes de metadados a arquivos VSS de dentro de seus aplicativos, implementando algumas etapas fáceis.
