...
steps:
    ...
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) consente agli sviluppatori di .NET di aggiungere facilmente i dettagli dei metadati ai file DICOM dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
