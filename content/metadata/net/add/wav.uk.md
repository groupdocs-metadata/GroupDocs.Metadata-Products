...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) дозволяє розробникам .NET легко додавати деталі метаданих до файлів WAV зі своїх програм, виконавши кілька простих кроків.
