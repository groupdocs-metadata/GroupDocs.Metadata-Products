...
############################# Head ############################
head_title: "Add Metadata to XLS Files in C# Applications"
head_description: "C# metadata processing API to add metadata information to XLS files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc"
...
steps:
    enable: true
    title: "Steps for adding Metadata to Xls in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) makes it easy for .NET developers to add metadata details to XLS files from within their applications by implementing a few easy steps.
