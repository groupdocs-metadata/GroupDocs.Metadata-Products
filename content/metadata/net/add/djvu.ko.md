...
steps:
    enable: true
    title_left: "Steps for adding Metadata to DJVU in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/ko/metadata/net/) makes it easy for .NET developers to add metadata details to DJVU files from within their applications by implementing a few easy steps.
