...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) consente agli sviluppatori di .NET di aggiungere facilmente i dettagli dei metadati ai file MP3 dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
