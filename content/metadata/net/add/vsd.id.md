...
head_title: "Tambahkan Metadata ke VSD File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menambahkan informasi metadata ke file VSD. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Menambahkan Metadata ke VSD di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan VSD Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file VSD dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
