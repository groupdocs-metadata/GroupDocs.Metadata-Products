...
head_title: "C＃.NETアプリケーションのZIPファイルにメタデータを追加する"
head_description: "メタデータ情報をZIPファイルに追加するためのC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "C＃でZIPにメタデータを追加する"
...
steps:
    enable: true
    title_left: "C＃でZIPメタデータを追加する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からメタデータの詳細をZIPファイルに簡単に追加できます。
