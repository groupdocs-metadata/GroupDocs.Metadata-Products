...
steps:
    ...
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file TTC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
