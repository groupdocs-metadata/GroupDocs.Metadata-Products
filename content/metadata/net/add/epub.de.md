...
############################# Head ############################
head_title: "Fügen Sie Metadaten zu EPUB-Dateien in C#-Anwendungen hinzu"
head_description: "C#-Metadatenverarbeitungs-API zum Hinzufügen von Metadateninformationen zu EPUB-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw"

############################# Header ############################
title: "Hinzufügen von Metadaten zu EPUB in C#" 
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen von Metadaten zu Epub in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) erleichtert .NET-Entwicklern das Hinzufügen von Metadatendetails zu EPUB-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
