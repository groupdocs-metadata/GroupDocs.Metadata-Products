...
############################# Head ############################
head_title: "Add Metadata to TTC Files in C# Applications"
head_description: "C# metadata processing API to add metadata information to TTC files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc"
...
steps:
    enable: true
    title: "Steps for adding Metadata to Ttc in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) makes it easy for .NET developers to add metadata details to TTC files from within their applications by implementing a few easy steps.
      
      1. Load the TTC file to be updated.
