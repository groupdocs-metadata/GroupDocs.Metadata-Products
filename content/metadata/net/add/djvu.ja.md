...
head_title: "C＃.NETアプリケーションのDjVuファイルにメタデータを追加する"
head_description: "DjVuファイルにメタデータ情報を追加するためのC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作する."

title: "C＃でDjVuにメタデータを追加する"
...
steps:
    enable: true
    title_left: "C＃でDjVuメタデータを追加する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からDjVuファイルにメタデータの詳細を簡単に追加できます。

        * メタデータクラスのインスタンスを使用してDjVuをロードします。
