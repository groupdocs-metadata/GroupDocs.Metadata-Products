...
############################# Head ############################
head_title: "Tambahkan Metadata ke File DOC di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk menambahkan informasi metadata ke file DOC. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke Doc di C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file DOC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
