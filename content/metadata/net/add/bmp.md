...
############################# Head ############################
head_title: "Add Metadata to BMP Files in C# Applications"
head_description: "C# metadata processing API to add metadata information to BMP files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
