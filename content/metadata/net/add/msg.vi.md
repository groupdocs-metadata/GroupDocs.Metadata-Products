...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) giúp nhà phát triển .NET dễ dàng thêm chi tiết siêu dữ liệu vào tệp MSG từ bên trong ứng dụng của họ bằng cách triển khai một vài bước đơn giản.
