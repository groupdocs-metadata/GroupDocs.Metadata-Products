...
############################# Head ############################
head_title: "Add Metadata to OTC Files in C# .NET Applications"
head_description: "C# .NET metadata processing API to add metadata information to OTC files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adding Metadata To OTC In C#"
...
steps:
    enable: true
    title_left: "Steps for adding Metadata to OTC in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/ko/metadata/net/) makes it easy for .NET developers to add metadata details to OTC files from within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
       Add metadata information to OTC file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
