...
############################# Head ############################
head_title: "Tambahkan Metadata ke File OTC di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke Otc di C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file OTC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
