...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) consente agli sviluppatori di .NET di aggiungere facilmente i dettagli dei metadati ai file VCR dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
