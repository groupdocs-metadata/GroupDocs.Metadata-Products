...
############################# Head ############################
head_title: "Tambahkan Metadata ke PPTX File di C# Aplikasi"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menambahkan Metadata ke PPTX di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file PPTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
