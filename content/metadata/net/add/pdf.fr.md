...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) permet aux développeurs .NET d'ajouter facilement des détails de métadonnées aux fichiers PDF à partir de leurs applications en mettant en œuvre quelques étapes simples.
