...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/zh/metadata/net/) makes it easy for .NET developers to add metadata details to JP2 files from within their applications by implementing a few easy steps.
