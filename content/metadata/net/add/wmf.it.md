...
############################# Head ############################
head_title: "Aggiungi metadati ai file WMF nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per aggiungere informazioni sui metadati ai file WMF. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc"

############################# Header ############################
title: "Aggiunta di metadati a WMF in C#" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a Wmf in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) consente agli sviluppatori di .NET di aggiungere facilmente i dettagli dei metadati ai file WMF dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
