...
head_title: "C＃.NETアプリケーションのOTCファイルにメタデータを追加する"
head_description: "C＃.NETメタデータ処理APIを使用して、メタデータ情報をOTCファイルに追加します。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "C＃でOTCにメタデータを追加する"
