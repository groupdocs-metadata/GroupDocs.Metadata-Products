...
############################# Head ############################
head_title: "Agregar metadatos a archivos VSX en aplicaciones C#"
head_description: "C# API de procesamiento de metadatos para agregar información de metadatos a archivos VSX. Trabajar con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a VSX en C#" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a Vsx en C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) facilita a los desarrolladores de .NET agregar detalles de metadatos a archivos VSX desde sus aplicaciones mediante la implementación de unos sencillos pasos.
