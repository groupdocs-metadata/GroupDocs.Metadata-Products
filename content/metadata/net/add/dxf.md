...
############################# Head ############################
head_title: "Add Metadata to DXF Files in C# Applications"
head_description: "C# metadata processing API to add metadata information to DXF files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
