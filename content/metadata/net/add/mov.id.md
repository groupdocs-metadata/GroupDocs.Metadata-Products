...
head_title: "Tambahkan Metadata ke MOV File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menambahkan informasi metadata ke file MOV. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Menambahkan Metadata ke MOV di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan MOV Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file MOV dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Muat MOV dengan instance kelas Metadata.
        ...
        * Simpan kembali perubahan dalam format MOV.
