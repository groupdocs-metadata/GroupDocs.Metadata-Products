...
head_title: "Tambahkan Metadata ke EPUB File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menambahkan informasi metadata ke file EPUB. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Menambahkan Metadata ke EPUB di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan EPUB Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file EPUB dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
