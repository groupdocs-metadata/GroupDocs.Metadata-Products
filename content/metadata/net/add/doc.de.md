...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) erleichtert .NET-Entwicklern das Hinzufügen von Metadatendetails zu DOC-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
