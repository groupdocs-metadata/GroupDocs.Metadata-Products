...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/metadata/net/) makes it easy for .NET developers to add metadata details to DOTM files from within their applications by implementing a few easy steps.
