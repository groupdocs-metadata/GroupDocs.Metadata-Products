...
############################# Head ############################
head_title: "Agregar metadatos a archivos XLTX en aplicaciones C#"
head_description: "C# API de procesamiento de metadatos para agregar información de metadatos a archivos XLTX. Trabajar con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a XLTX en C#" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a Xltx en C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) facilita a los desarrolladores de .NET agregar detalles de metadatos a archivos XLTX desde sus aplicaciones mediante la implementación de unos sencillos pasos.
