...
head_title: "C＃.NETアプリケーションのXLSファイルにメタデータを追加する"
head_description: "XLSファイルにメタデータ情報を追加するためのC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作する."

title: "C＃でXLSにメタデータを追加する"
...
steps:
    enable: true
    title_left: "C＃でXLSメタデータを追加する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からXLSファイルにメタデータの詳細を簡単に追加できます。
