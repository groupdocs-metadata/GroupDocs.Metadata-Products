...
############################# Head ############################
head_title: "Fügen Sie Metadaten zu TORRENT-Dateien in C#-Anwendungen hinzu"
head_description: "C#-Metadatenverarbeitungs-API zum Hinzufügen von Metadateninformationen zu TORRENT-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw"

############################# Header ############################
title: "Hinzufügen von Metadaten zu TORRENT in C#" 
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen von Metadaten zu Torrent in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) erleichtert .NET-Entwicklern das Hinzufügen von Metadatendetails zu TORRENT-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
