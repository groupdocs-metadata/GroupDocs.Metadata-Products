...
head_title: "Tambahkan Metadata ke JPF File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menambahkan informasi metadata ke file JPF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Menambahkan Metadata ke JPF di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan JPF Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file JPF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Simpan kembali perubahan dalam format JPF.
