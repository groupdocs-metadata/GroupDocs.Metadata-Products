...
head_title: "Tambahkan Metadata ke PPTM File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menambahkan informasi metadata ke file PPTM. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Menambahkan Metadata ke PPTM di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan PPTM Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file PPTM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
