...
############################# Head ############################
head_title: "Adicionar metadados a arquivos EMF em aplicativos C#"
head_description: "API de processamento de metadados C# para adicionar informações de metadados a arquivos EMF. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adicionando metadados a EMF em C#" 
...
steps:
    enable: true
    title: "Etapas para adicionar metadados a Emf em C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) torna mais fácil para os desenvolvedores de .NET adicionar detalhes de metadados a arquivos EMF de dentro de seus aplicativos, implementando algumas etapas fáceis.
