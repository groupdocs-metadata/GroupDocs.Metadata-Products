...
steps:
    ...
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) дозволяє розробникам .NET легко додавати деталі метаданих до файлів EMF зі своїх програм, виконавши кілька простих кроків.
