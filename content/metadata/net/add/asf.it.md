...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) consente agli sviluppatori di .NET di aggiungere facilmente i dettagli dei metadati ai file ASF dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
