...
############################# Head ############################
head_title: "Thêm siêu dữ liệu vào tệp DJVU trong ứng dụng C#"
head_description: "API xử lý siêu dữ liệu C# để thêm thông tin siêu dữ liệu vào tệp DJVU. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Thêm siêu dữ liệu vào DJVU trong C#" 
...
steps:
    enable: true
    title: "Các bước để thêm Siêu dữ liệu vào Djvu trong C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) giúp nhà phát triển .NET dễ dàng thêm chi tiết siêu dữ liệu vào tệp DJVU từ bên trong ứng dụng của họ bằng cách triển khai một vài bước đơn giản.
