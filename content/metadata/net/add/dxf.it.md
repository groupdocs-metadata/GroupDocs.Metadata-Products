...
############################# Head ############################
head_title: "Aggiungi metadati ai file DXF nelle applicazioni C#"
head_description: "API di elaborazione dei metadati C# per aggiungere informazioni sui metadati ai file DXF. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc"

############################# Header ############################
title: "Aggiunta di metadati a DXF in C#" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a Dxf in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) consente agli sviluppatori di .NET di aggiungere facilmente i dettagli dei metadati ai file DXF dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
