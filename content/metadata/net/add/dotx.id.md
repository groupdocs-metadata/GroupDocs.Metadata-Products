...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file DOTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
