...
head_title: "C＃.NETアプリケーションのAVIファイルにメタデータを追加する"
head_description: "メタデータ情報をAVIファイルに追加するためのC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "C＃でAVIにメタデータを追加する"
...
steps:
    enable: true
    title_left: "C＃でAVIメタデータを追加する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からAVIファイルにメタデータの詳細を簡単に追加できます。
