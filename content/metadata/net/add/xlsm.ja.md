...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/ja/metadata/net/) makes it easy for .NET developers to add metadata details to XLSM files from within their applications by implementing a few easy steps.
