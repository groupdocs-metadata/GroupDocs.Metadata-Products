...
head_title: "C＃.NETアプリケーションのVSDファイルにメタデータを追加する"
head_description: "VSDファイルにメタデータ情報を追加するためのC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作する."

title: "C＃でVSDにメタデータを追加する"
...
steps:
    enable: true
    title_left: "C＃でVSDメタデータを追加する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からVSDファイルにメタデータの詳細を簡単に追加できます。
