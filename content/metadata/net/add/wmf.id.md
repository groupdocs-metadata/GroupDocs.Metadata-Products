...
head_title: "Tambahkan Metadata ke WMF File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menambahkan informasi metadata ke file WMF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Menambahkan Metadata ke WMF di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan WMF Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file WMF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
