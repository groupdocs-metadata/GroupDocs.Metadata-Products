...
############################# Head ############################
head_title: "Tambahkan Metadata ke File WMF di Aplikasi C#"
head_description: "C# API pemrosesan metadata untuk menambahkan informasi metadata ke file WMF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke Wmf di C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file WMF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
