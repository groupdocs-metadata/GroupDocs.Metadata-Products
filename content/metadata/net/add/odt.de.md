...
############################# Head ############################
head_title: "Fügen Sie Metadaten zu ODT-Dateien in C#-Anwendungen hinzu"
head_description: "C#-Metadatenverarbeitungs-API zum Hinzufügen von Metadateninformationen zu ODT-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw"

############################# Header ############################
title: "Hinzufügen von Metadaten zu ODT in C#" 
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen von Metadaten zu Odt in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) erleichtert .NET-Entwicklern das Hinzufügen von Metadatendetails zu ODT-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
