...
############################# Head ############################
head_title: "Tambahkan Metadata ke File PDF di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke Pdf di C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file PDF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
