...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/de/metadata/net/) makes it easy for .NET developers to add metadata details to MOV files from within their applications by implementing a few easy steps.
