...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/ru/metadata/net/) makes it easy for .NET developers to add metadata details to VCR files from within their applications by implementing a few easy steps.
