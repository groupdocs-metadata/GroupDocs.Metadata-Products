...
############################# Head ############################
head_title: "Tambahkan Metadata ke File XLTX di Aplikasi C#"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke Xltx di C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file XLTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
