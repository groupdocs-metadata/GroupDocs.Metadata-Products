...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/fr/metadata/net/) makes it easy for .NET developers to add metadata details to XLS files from within their applications by implementing a few easy steps.
