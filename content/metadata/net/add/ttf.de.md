...
############################# Head ############################
head_title: "Fügen Sie Metadaten zu TTF-Dateien in C#-Anwendungen hinzu"
head_description: "C#-Metadatenverarbeitungs-API zum Hinzufügen von Metadateninformationen zu TTF-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw"

############################# Header ############################
title: "Hinzufügen von Metadaten zu TTF in C#" 
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen von Metadaten zu Ttf in C#"
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) erleichtert .NET-Entwicklern das Hinzufügen von Metadatendetails zu TTF-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
