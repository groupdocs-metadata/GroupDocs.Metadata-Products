...
steps:
    ...
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) permet aux développeurs .NET d'ajouter facilement des détails de métadonnées aux fichiers MSG à partir de leurs applications en mettant en œuvre quelques étapes simples.
