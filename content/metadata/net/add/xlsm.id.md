...
############################# Head ############################
head_title: "Tambahkan Metadata ke XLSM File di C# Aplikasi"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menambahkan Metadata ke XLSM di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file XLSM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
