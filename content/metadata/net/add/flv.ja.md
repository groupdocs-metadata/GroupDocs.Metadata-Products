...
head_title: "C＃.NETアプリケーションのFLVファイルにメタデータを追加する"
head_description: "FLVファイルにメタデータ情報を追加するためのC＃.NETメタデータ処理API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "C＃でFLVにメタデータを追加する"
...
steps:
    enable: true
    title_left: "C＃でFLVメタデータを追加する手順"
    content_left: |
        [GroupDocs.Metadata](/metadata/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内からFLVファイルにメタデータの詳細を簡単に追加できます。
