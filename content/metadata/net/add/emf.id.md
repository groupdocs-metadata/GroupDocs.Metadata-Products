...
############################# Head ############################
head_title: "Tambahkan Metadata ke EMF File di C# Aplikasi"
head_description: "C# API pemrosesan metadata untuk menambahkan informasi metadata ke file EMF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menambahkan Metadata ke EMF di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file EMF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
