...
head_title: "Tambahkan Metadata ke EMF File di C# .NET Applications"
head_description: "C# .NET metadata processing API untuk menambahkan informasi metadata ke file EMF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Menambahkan Metadata ke EMF di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan EMF Metadata di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk menambahkan detail metadata ke file EMF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
