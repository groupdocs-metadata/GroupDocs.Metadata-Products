...
steps:
    ...
    content: |
      [GroupDocs.Metadata for .NET](/metadata/net/) erleichtert .NET-Entwicklern das Hinzufügen von Metadatendetails zu DCM-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
