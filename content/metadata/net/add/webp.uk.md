...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/net/) дозволяє розробникам .NET легко додавати деталі метаданих до файлів WEBP зі своїх програм, виконавши кілька простих кроків.
