...
############################# Head ############################
head_title: "Baca & Ekstrak Metadata File MP3 di Aplikasi C#"
head_description: "API manajemen metadata C# lintas platform untuk membaca dan mengekstrak informasi metadata file MP3. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Ekstraksi Metadata MP3 di .NET"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengekstrak untuk membaca dan mengekstrak informasi metadata dari file MP3 dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat MP3 dengan instance kelas .NET.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Ekstrak properti metadata MP3 dengan berbagai kriteria

        // Bangunlah Metadata dengan meneruskan jalur MP3
