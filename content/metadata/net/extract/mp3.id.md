...
head_title: "Baca &amp; Ekstrak Metadata File MP3 di Aplikasi C# .NET"
head_description: "Lintas platform C# .NET metadata manajemen API untuk membaca dan mengekstrak informasi metadata dari file MP3.Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Ekstrak Metadata dari File MP3 di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Ekstraksi Metadata MP3 di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk membaca dan mengekstrak informasi metadata dari file MP3 dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Muat MP3 dengan instance kelas Metadata.
...
demos:
    ...
    content: |
        Ambil informasi metadata file MP3 sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
