...
############################# Head ############################
head_title: "Leggi ed estrai metadati di file DOCM nelle applicazioni C#"
head_description: "API di gestione dei metadati C# multipiattaforma per leggere ed estrarre le informazioni sui metadati dei file DOCM. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Estrai metadati dal file DOCM in C#" 
...
steps:
    enable: true
    title: "Passaggi per l'estrazione dei metadati DOCM in .NET"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) semplifica l'estrazione per gli sviluppatori di .NET, la lettura e l'estrazione delle informazioni sui metadati dai file DOCM dalle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica DOCM con un'istanza della classe .NET.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Estrai le proprietà dei metadati DOCM in base a vari criteri

        // Costruisci Metadata passando il percorso DOCM
