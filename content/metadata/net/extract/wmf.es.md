...
############################# Head ############################
head_title: "Leer y extraer metadatos de archivos WMF en aplicaciones C#"
head_description: "API de administración de metadatos C# multiplataforma para leer y extraer información de metadatos de archivos WMF. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Extraiga metadatos del archivo WMF en C#" 
...
steps:
    enable: true
    title: "Pasos para la extracción de metadatos de WMF en .NET"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET extraer, leer y extraer información de metadatos de archivos WMF desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue WMF con una instancia de la clase .NET.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Extraiga las propiedades de metadatos WMF según varios criterios

        // Construya Metadata pasando la ruta WMF
