...
############################# Head ############################
head_title: "Leer y extraer metadatos de archivos VCF en aplicaciones C#"
head_description: "API de administración de metadatos C# multiplataforma para leer y extraer información de metadatos de archivos VCF. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Extraiga metadatos del archivo VCF en C#" 
...
steps:
    enable: true
    title: "Pasos para la extracción de metadatos de VCF en .NET"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) facilita a los desarrolladores de .NET extraer, leer y extraer información de metadatos de archivos VCF desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue VCF con una instancia de la clase .NET.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Extraiga las propiedades de metadatos VCF según varios criterios

        // Construya Metadata pasando la ruta VCF
