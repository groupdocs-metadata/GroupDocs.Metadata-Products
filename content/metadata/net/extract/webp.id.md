...
############################# Head ############################
head_title: "Baca & Ekstrak Metadata dari WEBP File di C# Aplikasi"
head_description: "API manajemen metadata lintas platform C# untuk membaca dan mengekstrak informasi metadata dari WEBP file. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Ekstrak Metadata Dari File WEBP Di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk WEBP Ekstraksi Metadata di C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/id/metadata/net/) memudahkan pengembang .NET untuk mengekstrak untuk membaca dan mengekstrak informasi metadata dari file WEBP dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
