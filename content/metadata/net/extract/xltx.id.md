...
head_title: "Baca &amp; Ekstrak Metadata File XLTX di Aplikasi C# .NET"
head_description: "Lintas platform C# .NET metadata manajemen API untuk membaca dan mengekstrak informasi metadata dari file XLTX.Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Ekstraksi Metadata XLTX di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk membaca dan mengekstrak informasi metadata dari file XLTX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
