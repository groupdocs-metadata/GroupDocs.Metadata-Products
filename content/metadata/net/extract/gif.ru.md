...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/ru/metadata/net/) makes it easy for .NET developers to extract to read and extract metadata information from GIF files from within their applications by implementing a few easy steps.
