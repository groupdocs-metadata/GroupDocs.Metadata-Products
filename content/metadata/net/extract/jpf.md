...
head_description: "Cross platform C# metadata menagement API to read and extract metadata information of JPF files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
