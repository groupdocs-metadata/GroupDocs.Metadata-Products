...
############################# Head ############################
head_title: "Baca & Ekstrak Metadata File VDX di Aplikasi C#"
head_description: "API manajemen metadata C# lintas platform untuk membaca dan mengekstrak informasi metadata file VDX. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Ekstraksi Metadata VDX di .NET"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengekstrak untuk membaca dan mengekstrak informasi metadata dari file VDX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat VDX dengan instance kelas .NET.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Ekstrak properti metadata VDX dengan berbagai kriteria

        // Bangunlah Metadata dengan meneruskan jalur VDX
