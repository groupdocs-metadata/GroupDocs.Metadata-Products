...
head_title: "Baca &amp; Ekstrak Metadata File DJVU di Aplikasi C# .NET"
head_description: "Lintas platform C# .NET metadata manajemen API untuk membaca dan mengekstrak informasi metadata dari file DJVU.Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Ekstraksi Metadata DJVU di C#"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/net/) memudahkan pengembang .NET untuk membaca dan mengekstrak informasi metadata dari file DJVU dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
        Ambil informasi metadata file DJVU sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
