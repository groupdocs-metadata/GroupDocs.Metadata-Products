...
############################# Head ############################
head_title: "Read & Extract Metadata of ASF Files in C# .NET Applications"
head_description: "Cross platform C# .NET metadata menagement API to read and extract metadata information of ASF files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract Metadata From ASF File In C#"
...
steps:
    enable: true
    title_left: "Steps for ASF Metadata Extraction in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/fr/metadata/net/) makes it easy for .NET developers to extract to read and extract metadata information from ASF files from within their applications by implementing a few easy steps.
        
        * Load the ASF with an instance of Metadata class.
...
demos:
    ...
    content: |
       Retrieve metadata information of ASF file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
