...
head_description: "Cross platform C# metadata menagement API to read and extract metadata information of VCR files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for .NET](/metadata/net/) makes it easy for .NET developers to extract to read and extract metadata information from VCR files from within their applications by implementing a few easy steps.
