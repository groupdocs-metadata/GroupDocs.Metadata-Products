...
############################# Head ############################
head_title: "Read & Extract Metadata of ODS Files in C# .NET Applications"
head_description: "Cross platform C# .NET metadata menagement API to read and extract metadata information of ODS files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract Metadata From ODS File In C#"
...
steps:
    enable: true
    title_left: "Steps for ODS Metadata Extraction in C#"
    content_left: |
        [GroupDocs.Metadata for .NET](/ko/metadata/net/) makes it easy for .NET developers to extract to read and extract metadata information from ODS files from within their applications by implementing a few easy steps.
