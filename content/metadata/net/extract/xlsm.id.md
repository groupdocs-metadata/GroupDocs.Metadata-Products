...
############################# Head ############################
head_title: "Baca & Ekstrak Metadata File XLSM di Aplikasi C#"
head_description: "API manajemen metadata C# lintas platform untuk membaca dan mengekstrak informasi metadata file XLSM. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Ekstraksi Metadata XLSM di .NET"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net/) memudahkan pengembang .NET mengekstrak untuk membaca dan mengekstrak informasi metadata dari file XLSM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat XLSM dengan instance kelas .NET.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Ekstrak properti metadata XLSM dengan berbagai kriteria

        // Bangunlah Metadata dengan meneruskan jalur XLSM
