...
############################# Head ############################
head_title: "Tambahkan Metadata ke POTM File di Java Aplikasi"
head_description: "Java API pemrosesan metadata untuk menambahkan informasi metadata ke file POTM. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Menambahkan Metadata Ke POTM Di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk menambahkan detail metadata ke file POTM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Simpan perubahan kembali dalam format POTM.
...
demos:
    ...
    content: |
       Tambahkan informasi metadata ke file POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata Demo Langsung](https://products.groupdocs.app/metadata/family).
