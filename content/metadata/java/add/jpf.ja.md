...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/ja/metadata/java/) makes it easy for Java developers to add metadata details to JPF files from within their applications by implementing a few easy steps.
