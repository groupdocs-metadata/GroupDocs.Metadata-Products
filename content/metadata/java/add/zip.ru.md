...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) позволяет разработчикам Java легко добавлять детали метаданных в файлы ZIP из своих приложений, выполнив несколько простых шагов.
