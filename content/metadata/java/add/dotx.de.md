...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/de/metadata/java/) makes it easy for Java developers to add metadata details to DOTX files from within their applications by implementing a few easy steps.
