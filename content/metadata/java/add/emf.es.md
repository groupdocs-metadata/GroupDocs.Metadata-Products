...
############################# Head ############################
head_title: "Agregar metadatos a archivos EMF en aplicaciones Java"
head_description: "Java API de procesamiento de metadatos para agregar información de metadatos a archivos EMF. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a EMF en Java" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a EMF en Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) facilita a los desarrolladores de Java agregar detalles de metadatos a archivos EMF desde sus aplicaciones mediante la implementación de unos sencillos pasos.
