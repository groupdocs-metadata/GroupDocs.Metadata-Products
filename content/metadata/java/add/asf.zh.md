...
############################# Head ############################
head_title: "将元数据添加到 Java 应用程序中的 ASF 文件"
head_description: "Java 元数据处理 API，用于将元数据信息添加到 ASF 文件。使用元数据标准 XMP、EXIF、IPTC、ID3 等。"

############################# Header ############################
title: "将元数据添加到 Java 中的 ASF" 
...
steps:
    enable: true
    title: "将元数据添加到 Java 中的 ASF 的步骤"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) 使 Java 开发人员可以通过执行几个简单的步骤，轻松地从其应用程序内向 ASF 文件添加元数据详细信息。
