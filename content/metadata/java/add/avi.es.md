...
############################# Head ############################
head_title: "Agregar metadatos a archivos AVI en aplicaciones Java"
head_description: "Java API de procesamiento de metadatos para agregar información de metadatos a archivos AVI. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a AVI en Java" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a AVI en Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) facilita a los desarrolladores de Java agregar detalles de metadatos a archivos AVI desde sus aplicaciones mediante la implementación de unos sencillos pasos.
