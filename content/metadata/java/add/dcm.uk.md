...
steps:
    ...
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) дозволяє розробникам Java легко додавати деталі метаданих до файлів DCM зі своїх програм, виконавши кілька простих кроків.
