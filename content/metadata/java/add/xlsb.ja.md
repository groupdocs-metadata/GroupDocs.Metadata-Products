...
############################# Head ############################
head_title: "Java アプリケーションの XLSB ファイルにメタデータを追加する"
head_description: "Java メタデータ処理 API を使用して、メタデータ情報を XLSB ファイルに追加します。メタデータ標準 XMP、EXIF、IPTC、ID3 などを使用します。"

############################# Header ############################
title: "Java の XLSB にメタデータを追加する" 
...
steps:
    enable: true
    title: "Java の XLSB にメタデータを追加する手順"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) を使用すると、Java の開発者は、いくつかの簡単な手順を実装することで、アプリケーション内から XLSB ファイルにメタデータの詳細を簡単に追加できます。
