...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/ru/metadata/java/) makes it easy for Java developers to add metadata details to VSX files from within their applications by implementing a few easy steps.
