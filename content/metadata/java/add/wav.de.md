...
steps:
    ...
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) erleichtert Java-Entwicklern das Hinzufügen von Metadatendetails zu WAV-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
