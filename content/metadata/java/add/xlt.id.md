...
############################# Head ############################
head_title: "Tambahkan Metadata ke File XLT di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke XLT di Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) memudahkan pengembang Java untuk menambahkan detail metadata ke file XLT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
