...
steps:
    ...
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) позволяет разработчикам Java легко добавлять детали метаданных в файлы AVI из своих приложений, выполнив несколько простых шагов.
