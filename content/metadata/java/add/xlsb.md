...
############################# Head ############################
head_title: "Add Metadata Properties to XLSB Files in Java"
head_description: "Cross platform Java metadata API to view and add metadata fields to XLSB files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Add Metadata to XLSB in Java"
description: "Add metadata properties to XLSB and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to add metadata fields to XLSB files from within their applications by implementing a few easy steps.
