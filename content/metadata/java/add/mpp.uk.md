...
############################# Head ############################
head_title: "Додайте метадані до файлів MPP у програмах Java"
head_description: "API обробки метаданих Java для додавання інформації метаданих до файлів MPP. Робота зі стандартами метаданих XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Додавання метаданих до MPP у Java" 
...
steps:
    enable: true
    title: "Кроки для додавання метаданих до MPP у Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) дозволяє розробникам Java легко додавати деталі метаданих до файлів MPP зі своїх програм, виконавши кілька простих кроків.
