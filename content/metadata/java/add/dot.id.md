...
head_title: "Tambahkan Properti Metadata ke DOT File di Java"
head_description: "Lintas platform Java metadata API untuk melihat dan menambahkan bidang metadata ke file DOT. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Tambahkan Metadata ke DOT di Java"
description: "Tambahkan properti metadata ke DOT dan banyak dokumen, gambar, dan format file multimedia populer lainnya menggunakan GroupDocs.Metadata for Java API."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menambahkan Metadata ke DOT di Java"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/java/) memudahkan pengembang Java untuk menambahkan bidang metadata ke file DOT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Muat file DOT yang akan diperbarui.
...
demos:
    ...
    content: |
        Tambahkan informasi metadata ke file DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
