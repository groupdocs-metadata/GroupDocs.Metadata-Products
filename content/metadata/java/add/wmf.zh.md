...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/zh/metadata/java/) makes it easy for Java developers to add metadata details to WMF files from within their applications by implementing a few easy steps.
