...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) memudahkan pengembang Java untuk menambahkan detail metadata ke file WMF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
