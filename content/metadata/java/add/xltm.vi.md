...
############################# Head ############################
head_title: "Thêm siêu dữ liệu vào tệp XLTM trong ứng dụng Java"
head_description: "API xử lý siêu dữ liệu Java để thêm thông tin siêu dữ liệu vào tệp XLTM. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Thêm siêu dữ liệu vào XLTM trong Java" 
...
steps:
    enable: true
    title: "Các bước để thêm Siêu dữ liệu vào XLTM trong Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) giúp nhà phát triển Java dễ dàng thêm chi tiết siêu dữ liệu vào tệp XLTM từ bên trong ứng dụng của họ bằng cách triển khai một vài bước đơn giản.
