...
############################# Head ############################
head_title: "Добавить метаданные в файлы BMP в приложениях Java"
head_description: "API обработки метаданных Java для добавления информации метаданных в файлы BMP. Работа со стандартами метаданных XMP, EXIF, IPTC, ID3 и др."
...
steps:
    enable: true
    title: "Шаги по добавлению метаданных в BMP в Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) позволяет разработчикам Java легко добавлять детали метаданных в файлы BMP из своих приложений, выполнив несколько простых шагов.
