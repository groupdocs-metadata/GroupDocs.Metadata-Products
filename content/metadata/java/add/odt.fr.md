...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/fr/metadata/java/) makes it easy for Java developers to add metadata details to ODT files from within their applications by implementing a few easy steps.
