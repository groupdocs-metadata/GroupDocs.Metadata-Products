...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) torna mais fácil para os desenvolvedores de Java adicionar detalhes de metadados a arquivos ODT de dentro de seus aplicativos, implementando algumas etapas fáceis.
