...
############################# Head ############################
head_title: "Agregar metadatos a archivos DOTX en aplicaciones Java"
head_description: "Java API de procesamiento de metadatos para agregar información de metadatos a archivos DOTX. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a DOTX en Java" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a DOTX en Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) facilita a los desarrolladores de Java agregar detalles de metadatos a archivos DOTX desde sus aplicaciones mediante la implementación de unos sencillos pasos.
