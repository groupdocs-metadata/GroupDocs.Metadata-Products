...
############################# Head ############################
head_title: "Add Metadata to POTX Files in Java Java Applications"
head_description: "Java Java metadata processing API to add metadata information to POTX files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adding Metadata To POTX In Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/fr/metadata/java/) makes it easy for Java developers to add metadata details to POTX files from within their applications by implementing a few easy steps.
