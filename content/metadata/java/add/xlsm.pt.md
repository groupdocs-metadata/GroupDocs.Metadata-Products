...
############################# Head ############################
head_title: "Adicionar metadados a arquivos XLSM em aplicativos Java"
head_description: "API de processamento de metadados Java para adicionar informações de metadados a arquivos XLSM. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adicionando metadados a XLSM em Java" 
...
steps:
    enable: true
    title: "Etapas para adicionar metadados a XLSM em Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) torna mais fácil para os desenvolvedores de Java adicionar detalhes de metadados a arquivos XLSM de dentro de seus aplicativos, implementando algumas etapas fáceis.
