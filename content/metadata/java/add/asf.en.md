...
############################# Head ############################
head_title: "Add Metadata to ASF Files in Java Applications"
head_description: "Java metadata processing API to add metadata information to ASF files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adding Metadata To ASF In Java" 
...
steps:
    enable: true
    title: "Steps for adding Metadata to ASF in Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) makes it easy for Java developers to add metadata details to ASF files from within their applications by implementing a few easy steps.
