...
############################# Head ############################
head_title: "Fügen Sie Metadaten zu OTF-Dateien in Java-Anwendungen hinzu"
head_description: "Java-Metadatenverarbeitungs-API zum Hinzufügen von Metadateninformationen zu OTF-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Hinzufügen von Metadaten zu OTF in Java" 
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen von Metadaten zu OTF in Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) erleichtert Java-Entwicklern das Hinzufügen von Metadatendetails zu OTF-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
