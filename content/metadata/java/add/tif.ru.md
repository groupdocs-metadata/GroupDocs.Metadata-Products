...
############################# Head ############################
head_title: "Добавить метаданные в файлы TIF в приложениях Java"
head_description: "API обработки метаданных Java для добавления информации метаданных в файлы TIF. Работа со стандартами метаданных XMP, EXIF, IPTC, ID3 и др."
...
steps:
    enable: true
    title: "Шаги по добавлению метаданных в TIF в Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) позволяет разработчикам Java легко добавлять детали метаданных в файлы TIF из своих приложений, выполнив несколько простых шагов.
