...
############################# Head ############################
head_title: "Add Metadata to VSD Files in Java Java Applications"
head_description: "Java Java metadata processing API to add metadata information to VSD files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adding Metadata To VSD In Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/fr/metadata/java/) makes it easy for Java developers to add metadata details to VSD files from within their applications by implementing a few easy steps.
