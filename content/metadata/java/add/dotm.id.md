...
############################# Head ############################
head_title: "Tambahkan Metadata ke File DOTM di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke DOTM di Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) memudahkan pengembang Java untuk menambahkan detail metadata ke file DOTM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
