...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) makes it easy for Java developers to add metadata details to HEIC files from within their applications by implementing a few easy steps.
