...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) permet aux développeurs Java d'ajouter facilement des détails de métadonnées aux fichiers DOTX à partir de leurs applications en mettant en œuvre quelques étapes simples.
