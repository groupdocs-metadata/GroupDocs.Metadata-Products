...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) memudahkan pengembang Java untuk menambahkan detail metadata ke file GIF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
