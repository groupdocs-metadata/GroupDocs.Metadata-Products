...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) consente agli sviluppatori di Java di aggiungere facilmente i dettagli dei metadati ai file VSD dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
