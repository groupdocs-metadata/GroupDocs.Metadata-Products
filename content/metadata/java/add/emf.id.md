...
############################# Head ############################
head_title: "Tambahkan Metadata ke File EMF di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke EMF di Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) memudahkan pengembang Java untuk menambahkan detail metadata ke file EMF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
