...
steps:
    ...
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) memudahkan pengembang Java untuk menambahkan detail metadata ke file XLS dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
