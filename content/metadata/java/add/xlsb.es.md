...
steps:
    ...
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) facilita a los desarrolladores de Java agregar detalles de metadatos a archivos XLSB desde sus aplicaciones mediante la implementación de unos sencillos pasos.
