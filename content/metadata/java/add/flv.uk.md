...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) дозволяє розробникам Java легко додавати деталі метаданих до файлів FLV зі своїх програм, виконавши кілька простих кроків.
