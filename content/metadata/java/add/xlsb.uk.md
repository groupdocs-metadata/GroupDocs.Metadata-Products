...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) дозволяє розробникам Java легко додавати деталі метаданих до файлів XLSB зі своїх програм, виконавши кілька простих кроків.
