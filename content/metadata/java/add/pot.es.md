...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) facilita a los desarrolladores de Java agregar detalles de metadatos a archivos POT desde sus aplicaciones mediante la implementación de unos sencillos pasos.
