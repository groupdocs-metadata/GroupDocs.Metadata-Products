...
############################# Head ############################
head_title: "Fügen Sie Metadaten zu MPP-Dateien in Java-Anwendungen hinzu"
head_description: "Java-Metadatenverarbeitungs-API zum Hinzufügen von Metadateninformationen zu MPP-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Hinzufügen von Metadaten zu MPP in Java" 
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen von Metadaten zu MPP in Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) erleichtert Java-Entwicklern das Hinzufügen von Metadatendetails zu MPP-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
