...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) позволяет разработчикам Java легко добавлять детали метаданных в файлы VCR из своих приложений, выполнив несколько простых шагов.
