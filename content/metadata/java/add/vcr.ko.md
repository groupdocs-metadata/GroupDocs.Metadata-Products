...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/ko/metadata/java/) makes it easy for Java developers to add metadata details to VCR files from within their applications by implementing a few easy steps.
