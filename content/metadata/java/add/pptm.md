...
############################# Head ############################
head_title: "Add Metadata Properties to PPTM Files in Java"
head_description: "Cross platform Java metadata API to view and add metadata fields to PPTM files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Add Metadata to PPTM in Java"
description: "Add metadata properties to PPTM and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to add metadata fields to PPTM files from within their applications by implementing a few easy steps.
