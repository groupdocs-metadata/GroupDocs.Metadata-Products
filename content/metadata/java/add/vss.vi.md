...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/java/) giúp nhà phát triển Java dễ dàng thêm chi tiết siêu dữ liệu vào tệp VSS từ bên trong ứng dụng của họ bằng cách triển khai một vài bước đơn giản.
