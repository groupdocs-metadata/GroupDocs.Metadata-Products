...
############################# Head ############################
head_title: "Aggiungi metadati ai file VCF nelle applicazioni Java"
head_description: "API di elaborazione dei metadati Java per aggiungere informazioni sui metadati ai file VCF. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a VCF in Java" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a VCF in Java"
    content: |
      [GroupDocs.Metadata for Java](/metadata/java/) consente agli sviluppatori di Java di aggiungere facilmente i dettagli dei metadati ai file VCF dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
