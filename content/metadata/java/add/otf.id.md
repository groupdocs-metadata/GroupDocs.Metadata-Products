...
head_title: "Tambahkan Properti Metadata ke OTF File di Java"
head_description: "Lintas platform Java metadata API untuk melihat dan menambahkan bidang metadata ke file OTF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Tambahkan Metadata ke OTF di Java"
description: "Tambahkan properti metadata ke OTF dan banyak dokumen, gambar, dan format file multimedia populer lainnya menggunakan GroupDocs.Metadata for Java API."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menambahkan Metadata ke OTF di Java"
    content_left: |
        [GroupDocs.Metadata](/id/metadata/java/) memudahkan pengembang Java untuk menambahkan bidang metadata ke file OTF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Muat file OTF yang akan diperbarui.
...
demos:
    ...
    content: |
        Tambahkan informasi metadata ke file OTF sekarang juga dengan mengunjungi situs web [GroupDocs.Metadata](https://products.groupdocs.app/metadata/family).  
