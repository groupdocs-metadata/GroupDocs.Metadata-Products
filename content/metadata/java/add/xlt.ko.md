...
############################# Head ############################
head_title: "Add Metadata to XLT Files in Java Java Applications"
head_description: "Java Java metadata processing API to add metadata information to XLT files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adding Metadata To XLT In Java"
...
steps:
    enable: true
    title_left: "Steps for adding Metadata to XLT in Java"
    content_left: |
        [GroupDocs.Metadata for Java](/ko/metadata/java/) makes it easy for Java developers to add metadata details to XLT files from within their applications by implementing a few easy steps.
