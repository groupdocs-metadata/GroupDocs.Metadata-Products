...
############################# Head ############################
head_title: "Metadateneigenschaften von XLSM-Dateien in Java entfernen"
head_description: "Plattformübergreifende Java-Metadaten-API zum Ausblenden und Entfernen von Metadatenfeldern von XLSM-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "XLSM-Metadaten in Java entfernen" 
description: "Entfernen Sie Metadateneigenschaften aus XLSM und vielen anderen gängigen Dokumenten-, Bild- und Multimediadateiformaten mithilfe der GroupDocs.Metadata for Java-API"
...
steps:
    enable: true
    title: "Schritte zum Entfernen von Metadaten in XLSM in Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) erleichtert Java-Entwicklern das Löschen von Metadateninformationen aus XLSM-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
      
      1. Laden Sie die zu aktualisierende Datei XLSM.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Löschen Sie die Metadaten des Dokuments XLSM
