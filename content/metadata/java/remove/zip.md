...
steps:
    enable: true
    title_left: "Steps for Removing ZIP Metadata in Java"
    content_left: |
        [GroupDocs.Metadata](/metadata/java/) makes it easy for Java developers to delete metadata information from ZIP files from within their applications by implementing a few easy steps.
