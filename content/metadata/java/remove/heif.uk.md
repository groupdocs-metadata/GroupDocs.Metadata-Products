...
############################# Head ############################
head_title: "Видалити властивості метаданих файлів HEIF у Java"
head_description: "Міжплатформний API метаданих Java для приховання та видалення полів метаданих файлів HEIF. Робота зі стандартами метаданих XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Видалити метадані HEIF у Java" 
description: "Видаліть властивості метаданих із HEIF та багатьох інших популярних документів, зображень і мультимедійних форматів файлів за допомогою API GroupDocs.Metadata for Java"
...
steps:
    enable: true
    title: "Кроки для видалення метаданих у HEIF у Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) дозволяє розробникам Java легко видаляти інформацію метаданих із файлів HEIF у своїх програмах, реалізувавши кілька простих кроків.
