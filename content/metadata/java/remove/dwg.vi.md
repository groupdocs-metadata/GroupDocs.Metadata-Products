...
############################# Head ############################
head_title: "Xóa thuộc tính siêu dữ liệu của tệp DWG trong Java"
head_description: "API siêu dữ liệu Java đa nền tảng để ẩn và xóa các trường siêu dữ liệu của tệp DWG. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Xóa siêu dữ liệu DWG trong Java" 
description: "Xóa thuộc tính siêu dữ liệu khỏi DWG và nhiều định dạng tài liệu, hình ảnh và tệp đa phương tiện phổ biến khác bằng API GroupDocs.Metadata for Java"
...
steps:
    enable: true
    title: "Các bước để xóa siêu dữ liệu sang DWG trong Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) giúp nhà phát triển Java dễ dàng xóa thông tin siêu dữ liệu khỏi tệp DWG khỏi ứng dụng của họ bằng cách thực hiện một vài bước đơn giản.
      
      1. Tải tệp DWG cần cập nhật.
