...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/ko/metadata/java/) makes it easy for Java developers to delete metadata information from BMP files from within their applications by implementing a few easy steps.
