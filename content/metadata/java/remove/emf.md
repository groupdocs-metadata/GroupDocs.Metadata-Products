...
steps:
    enable: true
    title_left: "Steps for Removing EMF Metadata in Java"
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to delete metadata information from EMF files from within their applications by implementing a few easy steps.
