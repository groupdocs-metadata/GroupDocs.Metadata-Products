...
############################# Head ############################
head_title: "ลบคุณสมบัติข้อมูลเมตาของไฟล์ PPSX ใน Java"
head_description: "API ข้อมูลเมตาข้ามแพลตฟอร์ม Java เพื่อซ่อนและลบช่องข้อมูลเมตาของไฟล์ PPSX ทำงานร่วมกับมาตรฐานข้อมูลเมตา XMP, EXIF, IPTC, ID3 ฯลฯ"

############################# Header ############################
title: "ลบข้อมูลเมตา PPSX ใน Java" 
description: "ลบคุณสมบัติข้อมูลเมตาออกจาก PPSX และเอกสาร รูปภาพ และรูปแบบไฟล์มัลติมีเดียยอดนิยมอื่นๆ อีกมากมายโดยใช้ API GroupDocs.Metadata for Java"
...
steps:
    enable: true
    title: "ขั้นตอนในการลบข้อมูลเมตาไปยัง PPSX ใน Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) ช่วยให้นักพัฒนา Java ลบข้อมูลเมตาดาต้าจากไฟล์ PPSX จากภายในแอปพลิเคชันของตนได้อย่างง่ายดายโดยทำตามขั้นตอนง่ายๆ เพียงไม่กี่ขั้นตอน
      
      1. โหลดไฟล์ PPSX ที่จะอัปเดต
