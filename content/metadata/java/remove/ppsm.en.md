...
steps:
    enable: true
    title: "Steps for Removing Metadata to PPSM in Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) makes it easy for Java developers to delete metadata information from PPSM files from within their applications by implementing a few easy steps.
