...
############################# Head ############################
head_title: "Rimuovi le proprietà dei metadati dei file MP3 in Java"
head_description: "API di metadati Java multipiattaforma per nascondere e rimuovere i campi di metadati dei file MP3. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Rimuovi i metadati MP3 in Java" 
description: "Rimuovi le proprietà dei metadati da MP3 e molti altri formati di documenti, immagini e file multimediali più diffusi utilizzando l'API GroupDocs.Metadata for Java"
...
steps:
    enable: true
    title: "Passaggi per rimuovere i metadati in MP3 in Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) consente agli sviluppatori di Java di eliminare facilmente le informazioni sui metadati dai file MP3 dalle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica il file MP3 da aggiornare.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Cancella i metadati del documento MP3
