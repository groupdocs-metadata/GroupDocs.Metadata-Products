...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/fr/metadata/java/) makes it easy for Java developers to delete metadata information from PSD files from within their applications by implementing a few easy steps.
