...
############################# Head ############################
head_title: "Remover propriedades de metadados de arquivos MPP em Java"
head_description: "API de metadados Java de plataforma cruzada para ocultar e remover campos de metadados de arquivos MPP. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Remover metadados MPP em Java" 
description: "Remova propriedades de metadados de MPP e muitos outros documentos populares, imagens e formatos de arquivos multimídia usando a API GroupDocs.Metadata for Java"
...
steps:
    enable: true
    title: "Etapas para remover metadados de MPP em Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java excluir informações de metadados de arquivos MPP de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o arquivo MPP a ser atualizado.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Limpar metadados do documento MPP
