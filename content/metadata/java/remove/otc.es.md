...
############################# Head ############################
head_title: "Remove Metadata Properties of OTC Files in Java"
head_description: "Cross platform Java metadata API to hide and remove metadata fields of OTC files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc. "

############################# Header ############################
title: "Remove OTC Metadata In Java"
description: "Remove metadata properties from OTC and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    enable: true
    title_left: "Steps for Removing  Metadata to OTC in Java"
    content_left: |
        [GroupDocs.Metadata for Java](/es/metadata/java/) makes it easy for Java developers to delete metadata information from OTC files from within their applications by implementing a few easy steps.
        
        * Load the OTC file to be updated.
...
demos:
    ...
    content: |
       Remove metadata information of OTC file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
