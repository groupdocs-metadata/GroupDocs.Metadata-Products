...
############################# Head ############################
head_title: "Eliminar propiedades de metadatos de archivos PPTX en Java"
head_description: "API de metadatos Java multiplataforma para ocultar y eliminar campos de metadatos de archivos PPTX. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Eliminar metadatos de PPTX en Java" 
description: "Elimine las propiedades de metadatos de PPTX y muchos otros documentos, imágenes y formatos de archivos multimedia populares utilizando la API GroupDocs.Metadata for Java"
...
steps:
    enable: true
    title: "Pasos para eliminar metadatos de PPTX en Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) facilita a los desarrolladores de Java eliminar información de metadatos de archivos PPTX desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue el archivo PPTX para actualizarlo.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Borrar metadatos del documento PPTX
