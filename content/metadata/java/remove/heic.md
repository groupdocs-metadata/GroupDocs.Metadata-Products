...
steps:
    enable: true
    title_left: "Steps for Removing HEIC Metadata in Java"
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to delete metadata information from HEIC files from within their applications by implementing a few easy steps.
