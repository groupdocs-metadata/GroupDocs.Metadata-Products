...
############################# Head ############################
head_title: "Remover propriedades de metadados de arquivos MP3 em Java"
head_description: "API de metadados Java de plataforma cruzada para ocultar e remover campos de metadados de arquivos MP3. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Remover metadados MP3 em Java" 
description: "Remova propriedades de metadados de MP3 e muitos outros documentos populares, imagens e formatos de arquivos multimídia usando a API GroupDocs.Metadata for Java"
...
steps:
    enable: true
    title: "Etapas para remover metadados de MP3 em Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java excluir informações de metadados de arquivos MP3 de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o arquivo MP3 a ser atualizado.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Limpar metadados do documento MP3
