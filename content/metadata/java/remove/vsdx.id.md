...
############################# Head ############################
head_title: "Hapus Properti Metadata dari VSDX File di Java"
head_description: "API metadata lintas platform Java untuk menyembunyikan dan menghapus bidang metadata dari VSDX file. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll. "

############################# Header ############################
title: "Hapus VSDX Metadata Dalam Java"
description: "Hapus properti metadata dari VSDX dan banyak dokumen populer lainnya, gambar, dan format file multimedia menggunakan GroupDocs.Metadata for Java API."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus Metadata ke VSDX di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk menghapus informasi metadata dari file VSDX dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        
        * Muat file VSDX yang akan diperbarui.
...
demos:
    ...
    content: |
       Hapus informasi metadata dari file VSDX sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
