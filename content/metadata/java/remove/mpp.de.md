...
steps:
    enable: true
    title_left: "Steps for Removing  Metadata to MPP in Java"
    content_left: |
        [GroupDocs.Metadata for Java](/de/metadata/java/) makes it easy for Java developers to delete metadata information from MPP files from within their applications by implementing a few easy steps.
