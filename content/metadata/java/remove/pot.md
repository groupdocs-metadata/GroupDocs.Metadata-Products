...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](/metadata/java/) makes it easy for Java developers to delete metadata information from POT files from within their applications by implementing a few easy steps.
