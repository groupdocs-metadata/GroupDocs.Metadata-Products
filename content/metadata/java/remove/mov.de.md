...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/de/metadata/java/) makes it easy for Java developers to delete metadata information from MOV files from within their applications by implementing a few easy steps.
