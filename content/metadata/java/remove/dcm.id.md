...
############################# Head ############################
head_title: "Hapus Properti Metadata dari File DCM di Java"
head_description: "API metadata Java lintas platform untuk menyembunyikan dan menghapus bidang metadata file DCM. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Hapus Metadata DCM di Java" 
description: "Hapus properti metadata dari DCM dan banyak format file dokumen, gambar, dan multimedia populer lainnya menggunakan API GroupDocs.Metadata for Java"
...
steps:
    enable: true
    title: "Langkah-langkah Menghapus Metadata ke DCM di Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java menghapus informasi metadata dari file DCM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
