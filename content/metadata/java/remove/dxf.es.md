...
############################# Head ############################
head_title: "Remove Metadata Properties of DXF Files in Java"
head_description: "Cross platform Java metadata API to hide and remove metadata fields of DXF files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc. "

############################# Header ############################
title: "Remove DXF Metadata In Java"
description: "Remove metadata properties from DXF and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    enable: true
    title_left: "Steps for Removing  Metadata to DXF in Java"
    content_left: |
        [GroupDocs.Metadata for Java](/es/metadata/java/) makes it easy for Java developers to delete metadata information from DXF files from within their applications by implementing a few easy steps.
        
        * Load the DXF file to be updated.
...
demos:
    ...
    content: |
       Remove metadata information of DXF file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
