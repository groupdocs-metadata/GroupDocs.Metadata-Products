...
head_title: "表示＆amp; JavaアプリケーションでDXFファイルのメタデータを抽出する"
head_description: "DXFファイルのメタデータ情報を読み取って抽出するクロスプラットフォームのJavaメタデータ抽出API。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "JavaでDXFメタデータを抽出する"
