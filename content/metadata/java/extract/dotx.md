...
############################# Head ############################
head_title: "View &amp; Extract Metadata of DOTX Files in Java Applications"
head_description: "Cross platform Java metadata extraction API to read and extract metadata information of DOTX files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract DOTX Metadata in Java"
...
steps:
    ...
    content_left: |
        ...
        *   Load the DOTX file to be searched for metadata properties.
