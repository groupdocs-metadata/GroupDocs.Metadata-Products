...
head_title: "表示＆amp; JavaアプリケーションでXLSBファイルのメタデータを抽出する"
head_description: "クロスプラットフォームのJavaメタデータ抽出APIを使用して、XLSBファイルのメタデータ情報を読み取り、抽出します。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "JavaでXLSBメタデータを抽出する"
...
steps:
    ...
    content_left: |
        ...
        *メタデータプロパティを検索するXLSBファイルをロードします。
