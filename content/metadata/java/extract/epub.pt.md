...
############################# Head ############################
head_title: "Leia e extraia metadados de arquivos EPUB em aplicativos Java"
head_description: "API de gerenciamento de metadados Java de plataforma cruzada para ler e extrair informações de metadados de arquivos EPUB. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extraia metadados do arquivo EPUB em Java" 
...
steps:
    enable: true
    title: "Etapas para extração de metadados EPUB em Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java extrair, ler e extrair informações de metadados de arquivos EPUB de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o EPUB com uma instância da classe Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Pesquise metadados de imagem no documento EPUB

        // Componha Metadata passando EPUB para o construtor
