...
steps:
    enable: true
    title: "Vcf Watermarks Search via Java"
    content: |
      **[GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/)** simplifies the process of locating watermarks within business documents. Install our package into your Java applications to take advantage of its benefits.
      ...
      1. To utilize our library features, load the Vcf file into an instance of the {{TextWatermarkerBold}} class. You can provide a file path, file stream, or byte stream.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Search image watermarks in VCF document

        // Compose {{TextWatermarker}} passing VCF document
