...
############################# Head ############################
head_title: "Чтение и извлечение метаданных файлов MPT в приложениях Java"
head_description: "Межплатформенный API управления метаданными Java для чтения и извлечения информации метаданных из файлов MPT. Работа со стандартами метаданных XMP, EXIF, IPTC, ID3 и др."

############################# Header ############################
title: "Извлечь метаданные из файла MPT в Java" 
...
steps:
    enable: true
    title: "Шаги по извлечению метаданных MPT в Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) позволяет разработчикам Java легко извлекать и читать метаданные из файлов MPT из своих приложений, выполнив несколько простых шагов.
      
      1. Загрузите MPT с экземпляром класса Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Поиск метаданных изображения в документе MPT

        // Составьте Metadata, передав MPT в конструктор.
