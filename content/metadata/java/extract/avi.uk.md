...
############################# Head ############################
head_title: "Читати та видобувати метадані файлів AVI у програмах Java"
head_description: "Міжплатформний API керування метаданими Java для читання та вилучення метаданих файлів AVI. Робота зі стандартами метаданих XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Видобути метадані з файлу AVI у Java" 
...
steps:
    enable: true
    title: "Кроки для вилучення метаданих AVI у Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) спрощує розробникам Java видобувати для читання та видобувати інформацію метаданих із файлів AVI у своїх програмах, виконавши кілька простих кроків.
      
      1. Завантажте AVI з екземпляром класу Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Пошук метаданих зображення в документі AVI
