...
############################# Head ############################
head_title: "View &amp; Extract Metadata of ODT Files in Java Applications"
head_description: "Cross platform Java metadata extraction API to read and extract metadata information of ODT files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract ODT Metadata in Java"
...
steps:
    ...
    content_left: |
        ...
        *   Load the ODT file to be searched for metadata properties.
