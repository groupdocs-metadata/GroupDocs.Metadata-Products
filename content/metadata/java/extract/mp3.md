...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/metadata/java/) makes it easy for Java developers to extract to read and extract metadata information from MP3 files from within their applications by implementing a few easy steps.
