...
head_title: "表示＆amp; JavaアプリケーションでXLTMファイルのメタデータを抽出する"
head_description: "クロスプラットフォームのJavaメタデータ抽出APIを使用して、XLTMファイルのメタデータ情報を読み取り、抽出します。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "JavaでXLTMメタデータを抽出する"
...
steps:
    ...
    content_left: |
        ...
        *メタデータプロパティを検索するXLTMファイルをロードします。
