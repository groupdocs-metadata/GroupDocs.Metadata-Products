...
head_title: "Lihat &amp; Ekstrak Metadata File TIFF di Aplikasi Java"
head_description: "API ekstraksi metadata Java lintas platform untuk membaca dan mengekstrak informasi metadata dari file TIFF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Ekstrak TIFF Metadata di Jawa"
...
steps:
    ...
    content_left: |
        ...
        * Muat file TIFF yang akan dicari properti metadatanya.
