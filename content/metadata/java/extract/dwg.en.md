...
head_description: "Cross platform Java metadata management API to read and extract metadata information of DWG files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for DWG Metadata Extraction in Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) makes it easy for Java developers to extract to read and extract metadata information from DWG files from within their applications by implementing a few easy steps.
      
      1. Load the DWG with an instance of Java class.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Search image metadata in DWG document

        // Compose Metadata passing DWG to constructor
