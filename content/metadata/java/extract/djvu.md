...
############################# Head ############################
head_title: "View &amp; Extract Metadata of DJVU Files in Java Applications"
head_description: "Cross platform Java metadata extraction API to read and extract metadata information of DJVU files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract DJVU Metadata in Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](/metadata/java/) makes it easy for Java developers to get metadata information from DJVU files from within their applications by implementing a few easy steps.

        *   Load the DJVU file to be searched for metadata properties.
