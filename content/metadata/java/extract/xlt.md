...
############################# Head ############################
head_title: "View &amp; Extract Metadata of XLT Files in Java Applications"
head_description: "Cross platform Java metadata extraction API to read and extract metadata information of XLT files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract XLT Metadata in Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](/metadata/java/) makes it easy for Java developers to get metadata information from XLT files from within their applications by implementing a few easy steps.

        *   Load the XLT file to be searched for metadata properties.
