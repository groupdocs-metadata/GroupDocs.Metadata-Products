...
############################# Head ############################
head_title: "Read & Extract Metadata of MP3 Files in Java Java Applications"
head_description: "Cross platform Java Java metadata menagement API to read and extract metadata information of MP3 files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract Metadata From MP3 File In Java"
...
steps:
    enable: true
    title_left: "Steps for MP3 Metadata Extraction in Java"
    content_left: |
        [GroupDocs.Metadata for Java](/es/metadata/java/) makes it easy for Java developers to extract to read and extract metadata information from MP3 files from within their applications by implementing a few easy steps.
        
        * Load the MP3 with an instance of Metadata class.
...
demos:
    ...
    content: |
       Retrieve metadata information of MP3 file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.
