...
draft: false
############################# Head ############################
head_title: "Посмотреть и усилить Извлечение метаданных файлов ONE в приложениях Java"
head_description: "Кроссплатформенный API извлечения метаданных Java для чтения и извлечения метаданных из файлов ONE. Работа со стандартами метаданных XMP, EXIF, IPTC, ID3 и т. д."
############################# Header ############################
title: "Извлечь ОДНУ метаданные в Java"
...
steps:
    ...
    content_left: |
        ...
        * Загрузите ОДИН файл для поиска свойств метаданных.
