...
head_title: "Lihat &amp; Ekstrak Metadata File EML di Aplikasi Java"
head_description: "API ekstraksi metadata Java lintas platform untuk membaca dan mengekstrak informasi metadata dari file EML. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Ekstrak EML Metadata di Jawa"
...
steps:
    ...
    content_left: |
        ...
        * Muat file EML yang akan dicari properti metadatanya.
