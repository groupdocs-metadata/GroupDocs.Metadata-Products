...
head_title: "Lihat &amp; Ekstrak Metadata File VCR di Aplikasi Java"
head_description: "API ekstraksi metadata Java lintas platform untuk membaca dan mengekstrak informasi metadata dari file VCR. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Ekstrak VCR Metadata di Jawa"
...
steps:
    ...
    content_left: |
        ...
        * Muat file VCR yang akan dicari properti metadatanya.
