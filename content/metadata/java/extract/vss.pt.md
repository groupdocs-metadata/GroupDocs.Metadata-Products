...
############################# Head ############################
head_title: "Leia e extraia metadados de arquivos VSS em aplicativos Java"
head_description: "API de gerenciamento de metadados Java de plataforma cruzada para ler e extrair informações de metadados de arquivos VSS. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extraia metadados do arquivo VSS em Java" 
...
steps:
    enable: true
    title: "Etapas para extração de metadados VSS em Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java extrair, ler e extrair informações de metadados de arquivos VSS de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o VSS com uma instância da classe Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Pesquise metadados de imagem no documento VSS

        // Componha Metadata passando VSS para o construtor
