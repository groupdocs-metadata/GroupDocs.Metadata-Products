...
head_title: "Lihat &amp; Ekstrak Metadata File VSS di Aplikasi Java"
head_description: "API ekstraksi metadata Java lintas platform untuk membaca dan mengekstrak informasi metadata dari file VSS. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Ekstrak VSS Metadata di Jawa"
...
steps:
    ...
    content_left: |
        ...
        * Muat file VSS yang akan dicari properti metadatanya.
