...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/ja/metadata/java/) makes it easy for Java developers to extract to read and extract metadata information from DICOM files from within their applications by implementing a few easy steps.
