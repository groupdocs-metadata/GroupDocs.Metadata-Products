...
head_title: "表示＆amp; JavaアプリケーションでDICOMファイルのメタデータを抽出する"
head_description: "クロスプラットフォームのJavaメタデータ抽出APIを使用して、DICOMファイルのメタデータ情報を読み取って抽出します。メタデータ標準XMP、EXIF、IPTC、ID3などを操作します。"

title: "JavaでDICOMメタデータを抽出する"
...
steps:
    ...
    content_left: |
        ...
        *メタデータプロパティを検索するDICOMファイルをロードします。
