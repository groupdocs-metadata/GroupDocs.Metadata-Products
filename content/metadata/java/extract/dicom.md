...
############################# Head ############################
head_title: "View &amp; Extract Metadata of DICOM Files in Java Applications"
head_description: "Cross platform Java metadata extraction API to read and extract metadata information of DICOM files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract DICOM Metadata in Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to get metadata information from DICOM files from within their applications by implementing a few easy steps.

        *   Load the DICOM file to be searched for metadata properties.
