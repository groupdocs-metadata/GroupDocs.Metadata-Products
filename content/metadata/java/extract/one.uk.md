...
############################# Head ############################
head_title: "Читати та видобувати метадані файлів ONE у програмах Java"
head_description: "Міжплатформний API керування метаданими Java для читання та вилучення метаданих файлів ONE. Робота зі стандартами метаданих XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Видобути метадані з файлу ONE у Java" 
...
steps:
    enable: true
    title: "Кроки для вилучення метаданих ONE у Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) спрощує розробникам Java видобувати для читання та видобувати інформацію метаданих із файлів ONE у своїх програмах, виконавши кілька простих кроків.
      
      1. Завантажте ONE з екземпляром класу Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Пошук метаданих зображення в документі ONE

        // Створіть Metadata, передавши ONE у конструктор
