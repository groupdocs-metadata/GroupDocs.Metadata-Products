...
############################# Head ############################
head_title: "View &amp; Extract Metadata of MOV Files in Java Applications"
head_description: "Cross platform Java metadata extraction API to read and extract metadata information of MOV files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract MOV Metadata in Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](/metadata/java/) makes it easy for Java developers to get metadata information from MOV files from within their applications by implementing a few easy steps.

        *   Load the MOV file to be searched for metadata properties.
