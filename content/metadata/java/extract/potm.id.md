...
############################# Head ############################
head_title: "Baca & Ekstrak Metadata dari POTM File di Java Aplikasi"
head_description: "API manajemen metadata lintas platform Java untuk membaca dan mengekstrak informasi metadata dari POTM file. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Ekstrak Metadata Dari File POTM Di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk POTM Ekstraksi Metadata di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk mengekstrak untuk membaca dan mengekstrak informasi metadata dari file POTM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        
        * Muat POTM dengan instance kelas Metadata.
...
demos:
    ...
    content: |
       Ambil informasi metadata file POTM sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
