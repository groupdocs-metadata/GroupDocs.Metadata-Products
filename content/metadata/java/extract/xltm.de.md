...
############################# Head ############################
head_title: "Lesen und extrahieren Sie Metadaten von XLTM-Dateien in Java-Anwendungen"
head_description: "Plattformübergreifende Java-Metadatenverwaltungs-API zum Lesen und Extrahieren von Metadateninformationen von XLTM-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten aus der Datei XLTM in Java extrahieren" 
...
steps:
    enable: true
    title: "Schritte für die XLTM-Metadatenextraktion in Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) erleichtert Java-Entwicklern das Extrahieren, Lesen und Extrahieren von Metadateninformationen aus XLTM-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
      
      1. Laden Sie XLTM mit einer Instanz der Klasse Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Durchsuchen Sie Bildmetadaten im XLTM-Dokument

        // Verfassen Sie Metadata und übergeben Sie XLTM an den Konstruktor
