...
############################# Head ############################
head_title: "Baca & Ekstrak Metadata File DWG di Aplikasi Java"
head_description: "API pengelolaan metadata Java lintas platform untuk membaca dan mengekstrak informasi metadata file DWG. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Ekstraksi Metadata DWG di Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengekstrak untuk membaca dan mengekstrak informasi metadata dari file DWG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat DWG dengan instance kelas Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Telusuri metadata gambar dalam dokumen DWG

        // Tulis Metadata dengan meneruskan DWG ke konstruktor
