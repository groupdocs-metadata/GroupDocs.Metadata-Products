...
############################# Head ############################
head_title: "Read & Extract Metadata of MPP Files in Java Java Applications"
head_description: "Cross platform Java Java metadata menagement API to read and extract metadata information of MPP files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Extract Metadata From MPP File In Java"
...
steps:
    enable: true
    title_left: "Steps for MPP Metadata Extraction in Java"
    content_left: |
        [GroupDocs.Metadata for Java](/es/metadata/java/) makes it easy for Java developers to extract to read and extract metadata information from MPP files from within their applications by implementing a few easy steps.
