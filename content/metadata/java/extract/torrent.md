...
head_description: "Cross platform Java metadata menagement API to read and extract metadata information of TORRENT files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
