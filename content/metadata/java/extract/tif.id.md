...
############################# Head ############################
head_title: "Baca & Ekstrak Metadata File TIF di Aplikasi Java"
head_description: "API pengelolaan metadata Java lintas platform untuk membaca dan mengekstrak informasi metadata file TIF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."
...
steps:
    enable: true
    title: "Langkah-langkah Ekstraksi Metadata TIF di Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengekstrak untuk membaca dan mengekstrak informasi metadata dari file TIF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat TIF dengan instance kelas Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Telusuri metadata gambar dalam dokumen TIF

        // Tulis Metadata dengan meneruskan TIF ke konstruktor
