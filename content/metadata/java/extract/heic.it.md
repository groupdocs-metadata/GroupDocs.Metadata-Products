...
############################# Head ############################
head_title: "Leggi ed estrai metadati di file HEIC nelle applicazioni Java"
head_description: "API di gestione dei metadati Java multipiattaforma per leggere ed estrarre le informazioni sui metadati dei file HEIC. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Estrai metadati dal file HEIC in Java" 
...
steps:
    enable: true
    title: "Passaggi per l'estrazione dei metadati HEIC in Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) semplifica l'estrazione per gli sviluppatori di Java, la lettura e l'estrazione delle informazioni sui metadati dai file HEIC dalle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica HEIC con un'istanza della classe Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Cerca i metadati dell'immagine nel documento HEIC

        // Componi Metadata passando HEIC al costruttore
