...
############################# Head ############################
head_title: "Lesen und extrahieren Sie Metadaten von MPT-Dateien in Java-Anwendungen"
head_description: "Plattformübergreifende Java-Metadatenverwaltungs-API zum Lesen und Extrahieren von Metadateninformationen von MPT-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten aus der Datei MPT in Java extrahieren" 
...
steps:
    enable: true
    title: "Schritte für die MPT-Metadatenextraktion in Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) erleichtert Java-Entwicklern das Extrahieren, Lesen und Extrahieren von Metadateninformationen aus MPT-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
      
      1. Laden Sie MPT mit einer Instanz der Klasse Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Durchsuchen Sie Bildmetadaten im MPT-Dokument

        // Verfassen Sie Metadata und übergeben Sie MPT an den Konstruktor
