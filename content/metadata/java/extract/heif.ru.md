...
############################# Head ############################
head_title: "Чтение и извлечение метаданных файлов HEIF в приложениях Java"
head_description: "Межплатформенный API управления метаданными Java для чтения и извлечения информации метаданных из файлов HEIF. Работа со стандартами метаданных XMP, EXIF, IPTC, ID3 и др."

############################# Header ############################
title: "Извлечь метаданные из файла HEIF в Java" 
...
steps:
    enable: true
    title: "Шаги по извлечению метаданных HEIF в Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java/) позволяет разработчикам Java легко извлекать и читать метаданные из файлов HEIF из своих приложений, выполнив несколько простых шагов.
      
      1. Загрузите HEIF с экземпляром класса Java.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Поиск метаданных изображения в документе HEIF

        // Составьте Metadata, передав HEIF в конструктор.
