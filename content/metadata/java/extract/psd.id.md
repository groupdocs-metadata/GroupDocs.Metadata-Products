...
head_title: "Lihat &amp; Ekstrak Metadata File PSD di Aplikasi Java"
head_description: "API ekstraksi metadata Java lintas platform untuk membaca dan mengekstrak informasi metadata dari file PSD. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

title: "Ekstrak PSD Metadata di Jawa"
...
steps:
    ...
    content_left: |
        ...
        * Muat file PSD yang akan dicari properti metadatanya.
