...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/fr/metadata/java/) makes it easy for Java developers to edit metadata details to VSX files from within their applications by implementing a few easy steps.
