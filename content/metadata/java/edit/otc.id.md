...
############################# Head ############################
head_title: "Edit Metadata ke File OTC di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke Otc di Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengedit detail metadata ke file Otc dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat file Otc yang akan diperbarui
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit metadata tanggal pembuatan OTC
...
more_features:
  enable: true
  title: "Memanipulasi Metadata OTC untuk Aplikasi Java"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Fitur Asli OTC"
