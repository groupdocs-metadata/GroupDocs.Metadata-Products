...
############################# Head ############################
head_title: "Edit Metadata ke File DOC di Aplikasi Java"
head_description: "Java API pemrosesan metadata untuk mengedit informasi metadata ke file DOC. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Perbarui Metadata Dari File Doc Di Java" 
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke Doc di Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengedit detail metadata ke file Doc dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit metadata tanggal pembuatan DOC
...
more_features:
  enable: true
  title: "Memanipulasi Metadata DOC untuk Aplikasi Java"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Fitur Asli DOC"
