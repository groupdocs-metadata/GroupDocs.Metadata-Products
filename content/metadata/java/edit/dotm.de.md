...
############################# Head ############################
head_title: "Bearbeiten Sie Metadaten in DOTM-Dateien in Java-Anwendungen"
head_description: "Java-Metadatenverarbeitungs-API zum Bearbeiten von Metadateninformationen in DOTM-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten aus der Datei Dotm in Java aktualisieren" 
...
steps:
    enable: true
    title: "Schritte zum Aktualisieren von Metadaten auf Dotm in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) erleichtert Java-Entwicklern das Bearbeiten von Metadatendetails zu Dotm-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Bearbeiten Sie die Metadaten zum Erstellungsdatum von DOTM
...
more_features:
  enable: true
  title: "Manipulieren Sie DOTM-Metadaten für Java-Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Nutzung nativer DOTM-Funktionen"
