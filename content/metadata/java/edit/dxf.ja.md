...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/ja/metadata/java/) makes it easy for Java developers to edit metadata details to DXF files from within their applications by implementing a few easy steps.
