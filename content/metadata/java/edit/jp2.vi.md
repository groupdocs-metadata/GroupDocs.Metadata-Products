...
############################# Head ############################
head_title: "Chỉnh sửa siêu dữ liệu thành tệp JP2 trong ứng dụng Java"
head_description: "API xử lý siêu dữ liệu Java để chỉnh sửa thông tin siêu dữ liệu thành tệp JP2. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Cập nhật siêu dữ liệu từ tệp Jp2 trong Java" 
...
steps:
    enable: true
    title: "Các bước để cập nhật siêu dữ liệu lên Jp2 trong Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) giúp nhà phát triển Java dễ dàng chỉnh sửa chi tiết siêu dữ liệu cho các tệp Jp2 từ trong ứng dụng của họ bằng cách thực hiện một vài bước đơn giản.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Chỉnh sửa siêu dữ liệu ngày tạo JP2
...
more_features:
  enable: true
  title: "Thao tác siêu dữ liệu JP2 cho ứng dụng Java"
  ...
  features:
    ...
    # feature loop
    - title: "Sử dụng các tính năng gốc của JP2"
