...
############################# Head ############################
head_title: "Edit Metadata ke File PPSX di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke Ppsx di Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengedit detail metadata ke file Ppsx dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit metadata tanggal pembuatan PPSX
...
more_features:
  enable: true
  title: "Memanipulasi Metadata PPSX untuk Aplikasi Java"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Fitur Asli PPSX"
