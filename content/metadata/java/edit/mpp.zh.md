...
############################# Head ############################
head_title: "在 Java 应用程序中编辑元数据到 MPP 文件"
head_description: "Java 元数据处理 API，用于编辑 MPP 文件的元数据信息。使用元数据标准 XMP、EXIF、IPTC、ID3 等。"

############################# Header ############################
title: "更新 Java 中的 Mpp 文件的元数据" 
...
steps:
    enable: true
    title: "将元数据更新为 Java 中的 Mpp 的步骤"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) 使 Java 开发人员可以通过执行几个简单的步骤，轻松地从其应用程序内编辑 Mpp 文件的元数据详细信息。
