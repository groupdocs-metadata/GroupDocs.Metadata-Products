...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers PPTM dans les applications Java"
head_description: "API de traitement des métadonnées Java pour modifier les informations de métadonnées dans les fichiers PPTM. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Mettre à jour les métadonnées du fichier Pptm dans Java" 
...
steps:
    enable: true
    title: "Étapes de mise à jour des métadonnées vers Pptm dans Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) permet aux développeurs Java de modifier facilement les détails des métadonnées dans les fichiers Pptm à partir de leurs applications en mettant en œuvre quelques étapes simples.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Modifier les métadonnées de la date de création de PPTM
...
more_features:
  enable: true
  title: "Manipuler les métadonnées PPTM pour les applications Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisation des fonctionnalités natives PPTM"
