...
############################# Head ############################
head_title: "Edite metadados para arquivos OTC em aplicativos Java"
head_description: "API de processamento de metadados Java para editar informações de metadados em arquivos OTC. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Otc em Java" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para Otc em Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java editar detalhes de metadados em arquivos Otc de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue o arquivo Otc a ser atualizado
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Editar metadados da data de criação de OTC
...
more_features:
  enable: true
  title: "Manipular metadados OTC para aplicativos Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizando recursos nativos OTC"
