...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata for Java](/es/metadata/java/) makes it easy for Java developers to edit metadata details to TIF files from within their applications by implementing a few easy steps.
