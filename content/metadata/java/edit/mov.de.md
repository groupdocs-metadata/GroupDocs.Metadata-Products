...
############################# Head ############################
head_title: "Edit Metadata to MOV Files in Java Java Applications"
head_description: "Java Java metadata processing API to edit metadata information to MOV files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title_left: "Steps for Updating Metadata to MOV in Java"
    content_left: |
        [GroupDocs.Metadata for Java](/de/metadata/java/) makes it easy for Java developers to edit metadata details to MOV files from within their applications by implementing a few easy steps.
