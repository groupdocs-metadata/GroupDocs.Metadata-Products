...
############################# Head ############################
head_title: "Chỉnh sửa siêu dữ liệu thành tệp FLV trong ứng dụng Java"
head_description: "API xử lý siêu dữ liệu Java để chỉnh sửa thông tin siêu dữ liệu thành tệp FLV. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Cập nhật siêu dữ liệu từ tệp Flv trong Java" 
...
steps:
    enable: true
    title: "Các bước để cập nhật siêu dữ liệu lên Flv trong Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) giúp nhà phát triển Java dễ dàng chỉnh sửa chi tiết siêu dữ liệu cho các tệp Flv từ trong ứng dụng của họ bằng cách thực hiện một vài bước đơn giản.
      
      1. Tải tệp Flv cần cập nhật
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Chỉnh sửa siêu dữ liệu ngày tạo FLV
...
more_features:
  enable: true
  title: "Thao tác siêu dữ liệu FLV cho ứng dụng Java"
  ...
  features:
    ...
    # feature loop
    - title: "Sử dụng các tính năng gốc của FLV"
