...
############################# Head ############################
head_title: "Bearbeiten Sie Metadaten in EML-Dateien in Java-Anwendungen"
head_description: "Java-Metadatenverarbeitungs-API zum Bearbeiten von Metadateninformationen in EML-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Metadaten aus der Datei Eml in Java aktualisieren" 
...
steps:
    enable: true
    title: "Schritte zum Aktualisieren von Metadaten auf Eml in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) erleichtert Java-Entwicklern das Bearbeiten von Metadatendetails zu Eml-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Bearbeiten Sie die Metadaten zum Erstellungsdatum von EML
...
more_features:
  enable: true
  title: "Manipulieren Sie EML-Metadaten für Java-Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Nutzung nativer EML-Funktionen"
