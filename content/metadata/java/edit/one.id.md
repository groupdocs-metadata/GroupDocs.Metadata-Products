...
############################# Head ############################
head_title: "Edit Metadata ke ONE File di Java Aplikasi"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke ONE di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk mengedit detail metadata ke file ONE dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
