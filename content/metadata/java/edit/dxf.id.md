...
############################# Head ############################
head_title: "Edit Metadata ke DXF File di Java Aplikasi"
head_description: "Java API pemrosesan metadata untuk mengedit informasi metadata ke file DXF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Perbarui Metadata Dari File DXF Di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke DXF di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk mengedit detail metadata ke file DXF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
       Perbarui informasi metadata ke file DXF sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
