...
############################# Head ############################
head_title: "Edit Metadata ke ODS File di Java Aplikasi"
head_description: "Java API pemrosesan metadata untuk mengedit informasi metadata ke file ODS. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Perbarui Metadata Dari File ODS Di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke ODS di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk mengedit detail metadata ke file ODS dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
