...
############################# Head ############################
head_title: "Edit Metadata ke POT File di Java Aplikasi"
head_description: "Java API pemrosesan metadata untuk mengedit informasi metadata ke file POT. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Perbarui Metadata Dari File POT Di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke POT di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk mengedit detail metadata ke file POT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
