...
############################# Head ############################
head_title: "Editar metadatos en archivos OTC en aplicaciones Java"
head_description: "API de procesamiento de metadatos Java para editar información de metadatos en archivos OTC. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Actualizar metadatos del archivo Otc en Java" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos a Otc en Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) facilita a los desarrolladores de Java editar detalles de metadatos en archivos Otc desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue el archivo Otc para actualizarlo
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Editar metadatos de la fecha de creación de OTC
...
more_features:
  enable: true
  title: "Manipular metadatos OTC para aplicaciones Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizando funciones nativas OTC"
