...
steps:
    enable: true
    title: "Steps for Updating Metadata to Otc in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) makes it easy for Java developers to edit metadata details to Otc files from within their applications by implementing a few easy steps.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit OTC creation date metadata
...
more_features:
  enable: true
  title: "Manipulate OTC Metadata for Java Apps"
