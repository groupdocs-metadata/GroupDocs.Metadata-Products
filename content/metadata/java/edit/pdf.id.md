...
############################# Head ############################
head_title: "Edit Metadata ke File PDF di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke Pdf di Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengedit detail metadata ke file Pdf dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit metadata tanggal pembuatan PDF
...
more_features:
  enable: true
  title: "Memanipulasi Metadata PDF untuk Aplikasi Java"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Fitur Asli PDF"
