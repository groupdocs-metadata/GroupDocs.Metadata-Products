...
steps:
    enable: true
    title: "Steps for Updating Metadata to Eml in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) makes it easy for Java developers to edit metadata details to Eml files from within their applications by implementing a few easy steps.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit EML creation date metadata
...
more_features:
  enable: true
  title: "Manipulate EML Metadata for Java Apps"
