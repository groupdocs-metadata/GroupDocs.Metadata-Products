...
############################# Head ############################
head_title: "Modifica i metadati nei file DOCX nelle applicazioni Java"
head_description: "API di elaborazione dei metadati Java per modificare le informazioni sui metadati nei file DOCX. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiorna metadati dal file Docx in Java" 
...
steps:
    enable: true
    title: "Passaggi per l'aggiornamento dei metadati su Docx in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) consente agli sviluppatori di Java di modificare facilmente i dettagli dei metadati nei file Docx dalle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica il file Docx da aggiornare
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Modifica i metadati della data di creazione di DOCX
...
more_features:
  enable: true
  title: "Manipola i metadati di DOCX per le app di Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizzo delle funzionalità native di DOCX"
