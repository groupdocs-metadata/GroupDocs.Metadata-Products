...
head_title: "Editor Metadata Java - Perbarui Metadata File TTF di Java"
head_description: "API editor metadata Java lintas platform untuk mengedit dan memperbarui bidang metadata file TTF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3, dll.."

title: "Perbarui Metadata dari File TTF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah Ekstraksi Metadata TTF di Java"
    content_left: |
