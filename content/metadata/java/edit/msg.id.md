...
############################# Head ############################
head_title: "Edit Metadata ke File MSG di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke Msg di Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengedit detail metadata ke file Msg dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit metadata tanggal pembuatan MSG
...
more_features:
  enable: true
  title: "Memanipulasi Metadata MSG untuk Aplikasi Java"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Fitur Asli MSG"
