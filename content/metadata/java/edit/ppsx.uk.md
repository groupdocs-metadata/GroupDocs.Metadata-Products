...
############################# Head ############################
head_title: "Редагувати метадані файлів PPSX у програмах Java"
head_description: "API обробки метаданих Java для редагування інформації метаданих у файлах PPSX. Робота зі стандартами метаданих XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Оновити метадані з файлу Ppsx у Java" 
...
steps:
    enable: true
    title: "Кроки для оновлення метаданих до Ppsx у Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) полегшує розробникам Java редагування деталей метаданих файлів Ppsx у своїх програмах, реалізувавши кілька простих кроків.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Відредагуйте метадані дати створення PPSX
...
more_features:
  enable: true
  title: "Маніпулювати метаданими PPSX для програм Java"
  ...
  features:
    ...
    # feature loop
    - title: "Використання власних функцій PPSX"
