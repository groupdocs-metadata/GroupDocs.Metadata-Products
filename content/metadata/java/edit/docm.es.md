...
############################# Head ############################
head_title: "Editar metadatos en archivos DOCM en aplicaciones Java"
head_description: "API de procesamiento de metadatos Java para editar información de metadatos en archivos DOCM. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Actualizar metadatos del archivo Docm en Java" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos a Docm en Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) facilita a los desarrolladores de Java editar detalles de metadatos en archivos Docm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Editar metadatos de la fecha de creación de DOCM
...
more_features:
  enable: true
  title: "Manipular metadatos DOCM para aplicaciones Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizando funciones nativas DOCM"
