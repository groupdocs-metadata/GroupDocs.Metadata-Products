...
############################# Head ############################
head_title: "Modifier les métadonnées dans les fichiers MPT dans les applications Java"
head_description: "API de traitement des métadonnées Java pour modifier les informations de métadonnées dans les fichiers MPT. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Mettre à jour les métadonnées du fichier Mpt dans Java" 
...
steps:
    enable: true
    title: "Étapes de mise à jour des métadonnées vers Mpt dans Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) permet aux développeurs Java de modifier facilement les détails des métadonnées dans les fichiers Mpt à partir de leurs applications en mettant en œuvre quelques étapes simples.
...
more_features:
  enable: true
  title: "Manipuler les métadonnées MPT pour les applications Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilisation des fonctionnalités natives MPT"
