...
############################# Head ############################
head_title: "แก้ไขข้อมูลเมตาเป็นไฟล์ XLTM ในแอปพลิเคชัน Java"
head_description: "API การประมวลผลข้อมูลเมตา Java เพื่อแก้ไขข้อมูลเมตาดาต้าเป็นไฟล์ XLTM ทำงานร่วมกับมาตรฐานข้อมูลเมตา XMP, EXIF, IPTC, ID3 ฯลฯ"

############################# Header ############################
title: "อัปเดตข้อมูลเมตาจากไฟล์ Xltm ใน Java" 
...
steps:
    enable: true
    title: "ขั้นตอนในการอัปเดตข้อมูลเมตาเป็น Xltm ใน Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) ทำให้นักพัฒนา Java แก้ไขรายละเอียดข้อมูลเมตาเป็นไฟล์ Xltm จากภายในแอปพลิเคชันได้อย่างง่ายดายโดยทำตามขั้นตอนง่ายๆ เพียงไม่กี่ขั้นตอน
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // แก้ไขข้อมูลเมตาวันที่สร้าง XLTM
...
more_features:
  enable: true
  title: "จัดการข้อมูลเมตา XLTM สำหรับแอป Java"
  ...
  features:
    ...
    # feature loop
    - title: "การใช้คุณลักษณะดั้งเดิมของ XLTM"
