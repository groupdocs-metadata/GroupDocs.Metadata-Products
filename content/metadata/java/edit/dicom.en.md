...
steps:
    enable: true
    title: "Steps for Updating Metadata to Dicom in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) makes it easy for Java developers to edit metadata details to Dicom files from within their applications by implementing a few easy steps.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit DICOM creation date metadata
...
more_features:
  enable: true
  title: "Manipulate DICOM Metadata for Java Apps"
