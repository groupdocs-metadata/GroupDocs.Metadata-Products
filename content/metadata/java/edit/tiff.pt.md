...
############################# Head ############################
head_title: "Edite metadados para arquivos TIFF em aplicativos Java"
head_description: "API de processamento de metadados Java para editar informações de metadados em arquivos TIFF. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Tiff em Java" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para Tiff em Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java editar detalhes de metadados em arquivos Tiff de dentro de seus aplicativos, implementando algumas etapas fáceis.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Editar metadados da data de criação de TIFF
...
more_features:
  enable: true
  title: "Manipular metadados TIFF para aplicativos Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizando recursos nativos TIFF"
