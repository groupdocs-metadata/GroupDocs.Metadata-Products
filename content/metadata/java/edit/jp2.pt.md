...
############################# Head ############################
head_title: "Edite metadados para arquivos JP2 em aplicativos Java"
head_description: "API de processamento de metadados Java para editar informações de metadados em arquivos JP2. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Jp2 em Java" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para Jp2 em Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java editar detalhes de metadados em arquivos Jp2 de dentro de seus aplicativos, implementando algumas etapas fáceis.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Editar metadados da data de criação de JP2
...
more_features:
  enable: true
  title: "Manipular metadados JP2 para aplicativos Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizando recursos nativos JP2"
