...
############################# Head ############################
head_title: "Edit Metadata ke TORRENT File di Java Aplikasi"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke TORRENT di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk mengedit detail metadata ke file TORRENT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
