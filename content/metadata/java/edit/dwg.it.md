...
############################# Head ############################
head_title: "Modifica i metadati nei file DWG nelle applicazioni Java"
head_description: "API di elaborazione dei metadati Java per modificare le informazioni sui metadati nei file DWG. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiorna metadati dal file Dwg in Java" 
...
steps:
    enable: true
    title: "Passaggi per l'aggiornamento dei metadati su Dwg in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) consente agli sviluppatori di Java di modificare facilmente i dettagli dei metadati nei file Dwg dalle loro applicazioni implementando alcuni semplici passaggi.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Modifica i metadati della data di creazione di DWG
...
more_features:
  enable: true
  title: "Manipola i metadati di DWG per le app di Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizzo delle funzionalità native di DWG"
