...
############################# Head ############################
head_title: "Edit Metadata ke XLS File di Java Aplikasi"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke XLS di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk mengedit detail metadata ke file XLS dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
       Perbarui informasi metadata ke file XLS sekarang dengan mengunjungi situs web [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family).
