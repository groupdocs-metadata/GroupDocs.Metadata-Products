...
############################# Head ############################
head_title: "Java アプリケーションの VCF ファイルへのメタデータの編集"
head_description: "Java メタデータ処理APIを使用してメタデータ情報を VCF ファイルに編集します。メタデータ規格 XMP、EXIF、IPTC、ID3 などと連携してください。"

############################# Header ############################
title: "Java 内の VCF ファイルからメタデータを更新"
...
steps:
    enable: true
    title_left: "Java のメタデータを VCF に更新する手順"
    content_left: |
        [GroupDocs.Metadata for Java](/ja/metadata/java/) を使用すると、Java 開発者は、いくつかの簡単な手順を実行することで、アプリケーション内からメタデータの詳細を VCF ファイルに簡単に編集できます。
        
        * 更新する VCF ファイルをロードしてください
