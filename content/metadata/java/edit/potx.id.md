...
############################# Head ############################
head_title: "Edit Metadata ke File POTX di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke Potx di Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengedit detail metadata ke file Potx dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit metadata tanggal pembuatan POTX
...
more_features:
  enable: true
  title: "Memanipulasi Metadata POTX untuk Aplikasi Java"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Fitur Asli POTX"
