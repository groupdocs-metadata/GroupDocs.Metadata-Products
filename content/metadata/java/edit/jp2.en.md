...
############################# Head ############################
head_title: "Edit Metadata to JP2 Files in Java Applications"
head_description: "Java metadata processing API to edit metadata information to JP2 files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to Jp2 in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) makes it easy for Java developers to edit metadata details to Jp2 files from within their applications by implementing a few easy steps.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit JP2 creation date metadata
...
more_features:
  enable: true
  title: "Manipulate JP2 Metadata for Java Apps"
