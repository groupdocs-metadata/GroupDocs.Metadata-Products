...
############################# Head ############################
head_title: "Editar metadatos en archivos POTX en aplicaciones Java"
head_description: "API de procesamiento de metadatos Java para editar información de metadatos en archivos POTX. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Actualizar metadatos del archivo Potx en Java" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos a Potx en Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) facilita a los desarrolladores de Java editar detalles de metadatos en archivos Potx desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue el archivo Potx para actualizarlo
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Editar metadatos de la fecha de creación de POTX
...
more_features:
  enable: true
  title: "Manipular metadatos POTX para aplicaciones Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizando funciones nativas POTX"
