...
############################# Head ############################
head_title: "Edit Metadata to MP3 Files in Java Applications"
head_description: "Java metadata processing API to edit metadata information to MP3 files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to Mp3 in Java"
    content: |
      **[GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/)** makes it easy for Java developers to edit metadata details to Mp3 files from within their applications by implementing a few easy steps.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit MP3 creation date metadata
...
more_features:
  enable: true
  title: "Manipulate MP3 Metadata for Java Apps"
