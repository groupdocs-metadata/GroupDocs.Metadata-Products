...
############################# Head ############################
head_title: "Edit Metadata to MPT Files in Java Applications"
head_description: "Java metadata processing API to edit metadata information to MPT files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to Mpt in Java"
    content: |
      **[GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/)** makes it easy for Java developers to edit metadata details to Mpt files from within their applications by implementing a few easy steps.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit MPT creation date metadata
...
more_features:
  enable: true
  title: "Manipulate MPT Metadata for Java Apps"
