...
############################# Head ############################
head_title: "Edit Metadata ke File MP3 di Aplikasi Java"
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata ke Mp3 di Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) memudahkan pengembang Java mengedit detail metadata ke file Mp3 dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit metadata tanggal pembuatan MP3
...
more_features:
  enable: true
  title: "Memanipulasi Metadata MP3 untuk Aplikasi Java"
  ...
  features:
    ...
    # feature loop
    - title: "Memanfaatkan Fitur Asli MP3"
