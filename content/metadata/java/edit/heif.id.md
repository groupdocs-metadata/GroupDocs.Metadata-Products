...
############################# Head ############################
head_title: "Edit Metadata ke HEIF File di Java Aplikasi"
head_description: "Java API pemrosesan metadata untuk mengedit informasi metadata ke file HEIF. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Perbarui Metadata Dari File HEIF Di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memperbarui Metadata ke HEIF di Java"
    content_left: |
        [GroupDocs.Metadata for Java](/id/metadata/java/) memudahkan pengembang Java untuk mengedit detail metadata ke file HEIF dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
