...
############################# Head ############################
head_title: "Редагувати метадані файлів POTM у програмах Java"
head_description: "API обробки метаданих Java для редагування інформації метаданих у файлах POTM. Робота зі стандартами метаданих XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Оновити метадані з файлу Potm у Java" 
...
steps:
    enable: true
    title: "Кроки для оновлення метаданих до Potm у Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) полегшує розробникам Java редагування деталей метаданих файлів Potm у своїх програмах, реалізувавши кілька простих кроків.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Відредагуйте метадані дати створення POTM
...
more_features:
  enable: true
  title: "Маніпулювати метаданими POTM для програм Java"
  ...
  features:
    ...
    # feature loop
    - title: "Використання власних функцій POTM"
