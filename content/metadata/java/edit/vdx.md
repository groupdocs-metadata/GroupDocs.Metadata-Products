...
############################# Head ############################
head_title: "Edit Metadata to VDX Files in Java Applications"
head_description: "Java metadata processing API to edit metadata information to VDX files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
