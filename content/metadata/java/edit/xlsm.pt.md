...
############################# Head ############################
head_title: "Edite metadados para arquivos XLSM em aplicativos Java"
head_description: "API de processamento de metadados Java para editar informações de metadados em arquivos XLSM. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Xlsm em Java" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para Xlsm em Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java editar detalhes de metadados em arquivos Xlsm de dentro de seus aplicativos, implementando algumas etapas fáceis.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Editar metadados da data de criação de XLSM
...
more_features:
  enable: true
  title: "Manipular metadados XLSM para aplicativos Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizando recursos nativos XLSM"
