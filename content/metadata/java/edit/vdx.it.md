...
############################# Head ############################
head_title: "Modifica i metadati nei file VDX nelle applicazioni Java"
head_description: "API di elaborazione dei metadati Java per modificare le informazioni sui metadati nei file VDX. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiorna metadati dal file Vdx in Java" 
...
steps:
    enable: true
    title: "Passaggi per l'aggiornamento dei metadati su Vdx in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) consente agli sviluppatori di Java di modificare facilmente i dettagli dei metadati nei file Vdx dalle loro applicazioni implementando alcuni semplici passaggi.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Modifica i metadati della data di creazione di VDX
...
more_features:
  enable: true
  title: "Manipola i metadati di VDX per le app di Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizzo delle funzionalità native di VDX"
