...
############################# Head ############################
head_title: "Edit Metadata to ONE Files in Java Applications"
head_description: "Java metadata processing API to edit metadata information to ONE files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."
...
steps:
    enable: true
    title: "Steps for Updating Metadata to One in Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) makes it easy for Java developers to edit metadata details to One files from within their applications by implementing a few easy steps.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Edit ONE creation date metadata
...
more_features:
  enable: true
  title: "Manipulate ONE Metadata for Java Apps"
