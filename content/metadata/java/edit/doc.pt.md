...
############################# Head ############################
head_title: "Edite metadados para arquivos DOC em aplicativos Java"
head_description: "API de processamento de metadados Java para editar informações de metadados em arquivos DOC. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Atualizar metadados do arquivo Doc em Java" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados para Doc em Java"
    content: |
      [GroupDocs.Metadata for Java](https://products.groupdocs.com/metadata/java/) torna mais fácil para os desenvolvedores de Java editar detalhes de metadados em arquivos Doc de dentro de seus aplicativos, implementando algumas etapas fáceis.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Editar metadados da data de criação de DOC
...
more_features:
  enable: true
  title: "Manipular metadados DOC para aplicativos Java"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizando recursos nativos DOC"
