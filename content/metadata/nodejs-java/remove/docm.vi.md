...
############################# Head ############################
head_title: "Xóa siêu dữ liệu khỏi tệp DOCM trong Node.js via Java"
head_description: "API siêu dữ liệu Node.js via Java đa nền tảng để ẩn và xóa các trường siêu dữ liệu khỏi tệp DOCM. Hỗ trợ XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Xóa siêu dữ liệu DOCM trong Node.js via Java" 
description: "Xóa thuộc tính siêu dữ liệu khỏi DOCM và các định dạng tài liệu, hình ảnh và tệp đa phương tiện phổ biến khác bằng API GroupDocs.Metadata for Node.js via Java."
...
steps:
    enable: true
    title: "Các bước để xóa siêu dữ liệu khỏi DOCM trong Node.js via Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/) giúp nhà phát triển Node.js via Java dễ dàng xóa siêu dữ liệu khỏi tệp DOCM chỉ bằng một vài bước đơn giản.
