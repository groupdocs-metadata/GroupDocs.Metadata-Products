...
############################# Head ############################
head_title: "Hapus Metadata dari File DWG di Node.js via Java"
head_description: "API metadata Node.js via Java lintas platform untuk menyembunyikan dan menghapus bidang metadata dari file DWG. Mendukung XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Hapus Metadata DWG di Node.js via Java" 
description: "Hapus properti metadata dari DWG dan format file dokumen, gambar, dan multimedia populer lainnya menggunakan API GroupDocs.Metadata for Node.js via Java."
...
steps:
    enable: true
    title: "Langkah-langkah Menghapus Metadata dari DWG di Node.js via Java"
    content: |
      [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/) memudahkan pengembang Node.js via Java menghapus metadata dari file DWG dalam beberapa langkah sederhana.
      
      1. Muat file DWG yang akan diperbarui.
