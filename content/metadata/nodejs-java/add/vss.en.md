...
############################# Head ############################
head_title: "Add Metadata to VSS Files in JavaScript Applications"
head_description: "JavaScript metadata processing API to add metadata information to VSS files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adding Metadata To VSS In JavaScript" 
...
steps:
    enable: true
    title: "Steps for adding Metadata to VSS in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) makes it easy for Node.js via Java developers to add metadata details to VSS files from within their applications by implementing a few easy steps.
