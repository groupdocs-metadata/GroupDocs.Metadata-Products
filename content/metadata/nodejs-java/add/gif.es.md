...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) facilita a los desarrolladores de Node.js via Java agregar detalles de metadatos a archivos GIF desde sus aplicaciones mediante la implementación de unos sencillos pasos.
