...
steps:
    ...
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) erleichtert Node.js via Java-Entwicklern das Hinzufügen von Metadatendetails zu JPEG-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
