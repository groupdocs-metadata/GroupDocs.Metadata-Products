...
############################# Head ############################
head_title: "Fügen Sie Metadaten zu HEIF-Dateien in JavaScript-Anwendungen hinzu"
head_description: "JavaScript-Metadatenverarbeitungs-API zum Hinzufügen von Metadateninformationen zu HEIF-Dateien. Arbeiten Sie mit den Metadatenstandards XMP, EXIF, IPTC, ID3 usw."

############################# Header ############################
title: "Hinzufügen von Metadaten zu HEIF in JavaScript" 
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen von Metadaten zu HEIF in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) erleichtert Node.js via Java-Entwicklern das Hinzufügen von Metadatendetails zu HEIF-Dateien aus ihren Anwendungen heraus, indem sie ein paar einfache Schritte implementieren.
      
      1. Laden Sie HEIF mit einer Instanz der Klasse Metadata.
      ...
      4. Speichern Sie die Änderungen im HEIF-Format.
