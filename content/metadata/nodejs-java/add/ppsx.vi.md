...
############################# Head ############################
head_title: "Thêm siêu dữ liệu vào tệp PPSX trong ứng dụng JavaScript"
head_description: "API xử lý siêu dữ liệu JavaScript để thêm thông tin siêu dữ liệu vào tệp PPSX. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Thêm siêu dữ liệu vào PPSX trong JavaScript" 
...
steps:
    enable: true
    title: "Các bước để thêm Siêu dữ liệu vào PPSX trong JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) giúp nhà phát triển Node.js via Java dễ dàng thêm chi tiết siêu dữ liệu vào tệp PPSX từ bên trong ứng dụng của họ bằng cách triển khai một vài bước đơn giản.
      
      1. Tải PPSX bằng một phiên bản của lớp Metadata.
      ...
      4. Lưu các thay đổi về định dạng PPSX.
