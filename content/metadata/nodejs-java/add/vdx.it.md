...
############################# Head ############################
head_title: "Aggiungi metadati ai file VDX nelle applicazioni JavaScript"
head_description: "API di elaborazione dei metadati JavaScript per aggiungere informazioni sui metadati ai file VDX. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a VDX in JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a VDX in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file VDX dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica VDX con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato VDX.
