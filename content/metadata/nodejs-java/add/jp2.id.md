...
############################# Head ############################
head_title: "Tambahkan Metadata ke File JP2 di Aplikasi JavaScript"
head_description: "JavaScript API pemrosesan metadata untuk menambahkan informasi metadata ke file JP2. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Menambahkan Metadata Ke JP2 Di JavaScript" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke JP2 di JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) memudahkan pengembang Node.js via Java untuk menambahkan detail metadata ke file JP2 dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      ...
      4. Simpan kembali perubahan dalam format JP2.
