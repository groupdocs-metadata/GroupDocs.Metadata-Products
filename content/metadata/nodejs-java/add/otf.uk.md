...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) дозволяє розробникам Node.js via Java легко додавати деталі метаданих до файлів OTF зі своїх програм, виконавши кілька простих кроків.
