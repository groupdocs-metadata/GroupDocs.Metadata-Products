...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) makes it easy for Node.js via Java developers to add metadata details to VSD files from within their applications by implementing a few easy steps.
