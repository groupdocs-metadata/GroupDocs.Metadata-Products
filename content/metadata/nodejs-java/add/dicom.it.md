...
############################# Head ############################
head_title: "Aggiungi metadati ai file DICOM nelle applicazioni JavaScript"
head_description: "API di elaborazione dei metadati JavaScript per aggiungere informazioni sui metadati ai file DICOM. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a DICOM in JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a DICOM in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file DICOM dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica DICOM con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato DICOM.
