...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) дозволяє розробникам Node.js via Java легко додавати деталі метаданих до файлів PPTM зі своїх програм, виконавши кілька простих кроків.
