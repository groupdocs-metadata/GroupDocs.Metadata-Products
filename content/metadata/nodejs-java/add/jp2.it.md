...
############################# Head ############################
head_title: "Aggiungi metadati ai file JP2 nelle applicazioni JavaScript"
head_description: "API di elaborazione dei metadati JavaScript per aggiungere informazioni sui metadati ai file JP2. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a JP2 in JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a JP2 in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file JP2 dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica JP2 con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato JP2.
