...
############################# Head ############################
head_title: "Aggiungi metadati ai file HEIF nelle applicazioni JavaScript"
head_description: "API di elaborazione dei metadati JavaScript per aggiungere informazioni sui metadati ai file HEIF. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a HEIF in JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a HEIF in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file HEIF dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica HEIF con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato HEIF.
