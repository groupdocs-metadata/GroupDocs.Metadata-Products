...
############################# Head ############################
head_title: "Aggiungi metadati ai file ODT nelle applicazioni JavaScript"
head_description: "API di elaborazione dei metadati JavaScript per aggiungere informazioni sui metadati ai file ODT. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a ODT in JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a ODT in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file ODT dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica ODT con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato ODT.
