...
############################# Head ############################
head_title: "Agregar metadatos a archivos AVI en aplicaciones JavaScript"
head_description: "JavaScript API de procesamiento de metadatos para agregar información de metadatos a archivos AVI. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a AVI en JavaScript" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a AVI en JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) facilita a los desarrolladores de Node.js via Java agregar detalles de metadatos a archivos AVI desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue AVI con una instancia de la clase Metadata.
      ...
      4. Guarde los cambios nuevamente en formato AVI.
