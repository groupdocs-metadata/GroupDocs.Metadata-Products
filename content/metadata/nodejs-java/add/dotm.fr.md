...
############################# Head ############################
head_title: "Ajouter des métadonnées aux fichiers DOTM dans les applications JavaScript"
head_description: "JavaScript API de traitement des métadonnées pour ajouter des informations de métadonnées aux fichiers DOTM. Travaillez avec les normes de métadonnées XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Ajout de métadonnées à DOTM dans JavaScript" 
...
steps:
    enable: true
    title: "Étapes pour ajouter des métadonnées à DOTM dans JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) permet aux développeurs Node.js via Java d'ajouter facilement des détails de métadonnées aux fichiers DOTM à partir de leurs applications en mettant en œuvre quelques étapes simples.
      
      1. Chargez DOTM avec une instance de la classe Metadata.
      ...
      4. Enregistrez à nouveau les modifications au format DOTM.
