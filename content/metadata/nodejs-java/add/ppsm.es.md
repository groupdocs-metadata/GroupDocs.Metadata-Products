...
steps:
    ...
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) facilita a los desarrolladores de Node.js via Java agregar detalles de metadatos a archivos PPSM desde sus aplicaciones mediante la implementación de unos sencillos pasos.
