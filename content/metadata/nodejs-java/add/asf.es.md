...
############################# Head ############################
head_title: "Agregar metadatos a archivos ASF en aplicaciones JavaScript"
head_description: "JavaScript API de procesamiento de metadatos para agregar información de metadatos a archivos ASF. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a ASF en JavaScript" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a ASF en JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) facilita a los desarrolladores de Node.js via Java agregar detalles de metadatos a archivos ASF desde sus aplicaciones mediante la implementación de unos sencillos pasos.
      
      1. Cargue ASF con una instancia de la clase Metadata.
