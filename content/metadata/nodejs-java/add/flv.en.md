...
############################# Head ############################
head_title: "Add Metadata to FLV Files in JavaScript Applications"
head_description: "JavaScript metadata processing API to add metadata information to FLV files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adding Metadata To FLV In JavaScript" 
...
steps:
    enable: true
    title: "Steps for adding Metadata to FLV in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) makes it easy for Node.js via Java developers to add metadata details to FLV files from within their applications by implementing a few easy steps.
