...
############################# Head ############################
head_title: "Thêm siêu dữ liệu vào tệp TIF trong ứng dụng JavaScript"
head_description: "API xử lý siêu dữ liệu JavaScript để thêm thông tin siêu dữ liệu vào tệp TIF. Làm việc với các tiêu chuẩn siêu dữ liệu XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Thêm siêu dữ liệu vào TIF trong JavaScript" 
...
steps:
    enable: true
    title: "Các bước để thêm Siêu dữ liệu vào TIF trong JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) giúp nhà phát triển Node.js via Java dễ dàng thêm chi tiết siêu dữ liệu vào tệp TIF từ bên trong ứng dụng của họ bằng cách triển khai một vài bước đơn giản.
      
      1. Tải TIF bằng một phiên bản của lớp Metadata.
      ...
      4. Lưu các thay đổi về định dạng TIF.
