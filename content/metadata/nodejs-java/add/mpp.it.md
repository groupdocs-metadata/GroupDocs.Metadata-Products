...
############################# Head ############################
head_title: "Aggiungi metadati ai file MPP nelle applicazioni JavaScript"
head_description: "API di elaborazione dei metadati JavaScript per aggiungere informazioni sui metadati ai file MPP. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a MPP in JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a MPP in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file MPP dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica MPP con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato MPP.
