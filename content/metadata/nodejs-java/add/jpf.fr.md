...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) permet aux développeurs Node.js via Java d'ajouter facilement des détails de métadonnées aux fichiers JPF à partir de leurs applications en mettant en œuvre quelques étapes simples.
