...
############################# Head ############################
head_title: "Tambahkan Metadata ke File DICOM di Aplikasi JavaScript"
head_description: "JavaScript API pemrosesan metadata untuk menambahkan informasi metadata ke file DICOM. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Menambahkan Metadata Ke DICOM Di JavaScript" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke DICOM di JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) memudahkan pengembang Node.js via Java untuk menambahkan detail metadata ke file DICOM dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat DICOM dengan instance kelas Metadata.
