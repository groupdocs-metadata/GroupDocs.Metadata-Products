...
steps:
    ...
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file PPSX dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
