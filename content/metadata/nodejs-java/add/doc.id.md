...
############################# Head ############################
head_title: "Tambahkan Metadata ke File DOC di Aplikasi JavaScript"
head_description: "JavaScript API pemrosesan metadata untuk menambahkan informasi metadata ke file DOC. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Menambahkan Metadata Ke DOC Di JavaScript" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke DOC di JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) memudahkan pengembang Node.js via Java untuk menambahkan detail metadata ke file DOC dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat DOC dengan instance kelas Metadata.
      ...
      4. Simpan kembali perubahan dalam format DOC.
