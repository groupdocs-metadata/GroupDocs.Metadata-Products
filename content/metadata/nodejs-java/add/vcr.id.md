...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) memudahkan pengembang Node.js via Java untuk menambahkan detail metadata ke file VCR dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
