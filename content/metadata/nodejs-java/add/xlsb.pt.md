...
############################# Head ############################
head_title: "Adicionar metadados a arquivos XLSB em aplicativos JavaScript"
head_description: "API de processamento de metadados JavaScript para adicionar informações de metadados a arquivos XLSB. Trabalhe com padrões de metadados XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adicionando metadados a XLSB em JavaScript" 
...
steps:
    enable: true
    title: "Etapas para adicionar metadados a XLSB em JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) torna mais fácil para os desenvolvedores de Node.js via Java adicionar detalhes de metadados a arquivos XLSB de dentro de seus aplicativos, implementando algumas etapas fáceis.
      
      1. Carregue XLSB com uma instância da classe Metadata.
      ...
      4. Salve as alterações no formato XLSB.
