...
############################# Head ############################
head_title: "Aggiungi metadati ai file AVI nelle applicazioni JavaScript"
head_description: "API di elaborazione dei metadati JavaScript per aggiungere informazioni sui metadati ai file AVI. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a AVI in JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a AVI in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file AVI dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica AVI con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato AVI.
