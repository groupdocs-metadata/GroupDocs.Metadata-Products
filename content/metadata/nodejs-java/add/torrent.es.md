...
############################# Head ############################
head_title: "Agregar metadatos a archivos TORRENT en aplicaciones JavaScript"
head_description: "JavaScript API de procesamiento de metadatos para agregar información de metadatos a archivos TORRENT. Trabaje con estándares de metadatos XMP, EXIF, IPTC, ID3, etc."

############################# Header ############################
title: "Agregar metadatos a TORRENT en JavaScript" 
...
steps:
    enable: true
    title: "Pasos para agregar metadatos a TORRENT en JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) facilita a los desarrolladores de Node.js via Java agregar detalles de metadatos a archivos TORRENT desde sus aplicaciones mediante la implementación de unos sencillos pasos.
