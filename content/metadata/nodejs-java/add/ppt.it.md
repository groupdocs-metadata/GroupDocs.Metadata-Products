...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file PPT dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
