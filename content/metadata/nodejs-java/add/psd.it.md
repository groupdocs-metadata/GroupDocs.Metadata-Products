...
############################# Head ############################
head_title: "Aggiungi metadati ai file PSD nelle applicazioni JavaScript"
head_description: "API di elaborazione dei metadati JavaScript per aggiungere informazioni sui metadati ai file PSD. Funziona con gli standard di metadati XMP, EXIF, IPTC, ID3 ecc."

############################# Header ############################
title: "Aggiunta di metadati a PSD in JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere metadati a PSD in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) consente agli sviluppatori di Node.js via Java di aggiungere facilmente i dettagli dei metadati ai file PSD dall'interno delle loro applicazioni implementando alcuni semplici passaggi.
      
      1. Carica PSD con un'istanza della classe Metadata.
      ...
      4. Salva nuovamente le modifiche nel formato PSD.
