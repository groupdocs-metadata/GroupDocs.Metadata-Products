...
############################# Head ############################
head_title: "Tambahkan Metadata ke File MSG di Aplikasi JavaScript"
head_description: "JavaScript API pemrosesan metadata untuk menambahkan informasi metadata ke file MSG. Bekerja dengan standar metadata XMP, EXIF, IPTC, ID3 dll."

############################# Header ############################
title: "Menambahkan Metadata Ke MSG Di JavaScript" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk menambahkan Metadata ke MSG di JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) memudahkan pengembang Node.js via Java untuk menambahkan detail metadata ke file MSG dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
      
      1. Muat MSG dengan instance kelas Metadata.
