...
############################# Head ############################
head_title: "Add Metadata to MPT Files in JavaScript Applications"
head_description: "JavaScript metadata processing API to add metadata information to MPT files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Adding Metadata To MPT In JavaScript" 
...
steps:
    enable: true
    title: "Steps for adding Metadata to MPT in JavaScript"
    content: |
      [GroupDocs.Metadata for Node.js via Java](/metadata/nodejs-java/) makes it easy for Node.js via Java developers to add metadata details to MPT files from within their applications by implementing a few easy steps.
      
      1. Load MPT with an instance of Metadata class.
      2. Use Metadata.AddProperties method to add the properties.
      3. Use a predicate to find desired metadata properties.
      4. Save the changes back in MPT format.
