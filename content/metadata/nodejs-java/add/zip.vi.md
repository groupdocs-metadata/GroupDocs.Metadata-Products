...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) giúp nhà phát triển Node.js via Java dễ dàng thêm chi tiết siêu dữ liệu vào tệp ZIP từ bên trong ứng dụng của họ bằng cách triển khai một vài bước đơn giản.
