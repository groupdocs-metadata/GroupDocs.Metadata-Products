...
steps:
    ...
    content: |
      [GroupDocs.Metadata](/metadata/nodejs-java/) torna mais fácil para os desenvolvedores de Node.js via Java adicionar detalhes de metadados a arquivos VSD de dentro de seus aplicativos, implementando algumas etapas fáceis.
