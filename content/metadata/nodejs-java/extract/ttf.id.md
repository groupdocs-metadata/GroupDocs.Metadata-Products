...
############################# Head ############################
head_title: "Membaca Metadata dari File TTF di Aplikasi Node.js"
head_description: "Akses dan ekstrak metadata dengan mudah dari file TTF di Node.js. Bekerja dengan format umum seperti XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Ekstrak Metadata dari File TTF" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari File TTF di Node.js dengan GroupDocs.Metadata"
    content: |
      Ekstrak metadata dengan mudah dari file TTF dalam aplikasi Node.js via Java Anda menggunakan [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Begini caranya:
      
      1. Muat file TTF yang metadatanya ingin Anda ekstrak.
    ...
    code:
      ...
      content: |
        ...
        // Ekstrak semua detail dari file TTF
