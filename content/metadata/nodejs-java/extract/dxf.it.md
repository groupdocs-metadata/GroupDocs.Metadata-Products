...
############################# Head ############################
head_title: "Leggi i metadati dai file DXF nelle app Node.js"
head_description: "Accedi ed estrai facilmente i metadati dai file DXF su Node.js. Funziona con formati comuni come XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Estrai metadati dai file DXF" 
...
steps:
    enable: true
    title: "Come estrarre metadati dai file DXF in Node.js con GroupDocs.Metadata"
    content: |
      Estrai facilmente i metadati dai file DXF nelle tue applicazioni Node.js via Java utilizzando [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Ecco come:
      
      1. Carica il file DXF da cui vuoi estrarre i metadati.
    ...
    code:
      ...
      content: |
        ...
        // Estrai tutti i dettagli da un file DXF
