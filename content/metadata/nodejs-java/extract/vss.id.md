...
############################# Head ############################
head_title: "Membaca Metadata dari File VSS di Aplikasi Node.js"
head_description: "Akses dan ekstrak metadata dengan mudah dari file VSS di Node.js. Bekerja dengan format umum seperti XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Ekstrak Metadata dari File VSS" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari File VSS di Node.js dengan GroupDocs.Metadata"
    content: |
      Ekstrak metadata dengan mudah dari file VSS dalam aplikasi Node.js via Java Anda menggunakan [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Begini caranya:
      
      1. Muat file VSS yang metadatanya ingin Anda ekstrak.
    ...
    code:
      ...
      content: |
        ...
        // Ekstrak semua detail dari file VSS
