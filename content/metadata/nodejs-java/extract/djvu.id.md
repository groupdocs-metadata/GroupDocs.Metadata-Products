...
############################# Head ############################
head_title: "Membaca Metadata dari File DJVU di Aplikasi Node.js"
head_description: "Akses dan ekstrak metadata dengan mudah dari file DJVU di Node.js. Bekerja dengan format umum seperti XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Ekstrak Metadata dari File DJVU" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari File DJVU di Node.js dengan GroupDocs.Metadata"
    content: |
      Ekstrak metadata dengan mudah dari file DJVU dalam aplikasi Node.js via Java Anda menggunakan [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Begini caranya:
      
      1. Muat file DJVU yang metadatanya ingin Anda ekstrak.
    ...
    code:
      ...
      content: |
        ...
        // Ekstrak semua detail dari file DJVU
