...
############################# Head ############################
head_title: "Membaca Metadata dari File XLT di Aplikasi Node.js"
head_description: "Akses dan ekstrak metadata dengan mudah dari file XLT di Node.js. Bekerja dengan format umum seperti XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Ekstrak Metadata dari File XLT" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari File XLT di Node.js dengan GroupDocs.Metadata"
    content: |
      Ekstrak metadata dengan mudah dari file XLT dalam aplikasi Node.js via Java Anda menggunakan [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Begini caranya:
      
      1. Muat file XLT yang metadatanya ingin Anda ekstrak.
    ...
    code:
      ...
      content: |
        ...
        // Ekstrak semua detail dari file XLT
