...
############################# Head ############################
head_title: "Lire les métadonnées des fichiers PPSM dans les applications Node.js"
head_description: "Accédez et extrayez facilement les métadonnées des fichiers PPSM sur Node.js. Fonctionne avec les formats courants tels que XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Extraire les métadonnées des fichiers PPSM" 
...
steps:
    enable: true
    title: "Comment extraire les métadonnées des fichiers PPSM dans Node.js avec GroupDocs.Metadata"
    content: |
      Extrayez facilement les métadonnées des fichiers PPSM dans vos applications Node.js via Java à l'aide de [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Voici comment:
      
      1. Chargez le fichier PPSM dont vous souhaitez extraire les métadonnées.
    ...
    code:
      ...
      content: |
        ...
        // Extraire tous les détails d'un fichier PPSM
