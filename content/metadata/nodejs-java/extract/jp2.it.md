...
############################# Head ############################
head_title: "Leggi i metadati dai file JP2 nelle app Node.js"
head_description: "Accedi ed estrai facilmente i metadati dai file JP2 su Node.js. Funziona con formati comuni come XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Estrai metadati dai file JP2" 
...
steps:
    enable: true
    title: "Come estrarre metadati dai file JP2 in Node.js con GroupDocs.Metadata"
    content: |
      Estrai facilmente i metadati dai file JP2 nelle tue applicazioni Node.js via Java utilizzando [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Ecco come:
      
      1. Carica il file JP2 da cui vuoi estrarre i metadati.
    ...
    code:
      ...
      content: |
        ...
        // Estrai tutti i dettagli da un file JP2
