...
############################# Head ############################
head_title: "Read Metadata from DWG Files in Node.js via Java Apps"
head_description: "Easily access and extract metadata from DWG files across Node.js via Java. Works with common formats like XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Extract Metadata from DWG Files" 
...
steps:
    enable: true
    title: "How to Extract Metadata from DWG Files in Node.js via Java with GroupDocs.Metadata"
    content: |
      Easily extract metadata from DWG files within your Node.js via Java applications using [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Here's how:
      
      1. Load the DWG file you want to extract metadata from.
    ...
    code:
      ...
      content: |
        ...
        // Extract all details from a DWG file
