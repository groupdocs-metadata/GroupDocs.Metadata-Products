...
############################# Head ############################
head_title: "Read Metadata from PDF Files in Node.js Apps"
head_description: "Easily access and extract metadata from PDF files across Node.js. Works with common formats like XMP, EXIF, IPTC, ID3."
...
steps:
    enable: true
    title: "How to Extract Metadata from PDF Files in Node.js with GroupDocs.Metadata"
    content: |
