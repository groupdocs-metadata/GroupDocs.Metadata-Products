...
############################# Head ############################
head_title: "Leer metadatos de archivos TIF en aplicaciones Node.js"
head_description: "Acceda y extraiga fácilmente metadatos de archivos TIF en Node.js. Funciona con formatos comunes como XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Extraer metadatos de archivos TIF" 
...
steps:
    enable: true
    title: "Cómo extraer metadatos de archivos TIF en Node.js con GroupDocs.Metadata"
    content: |
      Extraiga fácilmente metadatos de archivos TIF dentro de sus aplicaciones Node.js via Java usando [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Así es cómo:
      
      1. Cargue el archivo TIF del que desea extraer metadatos.
    ...
    code:
      ...
      content: |
        ...
        // Extraiga todos los detalles de un archivo TIF
