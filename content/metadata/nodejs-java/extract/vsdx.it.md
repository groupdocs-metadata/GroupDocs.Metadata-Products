...
############################# Head ############################
head_title: "Leggi i metadati dai file VSDX nelle app Node.js"
head_description: "Accedi ed estrai facilmente i metadati dai file VSDX su Node.js. Funziona con formati comuni come XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Estrai metadati dai file VSDX" 
...
steps:
    enable: true
    title: "Come estrarre metadati dai file VSDX in Node.js con GroupDocs.Metadata"
    content: |
      Estrai facilmente i metadati dai file VSDX nelle tue applicazioni Node.js via Java utilizzando [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Ecco come:
      
      1. Carica il file VSDX da cui vuoi estrarre i metadati.
    ...
    code:
      ...
      content: |
        ...
        // Estrai tutti i dettagli da un file VSDX
