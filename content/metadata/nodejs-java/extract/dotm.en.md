...
############################# Head ############################
head_title: "Read Metadata from DOTM Files in Node.js Apps"
head_description: "Easily access and extract metadata from DOTM files across Node.js. Works with common formats like XMP, EXIF, IPTC, ID3."
...
steps:
    enable: true
    title: "How to Extract Metadata from DOTM Files in Node.js with GroupDocs.Metadata"
    content: |
      ...
      1. Load the DOTM file you want to extract metadata from.
