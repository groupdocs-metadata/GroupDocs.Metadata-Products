...
############################# Head ############################
head_title: "Leer metadatos de archivos AVI en aplicaciones Node.js"
head_description: "Acceda y extraiga fácilmente metadatos de archivos AVI en Node.js. Funciona con formatos comunes como XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Extraer metadatos de archivos AVI" 
...
steps:
    enable: true
    title: "Cómo extraer metadatos de archivos AVI en Node.js con GroupDocs.Metadata"
    content: |
      Extraiga fácilmente metadatos de archivos AVI dentro de sus aplicaciones Node.js via Java usando [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Así es cómo:
      
      1. Cargue el archivo AVI del que desea extraer metadatos.
    ...
    code:
      ...
      content: |
        ...
        // Extraiga todos los detalles de un archivo AVI
