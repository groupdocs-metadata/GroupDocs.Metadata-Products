...
############################# Head ############################
head_title: "Leia metadados de arquivos OTC em aplicativos Node.js"
head_description: "Acesse e extraia facilmente metadados de arquivos OTC em Node.js. Funciona com formatos comuns como XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Extraia metadados de arquivos OTC" 
...
steps:
    enable: true
    title: "Como extrair metadados de arquivos OTC em Node.js com GroupDocs.Metadata"
    content: |
      Extraia facilmente metadados de arquivos OTC em seus aplicativos Node.js via Java usando [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Veja como:
      
      1. Carregue o arquivo OTC do qual deseja extrair metadados.
    ...
    code:
      ...
      content: |
        ...
        // Extraia todos os detalhes de um arquivo OTC
