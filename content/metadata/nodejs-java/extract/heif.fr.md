...
############################# Head ############################
head_title: "Lire les métadonnées des fichiers HEIF dans les applications Node.js"
head_description: "Accédez et extrayez facilement les métadonnées des fichiers HEIF sur Node.js. Fonctionne avec les formats courants tels que XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Extraire les métadonnées des fichiers HEIF" 
...
steps:
    enable: true
    title: "Comment extraire les métadonnées des fichiers HEIF dans Node.js avec GroupDocs.Metadata"
    content: |
      Extrayez facilement les métadonnées des fichiers HEIF dans vos applications Node.js via Java à l'aide de [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Voici comment:
      
      1. Chargez le fichier HEIF dont vous souhaitez extraire les métadonnées.
    ...
    code:
      ...
      content: |
        ...
        // Extraire tous les détails d'un fichier HEIF
