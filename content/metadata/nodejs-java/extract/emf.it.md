...
############################# Head ############################
head_title: "Leggi i metadati dai file EMF nelle app Node.js"
head_description: "Accedi ed estrai facilmente i metadati dai file EMF su Node.js. Funziona con formati comuni come XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Estrai metadati dai file EMF" 
...
steps:
    enable: true
    title: "Come estrarre metadati dai file EMF in Node.js con GroupDocs.Metadata"
    content: |
      Estrai facilmente i metadati dai file EMF nelle tue applicazioni Node.js via Java utilizzando [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Ecco come:
      
      1. Carica il file EMF da cui vuoi estrarre i metadati.
    ...
    code:
      ...
      content: |
        ...
        // Estrai tutti i dettagli da un file EMF
