...
############################# Head ############################
head_title: "Membaca Metadata dari File ZIP di Aplikasi Node.js"
head_description: "Akses dan ekstrak metadata dengan mudah dari file ZIP di Node.js. Bekerja dengan format umum seperti XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Ekstrak Metadata dari File ZIP" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari File ZIP di Node.js dengan GroupDocs.Metadata"
    content: |
      Ekstrak metadata dengan mudah dari file ZIP dalam aplikasi Node.js via Java Anda menggunakan [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Begini caranya:
      
      1. Muat file ZIP yang metadatanya ingin Anda ekstrak.
    ...
    code:
      ...
      content: |
        ...
        // Ekstrak semua detail dari file ZIP
