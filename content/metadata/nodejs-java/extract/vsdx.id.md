...
############################# Head ############################
head_title: "Membaca Metadata dari File VSDX di Aplikasi Node.js"
head_description: "Akses dan ekstrak metadata dengan mudah dari file VSDX di Node.js. Bekerja dengan format umum seperti XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Ekstrak Metadata dari File VSDX" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari File VSDX di Node.js dengan GroupDocs.Metadata"
    content: |
      Ekstrak metadata dengan mudah dari file VSDX dalam aplikasi Node.js via Java Anda menggunakan [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Begini caranya:
      
      1. Muat file VSDX yang metadatanya ingin Anda ekstrak.
    ...
    code:
      ...
      content: |
        ...
        // Ekstrak semua detail dari file VSDX
