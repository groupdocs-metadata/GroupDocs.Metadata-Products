...
############################# Head ############################
head_title: "Membaca Metadata dari File POTX di Aplikasi Node.js"
head_description: "Akses dan ekstrak metadata dengan mudah dari file POTX di Node.js. Bekerja dengan format umum seperti XMP, EXIF, IPTC, ID3."

############################# Header ############################
title: "Ekstrak Metadata dari File POTX" 
...
steps:
    enable: true
    title: "Cara Mengekstrak Metadata dari File POTX di Node.js dengan GroupDocs.Metadata"
    content: |
      Ekstrak metadata dengan mudah dari file POTX dalam aplikasi Node.js via Java Anda menggunakan [GroupDocs.Metadata](https://products.groupdocs.com/metadata/nodejs-java/). Begini caranya:
      
      1. Muat file POTX yang metadatanya ingin Anda ekstrak.
    ...
    code:
      ...
      content: |
        ...
        // Ekstrak semua detail dari file POTX
