...
############################# Head ############################
head_title: "Редактирование метаданных в файлах JP2 с помощью приложений Node.js"
head_description: "Используйте API метаданных Node.js для редактирования метаданных в файлах JP2. Поддерживает XMP, EXIF, IPTC, ID3 и другие."

############################# Header ############################
title: "Обновить метаданные в файлах Jp2 с помощью JavaScript" 
...
steps:
    enable: true
    title: "Действия по обновлению метаданных в Jp2 с помощью Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) позволяет редактировать метаданные в файлах Jp2, выполнив несколько простых шагов.
...
more_features:
  enable: true
  title: "Редактировать метаданные JP2 для приложений Node.js."
  ...
  features:
    ...
    # feature loop
    - title: "Используйте встроенные функции JP2"
