...
############################# Head ############################
head_title: "Edite metadados em arquivos WEBP com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos WEBP. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Webp usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Webp usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Webp com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados WEBP para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos WEBP"
