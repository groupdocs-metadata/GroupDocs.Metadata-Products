...
############################# Head ############################
head_title: "Edit Metadata to WAV Files in Node.js via Java Applications"
head_description: "Node.js via Java metadata processing API to edit metadata information to WAV files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata From Wav File In JavaScript" 
...
steps:
    enable: true
    title: "Steps for Updating Metadata to Wav in Node.js via Java"
    content: |
      **[GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/)** makes it easy for Node.js via Java developers to edit metadata details to Wav files from within their applications by implementing a few easy steps.
...
more_features:
  enable: true
  title: "Manipulate WAV Metadata for Node.js via Java Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizing Native WAV Features"
