...
############################# Head ############################
head_title: "Edite metadados em arquivos PDF com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos PDF. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Pdf usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Pdf usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Pdf com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados PDF para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos PDF"
