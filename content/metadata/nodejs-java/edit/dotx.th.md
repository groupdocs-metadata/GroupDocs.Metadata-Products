...
############################# Head ############################
head_title: "แก้ไขข้อมูลเมตาในไฟล์ DOTX ด้วยแอปพลิเคชัน Node.js"
head_description: "ใช้ API ข้อมูลเมตา Node.js เพื่อแก้ไขข้อมูลเมตาในไฟล์ DOTX รองรับ XMP, EXIF, IPTC, ID3 และอื่นๆ"

############################# Header ############################
title: "อัปเดตข้อมูลเมตาในไฟล์ Dotx โดยใช้ JavaScript" 
...
steps:
    enable: true
    title: "ขั้นตอนในการอัปเดตข้อมูลเมตาใน Dotx โดยใช้ Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) อนุญาตให้แก้ไขข้อมูลเมตาในไฟล์ Dotx ด้วยขั้นตอนง่ายๆ เพียงไม่กี่ขั้นตอน
...
more_features:
  enable: true
  title: "แก้ไขข้อมูลเมตา DOTX สำหรับแอป Node.js"
