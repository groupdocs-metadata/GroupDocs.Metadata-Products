...
############################# Head ############################
head_title: "Edite metadados em arquivos XLSB com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos XLSB. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Xlsb usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Xlsb usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Xlsb com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados XLSB para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos XLSB"
