...
############################# Head ############################
head_title: "Edit Metadata in DOT Files with Node.js via Java Applications"
head_description: "Use Node.js via Java metadata API to edit metadata in DOT files. Supports XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Update Metadata in Dot Files Using JavaScript" 
...
steps:
    enable: true
    title: "Steps to Update Metadata in Dot Using Node.js via Java"
    content: |
      **[GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/)** allows Node.js via Java developers to edit metadata in Dot files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit DOT Metadata for Node.js via Java Apps"
