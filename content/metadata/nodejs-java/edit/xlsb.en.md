...
############################# Head ############################
head_title: "Edit Metadata in XLSB Files with Node.js via Java Applications"
head_description: "Use Node.js via Java metadata API to edit metadata in XLSB files. Supports XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Update Metadata in Xlsb Files Using JavaScript" 
...
steps:
    enable: true
    title: "Steps to Update Metadata in Xlsb Using Node.js via Java"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows Node.js via Java developers to edit metadata in Xlsb files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit XLSB Metadata for Node.js via Java Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Use Native XLSB Features"
