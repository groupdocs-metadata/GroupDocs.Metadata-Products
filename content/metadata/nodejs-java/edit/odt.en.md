...
############################# Head ############################
head_title: "Edit Metadata in ODT Files with Node.js via Java Applications"
head_description: "Use Node.js via Java metadata API to edit metadata in ODT files. Supports XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Update Metadata in Odt Files Using JavaScript" 
...
steps:
    enable: true
    title: "Steps to Update Metadata in Odt Using Node.js via Java"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows Node.js via Java developers to edit metadata in Odt files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit ODT Metadata for Node.js via Java Apps"
