...
############################# Head ############################
head_title: "Edit Metadata in HEIF Files with Node.js via Java Applications"
head_description: "Use Node.js via Java metadata API to edit metadata in HEIF files. Supports XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Update Metadata in Heif Files Using JavaScript" 
...
steps:
    enable: true
    title: "Steps to Update Metadata in Heif Using Node.js via Java"
    content: |
      **[GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/)** allows Node.js via Java developers to edit metadata in Heif files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit HEIF Metadata for Node.js via Java Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Use Native HEIF Features"
