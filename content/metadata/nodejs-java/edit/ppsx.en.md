...
############################# Head ############################
head_title: "Edit Metadata to PPSX Files in Node.js via Java Applications"
head_description: "Node.js via Java metadata processing API to edit metadata information to PPSX files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata From Ppsx File In JavaScript" 
...
steps:
    enable: true
    title: "Steps for Updating Metadata to Ppsx in Node.js via Java"
    content: |
      **[GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/)** makes it easy for Node.js via Java developers to edit metadata details to Ppsx files from within their applications by implementing a few easy steps.
      
      1. Load the Ppsx file to be updated
    ...
    code:
      ...
      content: |
        ...
        var metadata = new groupdocs.metadata.Metadata('input.ppsx');
...
more_features:
  enable: true
  title: "Manipulate PPSX Metadata for Node.js via Java Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizing Native PPSX Features"
