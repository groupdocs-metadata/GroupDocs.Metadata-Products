...
############################# Head ############################
head_title: "Edit Metadata in PPTX Files with Node.js via Java Applications"
head_description: "Use Node.js via Java metadata API to edit metadata in PPTX files. Supports XMP, EXIF, IPTC, ID3, and more."
...
steps:
    enable: true
    title: "Steps to Update Metadata in Pptx Using Node.js via Java"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows Node.js via Java developers to edit metadata in Pptx files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit PPTX Metadata for Node.js via Java Apps"
