...
############################# Head ############################
head_title: "Edite metadados em arquivos EMF com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos EMF. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Emf usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Emf usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Emf com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados EMF para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos EMF"
