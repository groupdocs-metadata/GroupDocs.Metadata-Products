...
############################# Head ############################
head_title: "Edit Metadata in ONE Files with Node.js Applications"
head_description: "Use Node.js metadata API to edit metadata in ONE files. Supports XMP, EXIF, IPTC, ID3, and more."
...
steps:
    enable: true
    title: "Steps to Update Metadata in One Using Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows to edit metadata in One files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit ONE Metadata for Node.js Apps"
