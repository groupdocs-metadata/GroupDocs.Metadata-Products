...
############################# Head ############################
head_title: "Edit Metadata in FLV Files with Node.js Applications"
head_description: "Use Node.js metadata API to edit metadata in FLV files. Supports XMP, EXIF, IPTC, ID3, and more."
...
steps:
    enable: true
    title: "Steps to Update Metadata in Flv Using Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows to edit metadata in Flv files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit FLV Metadata for Node.js Apps"
