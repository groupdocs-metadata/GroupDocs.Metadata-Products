...
############################# Head ############################
head_title: "Modifica i metadati nei file OTC con le applicazioni Node.js"
head_description: "Utilizza l'API dei metadati Node.js per modificare i metadati nei file OTC. Supporta XMP, EXIF, IPTC, ID3 e altro."

############################# Header ############################
title: "Aggiorna i metadati nei file Otc utilizzando JavaScript" 
...
steps:
    enable: true
    title: "Passaggi per aggiornare i metadati in Otc utilizzando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) consente di modificare i metadati nei file Otc con pochi semplici passaggi.
      
      1. Carica il file Otc da aggiornare.
...
more_features:
  enable: true
  title: "Modifica i metadati OTC per le app Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizza le funzionalità native di OTC"
