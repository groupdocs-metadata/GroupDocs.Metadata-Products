...
############################# Head ############################
head_title: "Редактирование метаданных в файлах PPT с помощью приложений Node.js"
head_description: "Используйте API метаданных Node.js для редактирования метаданных в файлах PPT. Поддерживает XMP, EXIF, IPTC, ID3 и другие."

############################# Header ############################
title: "Обновить метаданные в файлах Ppt с помощью JavaScript" 
...
steps:
    enable: true
    title: "Действия по обновлению метаданных в Ppt с помощью Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) позволяет редактировать метаданные в файлах Ppt, выполнив несколько простых шагов.
...
more_features:
  enable: true
  title: "Редактировать метаданные PPT для приложений Node.js."
  ...
  features:
    ...
    # feature loop
    - title: "Используйте встроенные функции PPT"
