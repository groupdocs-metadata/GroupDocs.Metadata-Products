...
############################# Head ############################
head_title: "使用 Node.js 应用程序编辑 WAV 文件中的元数据"
head_description: "使用 Node.js 元数据 API 编辑 WAV 文件中的元数据。支持 XMP、EXIF、IPTC、ID3 等。"

############################# Header ############################
title: "使用 JavaScript 更新 Wav 文件中的元数据" 
...
steps:
    enable: true
    title: "使用 Node.js 更新 Wav 中的元数据的步骤"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) 允许通过几个简单的步骤编辑 Wav 文件中的元数据。
