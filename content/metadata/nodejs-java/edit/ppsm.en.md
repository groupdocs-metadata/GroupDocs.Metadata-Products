...
############################# Head ############################
head_title: "Edit Metadata in PPSM Files with Node.js Applications"
head_description: "Use Node.js metadata API to edit metadata in PPSM files. Supports XMP, EXIF, IPTC, ID3, and more."
...
steps:
    enable: true
    title: "Steps to Update Metadata in Ppsm Using Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows to edit metadata in Ppsm files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit PPSM Metadata for Node.js Apps"
