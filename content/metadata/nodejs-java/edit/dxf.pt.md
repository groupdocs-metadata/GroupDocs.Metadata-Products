...
############################# Head ############################
head_title: "Edite metadados em arquivos DXF com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos DXF. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Dxf usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Dxf usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Dxf com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados DXF para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos DXF"
