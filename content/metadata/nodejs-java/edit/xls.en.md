...
############################# Head ############################
head_title: "Edit Metadata to XLS Files in Node.js via Java Applications"
head_description: "Node.js via Java metadata processing API to edit metadata information to XLS files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata From Xls File In JavaScript" 
...
steps:
    enable: true
    title: "Steps for Updating Metadata to Xls in Node.js via Java"
    content: |
      **[GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/)** makes it easy for Node.js via Java developers to edit metadata details to Xls files from within their applications by implementing a few easy steps.
...
more_features:
  enable: true
  title: "Manipulate XLS Metadata for Node.js via Java Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizing Native XLS Features"
