...
############################# Head ############################
head_title: "Edit Metadata in VCF Files with Node.js Applications"
head_description: "Use Node.js metadata API to edit metadata in VCF files. Supports XMP, EXIF, IPTC, ID3, and more."
...
steps:
    enable: true
    title: "Steps to Update Metadata in Vcf Using Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows to edit metadata in Vcf files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit VCF Metadata for Node.js Apps"
