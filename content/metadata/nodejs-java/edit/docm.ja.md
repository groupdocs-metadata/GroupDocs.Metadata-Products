...
############################# Head ############################
head_title: "Node.js アプリケーションを使用して DOCM ファイルのメタデータを編集する"
head_description: "Node.js メタデータ API を使用して、DOCM ファイル内のメタデータを編集します。 XMP、EXIF、IPTC、ID3 などをサポートします。"

############################# Header ############################
title: "JavaScript を使用して Docm ファイルのメタデータを更新する" 
...
steps:
    enable: true
    title: "Node.js を使用して Docm のメタデータを更新する手順"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) を使用すると、いくつかの簡単な手順で Docm ファイル内のメタデータを編集できます。
...
more_features:
  enable: true
  title: "Node.js アプリの DOCM メタデータを編集する"
