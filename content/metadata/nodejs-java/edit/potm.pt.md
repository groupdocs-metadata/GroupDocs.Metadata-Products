...
############################# Head ############################
head_title: "Edite metadados em arquivos POTM com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos POTM. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Potm usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Potm usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Potm com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados POTM para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos POTM"
