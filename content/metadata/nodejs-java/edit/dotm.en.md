...
############################# Head ############################
head_title: "Edit Metadata in DOTM Files with Node.js via Java Applications"
head_description: "Use Node.js via Java metadata API to edit metadata in DOTM files. Supports XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Update Metadata in Dotm Files Using JavaScript" 
...
steps:
    enable: true
    title: "Steps to Update Metadata in Dotm Using Node.js via Java"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows Node.js via Java developers to edit metadata in Dotm files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit DOTM Metadata for Node.js via Java Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Use Native DOTM Features"
