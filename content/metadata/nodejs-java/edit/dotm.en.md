...
############################# Head ############################
head_title: "Edit Metadata to DOTM Files in Node.js via Java Applications"
head_description: "Node.js via Java metadata processing API to edit metadata information to DOTM files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata From Dotm File In JavaScript" 
...
steps:
    enable: true
    title: "Steps for Updating Metadata to Dotm in Node.js via Java"
    content: |
      **[GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/)** makes it easy for Node.js via Java developers to edit metadata details to Dotm files from within their applications by implementing a few easy steps.
      
      1. Load the Dotm file to be updated
...
more_features:
  enable: true
  title: "Manipulate DOTM Metadata for Node.js via Java Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizing Native DOTM Features"
