...
############################# Head ############################
head_title: "Editar metadatos en archivos MSG con aplicaciones Node.js"
head_description: "Utilice la API de metadatos Node.js para editar metadatos en archivos MSG. Admite XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Actualizar metadatos en archivos Msg usando JavaScript" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos en Msg usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadatos en archivos Msg con unos sencillos pasos.
...
more_features:
  enable: true
  title: "Editar metadatos de MSG para aplicaciones Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Utilice funciones nativas MSG"
