...
############################# Head ############################
head_title: "Node.js アプリケーションを使用して HEIC ファイルのメタデータを編集する"
head_description: "Node.js メタデータ API を使用して、HEIC ファイル内のメタデータを編集します。 XMP、EXIF、IPTC、ID3 などをサポートします。"

############################# Header ############################
title: "JavaScript を使用して Heic ファイルのメタデータを更新する" 
...
steps:
    enable: true
    title: "Node.js を使用して Heic のメタデータを更新する手順"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) を使用すると、いくつかの簡単な手順で Heic ファイル内のメタデータを編集できます。
...
more_features:
  enable: true
  title: "Node.js アプリの HEIC メタデータを編集する"
