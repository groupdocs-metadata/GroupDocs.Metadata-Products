...
############################# Head ############################
head_title: "Editar metadatos en archivos POT con aplicaciones Node.js"
head_description: "Utilice la API de metadatos Node.js para editar metadatos en archivos POT. Admite XMP, EXIF, IPTC, ID3 y más."

############################# Header ############################
title: "Actualizar metadatos en archivos Pot usando JavaScript" 
...
steps:
    enable: true
    title: "Pasos para actualizar metadatos en Pot usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadatos en archivos Pot con unos sencillos pasos.
...
more_features:
  enable: true
  title: "Editar metadatos de POT para aplicaciones Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Utilice funciones nativas POT"
