...
############################# Head ############################
head_title: "Chỉnh sửa siêu dữ liệu trong tệp PPS bằng ứng dụng Node.js"
head_description: "Sử dụng API siêu dữ liệu Node.js để chỉnh sửa siêu dữ liệu trong tệp PPS. Hỗ trợ XMP, EXIF, IPTC, ID3, v.v."

############################# Header ############################
title: "Cập nhật siêu dữ liệu trong tệp Pps bằng cách sử dụng JavaScript" 
...
steps:
    enable: true
    title: "Các bước để cập nhật siêu dữ liệu trong Pps bằng cách sử dụng Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) cho phép chỉnh sửa siêu dữ liệu trong tệp Pps chỉ bằng một vài bước đơn giản.
...
more_features:
  enable: true
  title: "Chỉnh sửa siêu dữ liệu PPS cho ứng dụng Node.js"
