...
############################# Head ############################
head_title: "Edit Metadata in VDX Files with Node.js Applications"
head_description: "Use Node.js metadata API to edit metadata in VDX files. Supports XMP, EXIF, IPTC, ID3, and more."

############################# Header ############################
title: "Update Metadata in Vdx Files Using JavaScript" 
...
steps:
    enable: true
    title: "Steps to Update Metadata in Vdx Using Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) allows to edit metadata in Vdx files with a few easy steps.
...
more_features:
  enable: true
  title: "Edit VDX Metadata for Node.js Apps"
