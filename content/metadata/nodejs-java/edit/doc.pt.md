...
############################# Head ############################
head_title: "Edite metadados em arquivos DOC com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos DOC. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Doc usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Doc usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Doc com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados DOC para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos DOC"
