...
############################# Head ############################
head_title: "Редактирование метаданных в файлах OTF с помощью приложений Node.js"
head_description: "Используйте API метаданных Node.js для редактирования метаданных в файлах OTF. Поддерживает XMP, EXIF, IPTC, ID3 и другие."

############################# Header ############################
title: "Обновить метаданные в файлах Otf с помощью JavaScript" 
...
steps:
    enable: true
    title: "Действия по обновлению метаданных в Otf с помощью Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) позволяет редактировать метаданные в файлах Otf, выполнив несколько простых шагов.
...
more_features:
  enable: true
  title: "Редактировать метаданные OTF для приложений Node.js."
  ...
  features:
    ...
    # feature loop
    - title: "Используйте встроенные функции OTF"
