...
############################# Head ############################
head_title: "Node.js アプリケーションを使用して DXF ファイルのメタデータを編集する"
head_description: "Node.js メタデータ API を使用して、DXF ファイル内のメタデータを編集します。 XMP、EXIF、IPTC、ID3 などをサポートします。"

############################# Header ############################
title: "JavaScript を使用して Dxf ファイルのメタデータを更新する" 
...
steps:
    enable: true
    title: "Node.js を使用して Dxf のメタデータを更新する手順"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) を使用すると、いくつかの簡単な手順で Dxf ファイル内のメタデータを編集できます。
...
more_features:
  enable: true
  title: "Node.js アプリの DXF メタデータを編集する"
