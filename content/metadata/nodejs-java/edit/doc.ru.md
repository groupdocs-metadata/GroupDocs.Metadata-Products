...
############################# Head ############################
head_title: "Редактирование метаданных в файлах DOC с помощью приложений Node.js"
head_description: "Используйте API метаданных Node.js для редактирования метаданных в файлах DOC. Поддерживает XMP, EXIF, IPTC, ID3 и другие."

############################# Header ############################
title: "Обновить метаданные в файлах Doc с помощью JavaScript" 
...
steps:
    enable: true
    title: "Действия по обновлению метаданных в Doc с помощью Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) позволяет редактировать метаданные в файлах Doc, выполнив несколько простых шагов.
...
more_features:
  enable: true
  title: "Редактировать метаданные DOC для приложений Node.js."
  ...
  features:
    ...
    # feature loop
    - title: "Используйте встроенные функции DOC"
