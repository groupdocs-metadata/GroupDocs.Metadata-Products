...
############################# Head ############################
head_title: "Edite metadados em arquivos PSD com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos PSD. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Psd usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Psd usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Psd com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados PSD para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos PSD"
