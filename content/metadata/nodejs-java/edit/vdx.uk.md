...
############################# Head ############################
head_title: "Редагувати метадані у файлах VDX за допомогою програм Node.js"
head_description: "Використовуйте API метаданих Node.js для редагування метаданих у файлах VDX. Підтримує XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Оновіть метадані у файлах Vdx за допомогою JavaScript" 
...
steps:
    enable: true
    title: "Кроки для оновлення метаданих у Vdx за допомогою Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) дозволяє редагувати метадані у файлах Vdx за кілька простих кроків.
...
more_features:
  enable: true
  title: "Редагувати метадані VDX для програм Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Використовуйте власні функції VDX"
