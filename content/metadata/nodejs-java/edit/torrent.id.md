...
############################# Head ############################
head_title: "Edit Metadata di File TORRENT dengan Aplikasi Node.js"
head_description: "Gunakan API metadata Node.js untuk mengedit metadata di file TORRENT. Mendukung XMP, EXIF, IPTC, ID3, dan lainnya."

############################# Header ############################
title: "Perbarui Metadata di File Torrent Menggunakan JavaScript" 
...
steps:
    enable: true
    title: "Langkah-langkah Update Metadata di Torrent Menggunakan Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) memungkinkan pengeditan metadata dalam file Torrent dengan beberapa langkah mudah.
...
more_features:
  enable: true
  title: "Edit Metadata TORRENT untuk Aplikasi Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Gunakan Fitur Asli TORRENT"
