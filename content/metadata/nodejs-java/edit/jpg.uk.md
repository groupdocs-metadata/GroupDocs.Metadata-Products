...
############################# Head ############################
head_title: "Редагувати метадані у файлах JPG за допомогою програм Node.js"
head_description: "Використовуйте API метаданих Node.js для редагування метаданих у файлах JPG. Підтримує XMP, EXIF, IPTC, ID3 тощо."

############################# Header ############################
title: "Оновіть метадані у файлах Jpg за допомогою JavaScript" 
...
steps:
    enable: true
    title: "Кроки для оновлення метаданих у Jpg за допомогою Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) дозволяє редагувати метадані у файлах Jpg за кілька простих кроків.
...
more_features:
  enable: true
  title: "Редагувати метадані JPG для програм Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Використовуйте власні функції JPG"
