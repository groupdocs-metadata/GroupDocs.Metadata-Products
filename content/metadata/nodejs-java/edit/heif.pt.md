...
############################# Head ############################
head_title: "Edite metadados em arquivos HEIF com aplicativos Node.js"
head_description: "Use a API de metadados Node.js para editar metadados em arquivos HEIF. Suporta XMP, EXIF, IPTC, ID3 e muito mais."

############################# Header ############################
title: "Atualizar metadados em arquivos Heif usando JavaScript" 
...
steps:
    enable: true
    title: "Etapas para atualizar metadados em Heif usando Node.js"
    content: |
      [GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/) permite editar metadados em arquivos Heif com algumas etapas fáceis.
...
more_features:
  enable: true
  title: "Editar metadados HEIF para aplicativos Node.js"
  ...
  features:
    ...
    # feature loop
    - title: "Use recursos nativos HEIF"
