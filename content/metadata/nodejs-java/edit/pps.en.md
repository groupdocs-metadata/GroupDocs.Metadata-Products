...
############################# Head ############################
head_title: "Edit Metadata to PPS Files in Node.js via Java Applications"
head_description: "Node.js via Java metadata processing API to edit metadata information to PPS files. Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata From Pps File In JavaScript" 
...
steps:
    enable: true
    title: "Steps for Updating Metadata to Pps in Node.js via Java"
    content: |
      **[GroupDocs.Metadata for Node.js via Java](https://products.groupdocs.com/metadata/nodejs-java/)** makes it easy for Node.js via Java developers to edit metadata details to Pps files from within their applications by implementing a few easy steps.
...
more_features:
  enable: true
  title: "Manipulate PPS Metadata for Node.js via Java Apps"
  ...
  features:
    ...
    # feature loop
    - title: "Utilizing Native PPS Features"
