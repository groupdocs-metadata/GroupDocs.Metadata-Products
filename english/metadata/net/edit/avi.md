...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net) makes it easy for .NET developers to edit and edit metadata information from AVI files from within their applications by implementing a few easy steps.
