...
############################# Head ############################
head_title: "Edit &amp; Update Metadata of JP2 Files in C# .NET Applications"
head_description: "C# .NET metadata editing API to update metadata information of JP2 files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Update Metadata of JP2 File in C#"
...
steps:
    ...
    content_left: |
        ...
        *   Save the changes to disc in JP2 format.
...
demos:
    ...
    content: |
        Update metadata information of JP2 file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.  
