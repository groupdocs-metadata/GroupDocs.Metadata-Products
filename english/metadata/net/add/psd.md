...
steps:
    enable: true
    title_left: "Steps for Adding PSD Metadata in C#"
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/net) makes it easy for .NET developers to add metadata details to PSD files from within their applications by implementing a few easy steps.
