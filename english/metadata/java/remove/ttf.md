...
steps:
    enable: true
    title_left: "Steps for Removing TTF Metadata in Java"
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to delete metadata information from TTF files from within their applications by implementing a few easy steps.
