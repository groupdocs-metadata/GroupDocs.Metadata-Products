...
############################# Head ############################
head_title: "Add Metadata Properties to VSDX Files in Java"
head_description: "Cross platform Java metadata API to view and add metadata fields to VSDX files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Add Metadata to VSDX in Java"
description: "Add metadata properties to VSDX and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to add metadata fields to VSDX files from within their applications by implementing a few easy steps.
