...
############################# Head ############################
head_title: "Add Metadata Properties to JP2 Files in Java"
head_description: "Cross platform Java metadata API to view and add metadata fields to JP2 files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Add Metadata to JP2 in Java"
description: "Add metadata properties to JP2 and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    enable: true
    title_left: "Steps for adding Metadata to JP2 in Java"
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to add metadata fields to JP2 files from within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Add metadata information to JP2 file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.  
