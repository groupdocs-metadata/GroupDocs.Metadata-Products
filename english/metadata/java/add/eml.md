...
############################# Head ############################
head_title: "Add Metadata Properties to EML Files in Java"
head_description: "Cross platform Java metadata API to view and add metadata fields to EML files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Add Metadata to EML in Java"
description: "Add metadata properties to EML and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    enable: true
    title_left: "Steps for adding Metadata to EML in Java"
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to add metadata fields to EML files from within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Add metadata information to EML file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.  
