...
############################# Head ############################
head_title: "Add Metadata Properties to DOCX Files in Java"
head_description: "Cross platform Java metadata API to view and add metadata fields to DOCX files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Add Metadata to DOCX in Java"
description: "Add metadata properties to DOCX and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    enable: true
    title_left: "Steps for adding Metadata to DOCX in Java"
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to add metadata fields to DOCX files from within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Add metadata information to DOCX file right now by visiting [GroupDocs.Metadata Live Demos](https://products.groupdocs.app/metadata/family) website.  
