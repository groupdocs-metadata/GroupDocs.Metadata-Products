...
############################# Head ############################
head_title: "Add Metadata Properties to BMP Files in Java"
head_description: "Cross platform Java metadata API to view and add metadata fields to BMP files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Add Metadata to BMP in Java"
description: "Add metadata properties to BMP and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to add metadata fields to BMP files from within their applications by implementing a few easy steps.
