...
############################# Head ############################
head_title: "Add Metadata Properties to ZIP Files in Java"
head_description: "Cross platform Java metadata API to view and add metadata fields to ZIP files.Work with metadata standards XMP, EXIF, IPTC, ID3 etc."

############################# Header ############################
title: "Add Metadata to ZIP in Java"
description: "Add metadata properties to ZIP and many other popular documents, images and multimedia file formats using GroupDocs.Metadata for Java API."
...
steps:
    ...
    content_left: |
        [GroupDocs.Metadata](https://products.groupdocs.com/metadata/java) makes it easy for Java developers to add metadata fields to ZIP files from within their applications by implementing a few easy steps.
